    ...
    */
    ...
    'connections' => [
        ...
        'pusher' => [
            ...
            'options' => [
                // cluster is still supported for hosted Pusher
                'cluster' => env('PUSHER_APP_CLUSTER'),
                // TLS usage
                'useTLS' => env('PUSHER_APP_USE_TLS', true),
                // For self-hosted laravel-websockets, you can configure host/port/scheme
                ...
                'curl_options' => [
                    // Allow self-signed certs in development if needed
