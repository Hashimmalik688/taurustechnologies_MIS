{{-- Accounting Module — Top navigation bar (Xero-style) --}}
@php
    ...
    <div class="acct-subnav-inner">
        ...
        <nav class="acct-subnav-links">
            <a href="{{ route('admin.accounting.dashboard') }}"
               class="acct-nav-link {{ Str::startsWith($acctRoute,'admin.accounting.dashboard') ? 'active' : '' }}">
                <i class="bx bx-home-alt-2"></i> Overview
            </a>
            <a href="{{ route('admin.accounting.sales-ledger') }}"
