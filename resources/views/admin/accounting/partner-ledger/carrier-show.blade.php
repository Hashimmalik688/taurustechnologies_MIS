...
@section('title', $partner->name . ' · ' . ($carrier?->name ?? 'Unassigned') . ' — Ledger')
    ...
    <div class="stmt-header">
        <div class="stmt-header-left">
            ...
            <div class="stmt-carrier-badge">
                ...
                {{ $carrier?->name ?? 'Unassigned Carrier' }}
            </div>
        </div>
                    ...
                    <tr>
                        <td colspan="8" class="text-center py-5" style="font-size:.875rem;">
                            ...
                            <div style="color:#888;margin-bottom:6px;">
                                No transactions for
                                <strong>{{ $carrier?->name ?? 'Unassigned' }}</strong>
                                yet.
                            </div>
                            @canEditModule('accounting')
                            <div style="font-size:.78rem;color:#aaa;">
                                Record a Sale or Payment with
                                <strong>{{ $carrier?->name ?? 'no carrier' }}</strong>
