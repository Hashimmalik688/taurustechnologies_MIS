...
@section('title', 'Record a ChargeBack / Sales Return')
        ...
        <div>
            <div class="txn-card">
                ...
                <div class="txn-card-body">
                    <form method="POST" action="{{ route('admin.accounting.record-chargeback.store') }}" id="cbForm">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="gross_amount" id="grossAmountInput"
                                       ...
                                       value="{{ old('gross_amount') }}" placeholder="Full chargeback / policy value">
                                @error('gross_amount') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                        </div>

                        {{-- Share % + calculated chargeback amount --}}
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" name="reference" class="form-control"
                                       value="{{ old('reference') }}" placeholder="Original policy or ref #">
                            </div>
                        </div>
