...
@section('content')
            ...
            <div class="card agents-card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a class="btn btn-gold btn-sm" href="{{ route('agents.create') }}">
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap w-100">
                            ...
                            <tbody>
                                @foreach ($agents as $agent)
                                    <tr>
                                        <td>
                                            <span class="fw-bold text-primary">#{{ $agent->id }}</span>
                                        </td>
 ...
 <small class="u-fw-600" style="color: var(--bs-ui-success)">Active</small>
                                        ...
                                        <td>
                                            @if ($agent->userDetail && $agent->userDetail->phone)
 ...
 <span class="text-surface-600" >-</span>
                                        ...
                                        <td>
                                            @if ($agent->userDetail && $agent->userDetail->ssn_last4)
 ...
 <span class="text-surface-600" >-</span>
                                        ...
                                        <td>
                                            @if ($agent->userDetail && $agent->userDetail->dob)
                                                <span class="text-white-50">
 ...
 <span class="text-surface-600" >-</span>
                                        ...
                                        <td>
                                            @if ($agent->userDetail && $agent->userDetail->state)
                                                <span class="badge-gold">
                                                    ...
                                                    @hasanyrole([Roles::SUPER_ADMIN, Roles::MANAGER])
                                                        ...
                                                        <li>
                                                            <button class="dropdown-item"
                                                                onclick="viewCarriers({{ $agent->id }})">
                                                                <i class="bx bx-car me-2"></i>View Carriers
                                                            </button>
                                                        </li>
                                                        <li>
                                                            <button class="dropdown-item"
                                                                onclick="viewActiveStates({{ $agent->id }})">
