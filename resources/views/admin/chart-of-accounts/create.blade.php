            ...
            <div class="sec-body">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="crm-input @error('account_code') is-invalid @enderror" name="account_code" value="{{ old('account_code') }}" placeholder="e.g., 1000, 2000" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="crm-input @error('account_name') is-invalid @enderror" name="account_name" value="{{ old('account_name') }}" placeholder="e.g., Cash in Bank" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="crm-input @error('account_type') is-invalid @enderror" name="account_type" required>
                            ...
                            @foreach($accountTypes as $type)<option value="{{ $type }}" {{ old('account_type') == $type ? 'selected' : '' }}>{{ $type }}</option>@endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="crm-input @error('account_category') is-invalid @enderror" name="account_category">
                            ...
                            @foreach($accountCategories as $category)<option value="{{ $category }}" {{ old('account_category') == $category ? 'selected' : '' }}>{{ $category }}</option>@endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="crm-input @error('parent_account_id') is-invalid @enderror" name="parent_account_id">
                            ...
                            @foreach($parentAccounts as $parent)<option value="{{ $parent->id }}" {{ old('parent_account_id') == $parent->id ? 'selected' : '' }}>{{ $parent->account_code }} - {{ $parent->account_name }}</option>@endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.01" class="crm-input @error('opening_balance') is-invalid @enderror" name="opening_balance" value="{{ old('opening_balance', 0) }}" placeholder="0.00">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea class="crm-input @error('description') is-invalid @enderror" name="description" rows="3" placeholder="Account description">{{ old('description') }}</textarea>
                    ...
                    <div class="col-md-12">
                        <label style="font-size:.72rem;font-weight:600;display:flex;align-items:center;gap:.35rem;cursor:pointer;">
                            <input type="checkbox" name="is_active" value="1" class="crm-check" {{ old('is_active', true) ? 'checked' : '' }}>
                            Account is Active
                        </label>
                    </div>
                </div>
