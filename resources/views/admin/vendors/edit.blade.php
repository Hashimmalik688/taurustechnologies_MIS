...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            ...
            <form action="{{ route('vendors.update', $vendor->id ?? 1) }}" method="POST">
                @csrf
                @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                           ...
                                           value="{{ old('name', $vendor->name ?? 'John Smith') }}" required>
                                    @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('company_name') is-invalid @enderror"
                                           ...
                                           value="{{ old('company_name', $vendor->company_name ?? 'Smith Insurance Co.') }}">
                                    @error('company_name')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('vendor_type') is-invalid @enderror"
                                        ...
                                        <option value="us_agent" {{ old('vendor_type', $vendor->vendor_type ?? 'us_agent') == 'us_agent' ? 'selected' : '' }}>US Agent</option>
                                        <option value="vendor" {{ old('vendor_type', $vendor->vendor_type ?? '') == 'vendor' ? 'selected' : '' }}>Vendor</option>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control @error('email') is-invalid @enderror"
                                           ...
                                           value="{{ old('email', $vendor->email ?? 'john@smithins.com') }}" required>
                                    @error('email')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="tel" class="form-control @error('phone') is-invalid @enderror"
                                           ...
                                           value="{{ old('phone', $vendor->phone ?? '(555) 123-4567') }}" required>
                                    @error('phone')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('address') is-invalid @enderror"
                                              ...
                                              placeholder="Enter full address">{{ old('address', $vendor->address ?? '123 Main Street') }}</textarea>
                                    @error('address')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('city') is-invalid @enderror"
                                           ...
                                           value="{{ old('city', $vendor->city ?? 'New York') }}">
                                    @error('city')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('state') is-invalid @enderror"
                                           ...
                                           value="{{ old('state', $vendor->state ?? 'NY') }}">
                                    @error('state')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('zip_code') is-invalid @enderror"
                                           ...
                                           value="{{ old('zip_code', $vendor->zip_code ?? '10001') }}">
                                    @error('zip_code')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="commission-input-group">
                                        <input type="number" step="0.01" min="0" max="100"
                                               ...
                                               placeholder="10.00" value="{{ old('commission_rate', $vendor->commission_rate ?? '15.00') }}">
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('payment_terms') is-invalid @enderror"
                                           ...
                                           value="{{ old('payment_terms', $vendor->payment_terms ?? 'Net 30') }}">
                                    @error('payment_terms')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('notes') is-invalid @enderror"
                                              ...
                                              placeholder="Add any additional notes or comments...">{{ old('notes', $vendor->notes ?? '') }}</textarea>
                                    @error('notes')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
