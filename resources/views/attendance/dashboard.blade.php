...
.cal-hdr {
    ...
    font-size: 0.65rem;
    padding: 0.3rem 0;
    color: var(--bs-surface-500, #6c757d);
    text-transform: uppercase;
    letter-spacing: .5px;
    background: var(--bs-surface-100, #f0f0f0);
...
:is([data-theme="dark"],[data-theme="emerald-glass"],[data-theme="midnight-black"],[data-theme="ocean-blue"],[data-theme="royal-purple"],[data-theme="rose-gold"],[data-theme="copper-steel"]) .cal-hdr {
    background: var(--bg-tertiary, #2d2d2d);
    color: var(--text-secondary, #b0b0b0);
    border: 1px solid var(--border-color, rgba(255,255,255,.08));
}
:is([data-theme="dark"],[data-theme="emerald-glass"],[data-theme="midnight-black"],[data-theme="ocean-blue"],[data-theme="royal-purple"],[data-theme="rose-gold"],[data-theme="copper-steel"]) .cal-day {
    background: var(--bg-card, #1f1f1f);
    border-color: var(--border-color, rgba(255,255,255,.08));
}
:is([data-theme="dark"],[data-theme="emerald-glass"],[data-theme="midnight-black"],[data-theme="ocean-blue"],[data-theme="royal-purple"],[data-theme="rose-gold"],[data-theme="copper-steel"]) .cal-day .d-num {
    color: var(--text-primary, #e5e5e5);
}
:is([data-theme="dark"],[data-theme="emerald-glass"],[data-theme="midnight-black"],[data-theme="ocean-blue"],[data-theme="royal-purple"],[data-theme="rose-gold"],[data-theme="copper-steel"]) .cal-day .d-time {
    color: var(--text-muted, #737373);
}
:is([data-theme="dark"],[data-theme="emerald-glass"],[data-theme="midnight-black"],[data-theme="ocean-blue"],[data-theme="royal-purple"],[data-theme="rose-gold"],[data-theme="copper-steel"]) .cal-nav h5 {
    color: var(--text-primary, #e5e5e5);
}
:is([data-theme="dark"],[data-theme="emerald-glass"],[data-theme="midnight-black"],[data-theme="ocean-blue"],[data-theme="royal-purple"],[data-theme="rose-gold"],[data-theme="copper-steel"]) .cal-nav small {
    color: var(--text-muted, #737373);
}
:is([data-theme="dark"],[data-theme="emerald-glass"],[data-theme="midnight-black"],[data-theme="ocean-blue"],[data-theme="royal-purple"],[data-theme="rose-gold"],[data-theme="copper-steel"]) .cal-legend {
    color: var(--text-muted, #737373);
}
:is([data-theme="dark"],[data-theme="emerald-glass"],[data-theme="midnight-black"],[data-theme="ocean-blue"],[data-theme="royal-purple"],[data-theme="rose-gold"],[data-theme="copper-steel"]) .att-card {
    background: var(--bg-card, #1f1f1f);
    border-color: var(--border-color, rgba(255,255,255,.08));
}
:is([data-theme="dark"],[data-theme="emerald-glass"],[data-theme="midnight-black"],[data-theme="ocean-blue"],[data-theme="royal-purple"],[data-theme="rose-gold"],[data-theme="copper-steel"]) .stat-card {
    background: var(--bg-card, #1f1f1f);
    border-color: var(--border-color, rgba(255,255,255,.08));
}
:is([data-theme="dark"],[data-theme="emerald-glass"],[data-theme="midnight-black"],[data-theme="ocean-blue"],[data-theme="royal-purple"],[data-theme="rose-gold"],[data-theme="copper-steel"]) .stat-card .s-val {
    color: var(--text-primary, #e5e5e5);
}
:is([data-theme="dark"],[data-theme="emerald-glass"],[data-theme="midnight-black"],[data-theme="ocean-blue"],[data-theme="royal-purple"],[data-theme="rose-gold"],[data-theme="copper-steel"]) .stat-card .s-lbl {
    color: var(--text-muted, #737373);
}
:is([data-theme="dark"],[data-theme="emerald-glass"],[data-theme="midnight-black"],[data-theme="ocean-blue"],[data-theme="royal-purple"],[data-theme="rose-gold"],[data-theme="copper-steel"]) .pp-note {
    color: var(--text-muted, #737373);
}
...
@section('content')
    <div class="row g-3 mt-1">
        {{-- ═══ LEFT COLUMN: Check-in + Stats + Chart ═══ --}}
        <div class="col-xl-5 col-lg-6">

            {{-- Check-in / Check-out Banner --}}
            <div class="att-card checkin-banner">
                <div>
                    <div class="status-pill {{ $todayAttendance ? $todayAttendance->status : 'default' }}">
                        @if($todayAttendance)
                            <i class="bx bx-check-circle"></i>
                            {{ ucfirst($todayAttendance->status) }}
                            — {{ $todayAttendance->login_time ? \Carbon\Carbon::parse($todayAttendance->login_time)->format('h:i A') : 'N/A' }}
                            @if($todayAttendance->logout_time)
                                <span style="opacity:.6">→ {{ \Carbon\Carbon::parse($todayAttendance->logout_time)->format('h:i A') }}</span>
                            @endif
                        @else
                    ...
                    @if($todayAttendance && $todayAttendance->logout_time)
                        <div style="font-size:.72rem;color:var(--bs-surface-500);margin-top:0.2rem;padding-left:.75rem">
                            {{ $todayAttendance->working_hours ?? 0 }} hrs worked
                        </div>
                ...
                <div class="d-flex gap-2">
                    <button id="btnCheckin" class="btn-action btn-in" @if($todayAttendance && $todayAttendance->login_time) disabled @endif>
                        <i class="bx bx-log-in"></i> Check In
                    </button>
                    <button id="btnCheckout" class="btn-action btn-out" @if(!$canCheckout) disabled @endif>
            ...
            <div class="stats-row">
                <div class="stat-card s-half att-card">
                    <div class="stat-num">{{ $stats['half_day'] ?? 0 }}</div>
                    <div class="stat-lbl">Half Day</div>
                </div>
                <div class="stat-card s-leave att-card">
                    <div class="stat-num">{{ $stats['paid_leave'] ?? 0 }}</div>
                ...
                <div class="stat-card s-hours att-card">
                    <div class="stat-num">{{ $stats['avg_hours'] }}</div>
            ...
            <div class="att-card att-calendar">
                <div class="cal-nav">
                    <button class="btn btn-outline-secondary"
                        onclick="window.location.href='?month={{ \Carbon\Carbon::parse($currentMonth)->subMonth()->format('Y-m') }}'">
                        <i class="bx bx-chevron-left"></i> Prev
                    </button>
                    <div class="text-center">
                        <h5>{{ \Carbon\Carbon::parse($currentMonth)->format('F Y') }}</h5>
                        <small class="text-muted">{{ $payPeriodLabel }}</small>
                    </div>
                    <button class="btn btn-outline-secondary"
                        onclick="window.location.href='?month={{ \Carbon\Carbon::parse($currentMonth)->addMonth()->format('Y-m') }}'">
                ...
                <div class="cal-grid">
                    ...
                    @foreach($calendar as $week)
                        @foreach($week as $day)
                            ...
                            @endphp
                            <div class="{{ implode(' ', $cls) }}" title="{{ $tip }}">
                                <div class="d-num">{{ $day['date']->format('j') }}</div>
                                @if($day['holiday'])
                                    <div class="d-stat" style="color:#564ab1">
                                        <i class="bx bx-calendar-star" style="font-size:.45rem"></i> HOLIDAY
                                    </div>
                                    <div class="d-time">{{ Str::limit($day['holiday']->name, 15) }}</div>
                                @elseif($day['attendance'])
                                    <div class="d-stat">
                                    ...
                                    @if($day['attendance']->login_time || $day['attendance']->logout_time)
                                        <div class="d-time">
                                            @if($day['attendance']->login_time)
                                                {{ \Carbon\Carbon::parse($day['attendance']->login_time)->format('g:i A') }}
                                            @endif
                                            @if($day['attendance']->logout_time)
                                                <br>{{ \Carbon\Carbon::parse($day['attendance']->logout_time)->format('g:i A') }}
                                            @endif
                                        </div>
                                    @endif
                                @endif
...
document.addEventListener('DOMContentLoaded', function(){
    ...
    (function(){
        ...
        @foreach($calendar as $week)
            @foreach($week as $day)
                @if($day['isCurrentMonth'] && $day['attendance'] && $day['attendance']->working_hours)
                    labels.push('{{ $day["date"]->format("M j") }}');
                    hours.push({{ round($day['attendance']->working_hours, 1) }});
    ...
    (function(){
        ...
        var late    = {{ $stats['late'] }};
        var absent  = {{ $stats['absent'] }};
        var halfDay = {{ $stats['half_day'] ?? 0 }};
        var paidLeave = {{ $stats['paid_leave'] ?? 0 }};
