{{-- ┌─────────────────────────────────────────────────────────────────────────┐
     │  Freeloaders Widget — Topbar dropdown                                  │
     │  Shows Ravens Closers who haven't made a sale today.                   │
     │  Name drops off the list the moment a sale is submitted. Daily reset.  │
     │  Visible to: Super Admin, Manager, CEO, Ravens Closer                  │
     └─────────────────────────────────────────────────────────────────────────┘ --}}

@hasanyrole('Super Admin|Manager|CEO|Ravens Closer')
<style>
    /* ── Button ─────────────────────────────────────────── */
    .fl-btn {
        position: relative;
...
{{-- Freeloader popup — only rendered for Ravens Closers (shown via JS when they're on the list) --}}
