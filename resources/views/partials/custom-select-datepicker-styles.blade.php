{{-- Select2 + Bootstrap Datepicker theme-aware overrides for redesigned pages --}}
<link rel="stylesheet" href="{{ URL::asset('build/libs/select2/css/select2.min.css') }}">
<link rel="stylesheet" href="{{ URL::asset('build/libs/bootstrap-datepicker/css/bootstrap-datepicker3.min.css') }}">
<style>
/* ── Select2 Theme-Aware ── */
