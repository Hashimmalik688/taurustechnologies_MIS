    ...
    <div class="pd-hero-body">
        ...
        <div class="pd-hero-top">
            ...
            <form method="GET" action="{{ route('partner.dashboard') }}" class="pd-period-form" id="pd-filter-form">
                ...
                {{-- Date range mode --}}
                <span id="pd-range-wrap" style="{{ !request('date_from') ? 'display:none' : '' }}display:flex;align-items:center;gap:.35rem;">
        ...
        <div class="pd-hero-kpis">
            ...
            <div class="pd-kpi k-green pd-anim pd-d1">
                ...
                <div class="pd-kpi-sub">{{ number_format($earnedRatio,0) }}% of projected collected</div>
            ...
            <div class="pd-kpi k-indigo pd-anim pd-d2">
                ...
                <div class="pd-kpi-sub">After {{ $taurusPct }}% Taurus fee</div>
                <div class="pd-bar"><div class="pd-bar-fill" style="width:{{ $earnedRatio }}%;"></div></div>
            </div>
        ...
        <div class="pd-cb-note pd-anim pd-d4">
            ...
            <span>
                <strong>${{ number_format($chargebacks,2) }}</strong> in chargebacks this period —
...
<div class="pd-stats pd-anim pd-d2">
    ...
    <div class="pd-stat">
        ...
        <div>
            ...
            <div class="pd-stat-sub">After {{ $taurusPct }}% deduction</div>
        </div>
    </div>
    <div class="pd-stat">
