...
<div class="script-wrap">
    ...
    <div class="script-header">
        <h5>
            ...
            <span id="customBadge" class="custom-badge {{ $hasCustom ? 'badge-custom' : 'badge-default' }}">
        ...
        <div class="script-controls">
            ...
            <button id="resetBtn" class="sc-btn sc-btn-red" onclick="resetToDefault()" {{ !$hasCustom ? 'disabled' : '' }} title="Remove custom prompt and revert to built-in default">
