...
<div class="acct-subnav">
    <div class="acct-subnav-inner">
        ...
        <nav class="acct-subnav-links">
            ...
            <a href="<?php echo e(route('admin.accounting.sales-returns')); ?>"
               class="acct-nav-link <?php echo e($acctRoute === 'admin.accounting.sales-returns' ? 'active' : ''); ?>">
            ...
            <div class="acct-nav-dropdown">
                <button class="acct-nav-link acct-nav-link-btn <?php echo e(Str::startsWith($acctRoute,'admin.accounting.reports') ? 'active' : ''); ?>" data-bs-toggle="dropdown">
                ...
                <ul class="dropdown-menu shadow" style="font-size:.84rem;min-width:200px">
                    <li>
                        <a class="dropdown-item d-flex align-items-center gap-2" href="<?php echo e(route('admin.accounting.reports.trial-balance')); ?>">
                            <i class="bx bx-scale" style="color:#0369a1"></i> Trial Balance
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item d-flex align-items-center gap-2" href="<?php echo e(route('admin.accounting.reports.profit-loss')); ?>">
                            <i class="bx bx-line-chart" style="color:#059669"></i> Profit &amp; Loss
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item d-flex align-items-center gap-2" href="<?php echo e(route('admin.accounting.reports.balance-sheet')); ?>">
                            <i class="bx bx-wallet" style="color:#7c3aed"></i> Balance Sheet
                        </a>
                    </li>
                    <li><hr class="dropdown-divider"></li>
                    <li>
                        <a class="dropdown-item d-flex align-items-center gap-2" href="<?php echo e(route('admin.accounting.reports.expense-tracker')); ?>">
