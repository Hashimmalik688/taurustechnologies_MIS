                                ...
                                <div class="timeline">
                                    <div class="timeline-item <?php echo e($salaryRecord->calculated_at ? 'completed' : ''); ?>">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <small class="text-muted">
                                                <?php echo e($salaryRecord->calculated_at ? $salaryRecord->calculated_at->format('M d, Y g:i A') : 'Pending'); ?>
                                    ...
                                    <div class="timeline-item <?php echo e($salaryRecord->approved_at ? 'completed' : ''); ?>">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <small class="text-muted">
                                                <?php echo e($salaryRecord->approved_at ? $salaryRecord->approved_at->format('M d, Y g:i A') : 'Pending'); ?>
                                    ...
                                    <div class="timeline-item <?php echo e($salaryRecord->paid_at ? 'completed' : ''); ?>">
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <small class="text-muted">
                                                <?php echo e($salaryRecord->paid_at ? $salaryRecord->paid_at->format('M d, Y g:i A') : 'Pending'); ?>
