...
<div id="carrier-states-container">
    ...
    <div class="carrier-state-section mb-4 d-none" id="carrier-state-section-<?php echo e($carrier->id); ?>" style="border: 1px solid #e9ecef; padding: 15px; border-radius: 5px; background-color: #f8f9fa;">
        <h6 class="mb-3">
