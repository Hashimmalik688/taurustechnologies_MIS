...
<div id="announcement-bar" class="announcement-bar announcement-hidden" style="display: none !important;">
    <div class="announcement-content">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->hasRole([Roles::SUPER_ADMIN, Roles::COORDINATOR])): ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.addEventListener('click', function(e) {
        ...
        if (e.target.closest('.announcement-edit-btn')) {
            ...
            if (currentAnnouncementId) {
                ...
                fetch('<?php echo e(route("api.announcements.current")); ?>')
    ...
    function updateAnnouncement(announcementId) {
        ...
        const url = '<?php echo e(route("admin.announcements.update", ":id")); ?>'.replace(':id', announcementId);
...
<?php /**PATH /var/www/taurus-crm/resources/views/components/announcement-bar.blade.php ENDPATH**/ ?>