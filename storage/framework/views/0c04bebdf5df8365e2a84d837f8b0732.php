...
<div class="acct-page">
    ...
    <div class="sl-card mt-4">
        <div class="sl-card-header">
            ...
            <span style="font-size:.75rem;color:var(--acct-muted)"><?php echo e(number_format($allEntriesTotal)); ?> entries &nbsp;·&nbsp; <a href="<?php echo e(route('admin.accounting.sales-returns')); ?>" style="color:var(--acct-gold);text-decoration:none">View Sales Returns &rarr;</a></span>
        </div>
        ...
        <div style="overflow-x:auto">
            <table class="sl-table">
                ...
                <tbody>
                    ...
                    <?php $hasReturn = isset($returnedLeads[$je->id]); ?>
                    <tr>
                        <td>
                        ...
                        <td>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasReturn): ?>
