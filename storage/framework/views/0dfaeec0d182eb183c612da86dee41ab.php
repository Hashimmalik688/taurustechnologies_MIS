...
<?php $__env->startSection('css'); ?>
    ...
    <style>
        ...
        .leads-table-wrapper::-webkit-scrollbar-track {
            background: var(--bs-print-border);
            border-radius: 6px;
        }
            ...
            <div class="card">
                <div class="d-flex justify-content-end align-items-center p-2">
                    <div class="mx-3">
                        ...
                        <a href="<?php echo e(route('leads.create')); ?>" class="btn btn-success btn-sm waves-effect waves-light">
                        ...
                        <div class="modal fade" id="leadsImportModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="<?php echo e(route('leads.import')); ?>" method="post" enctype="multipart/form-data" id="importLeadsForm">
                                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                                        ...
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['import_file'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <?php echo $__env->make('admin.leads.index_table', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    ...
                    <table id="datatable" class="table table-bordered dt-responsive nowrap w-100">
                        <thead>
                            <tr>
                                ...
                                <th>Gender</th>
                                <th>Smoker</th>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (\Illuminate\Support\Facades\Blade::check('hasrole', [Roles::SUPER_ADMIN, Roles::MANAGER])): ?>
                                    <th>Policy Type</th>
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $leads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($lead->date ? $lead->date : 'N/A'); ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (\Illuminate\Support\Facades\Blade::check('hasrole', [Roles::SUPER_ADMIN, Roles::MANAGER])): ?>
                                        ...
                                        <td>$<?php echo e(number_format($lead->coverage_amount, 2)); ?></td>
                                        <td>$<?php echo e(number_format($lead->monthly_premium, 2)); ?></td>
                                        <td><?php echo e($lead->beneficiary ?? 'N/A'); ?></td>
                                        <td><?php echo e($lead->beneficiary_dob ? \Carbon\Carbon::parse($lead->beneficiary_dob)->format('M d, Y') : 'N/A'); ?></td>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (\Illuminate\Support\Facades\Blade::check('hasrole', Roles::SUPER_ADMIN)): ?>
                                        <td>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->card_number): ?>
                                                <span class="text-muted">****<?php echo e(substr($lead->card_number, -4)); ?></span>
                                            <?php else: ?>
                                                <span class="text-muted">N/A</span>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </td>
                                        <td>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->cvv): ?>
                                                <span class="badge bg-secondary"><?php echo e($lead->cvv); ?></span>
                                            <?php else: ?>
                                                <span class="text-muted">N/A</span>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </td>
                                        <td><?php echo e($lead->expiry_date ?? 'N/A'); ?></td>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <td>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->status == Statuses::LEAD_PENDING): ?>
                                            <span class="badge bg-warning">Pending</span>
                                        <?php elseif($lead->status == Statuses::LEAD_ACCEPTED): ?>
                                            <span class="badge bg-success">Approved</span>
                                        <?php elseif($lead->status == Statuses::LEAD_REJECTED): ?>
                                            <span class="badge bg-danger">Rejected</span>
                                        <?php elseif($lead->status == Statuses::LEAD_FORWARDED): ?>
                                    ...
                                    <td>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->zoom_number === null): ?>
                                        ...
                                        <?php else: ?>
                                            <button onclick="zoomDial('<?php echo e($zoomNumber); ?>')"
                                        ...
                                        <?php if(auth()->check() && auth()->user()->canViewModule('leads')): ?>
                                            <a href="<?php echo e(route('leads.show', $lead->id)); ?>" class="btn btn-info btn-sm">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                        <?php endif; ?>
                                        <?php if(auth()->check() && auth()->user()->canDeleteInModule('leads')): ?>
                                            <form action="<?php echo e(route('leads.delete', $lead->id)); ?>" method="POST" 
 class="m-0">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('DELETE'); ?>
                                                <button type="button" class="btn btn-danger btn-sm" 
                                                    onclick="event.preventDefault(); event.stopPropagation(); $('.modal-backdrop').remove(); if(confirm('Are you sure you want to delete <?php echo e(addslashes($lead->cn_name)); ?>?\n\nThis action cannot be undone.')) { this.closest('form').submit(); }">
 ...
 <div class="modal-header bg-gradient-gold" >
                                ...
                                <form id="leadEditForm" action="<?php echo e(route('leads.updateDuringCall')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taurus-crm/resources/views/admin/leads/index.blade.php ENDPATH**/ ?>