                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-8">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h2 class="mb-1"><?php echo e($partner->name); ?></h2>
                                    <p class="mb-0 opacity-75">
                                        <i class="mdi mdi-key-variant me-1"></i>
                                        Partner Code: <strong><?php echo e($partner->code); ?></strong>
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 text-lg-end mt-3 mt-lg-0">
                            ...
                            <?php else: ?>
                                <span class="status-badge">
                                    <span class="status-dot" style="background: var(--bs-status-default);"></span>Inactive
                                </span>
                ...
                <div class="card-body p-4">
                            ...
                            <div class="info-card">
                                ...
                                <div class="info-value">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($partner->email): ?>
                                        <a href="mailto:<?php echo e($partner->email); ?>" class="text-decoration-none">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $groupedCarrierStates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $carrierId => $carrierStates): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <div class="carrier-card">
                            ...
                            <div class="mb-3">
                                <strong class="d-block mb-2">Licensed States (<?php echo e($carrierStates->count()); ?>):</strong>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $carrierStates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span class="state-badge"><?php echo e($cs->state); ?></span>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $carrierStates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="settlement-row">
                                    <strong><?php echo e($cs->state); ?>:</strong>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cs->settlement_level_pct): ?>
                                        Level: <?php echo e(number_format($cs->settlement_level_pct, 2)); ?>%
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cs->settlement_graded_pct): ?>
                                        | Graded: <?php echo e(number_format($cs->settlement_graded_pct, 2)); ?>%
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cs->settlement_gi_pct): ?>
                                        | GI: <?php echo e(number_format($cs->settlement_gi_pct, 2)); ?>%
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cs->settlement_modified_pct): ?>
                                        | Modified: <?php echo e(number_format($cs->settlement_modified_pct, 2)); ?>%
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$cs->settlement_level_pct && !$cs->settlement_graded_pct && !$cs->settlement_gi_pct && !$cs->settlement_modified_pct): ?>
                    ...
                    <div class="mt-4 d-flex justify-content-end gap-2">
                        ...
                        <a href="<?php echo e(route('admin.partners.edit', $partner->id)); ?>" class="btn btn-gradient-primary">
