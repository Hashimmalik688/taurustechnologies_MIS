<?php $__env->startSection('title'); ?> Partner Details — <?php echo e($partner->name); ?> <?php $__env->stopSection(); ?>
...
<div class="pd-page-hdr">
    <h5>
        <i class="bx bx-user-circle"></i> <?php echo e($partner->name); ?>

        <span class="pd-sub">— Partner Profile</span>
    </h5>
    <a href="<?php echo e(route('admin.partners.index')); ?>" class="pd-back-btn"><i class="bx bx-arrow-back"></i> Partners</a>
</div>
    ...
    <div class="pd-hero">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div class="d-flex align-items-center gap-3">
                <div class="pd-avatar"><?php echo e(substr($partner->name, 0, 2)); ?></div>
                <div class="pd-hero-info">
                    <h4><?php echo e($partner->name); ?></h4>
                    <div class="pd-code"><i class="bx bx-hash"></i> Partner Code: <?php echo e($partner->code); ?></div>
                </div>
            </div>
    ...
    <div class="pd-sec-body">
        <div class="pd-kpi-row">
            <div class="pd-kpi k-blue">
                <div class="k-val"><?php echo e($totalCarriers); ?></div>
                <div class="k-lbl">Carriers</div>
            </div>
            <div class="pd-kpi k-green">
                <div class="k-val"><?php echo e($totalStates); ?></div>
            ...
            <div class="pd-kpi k-teal">
                <div class="k-val"><?php echo e($partner->our_commission_percentage ?? 0); ?>%</div>
...
<div class="row">
    ...
    <div class="col-lg-5">
            ...
            <div class="pd-sec-body">
                <div class="pd-info-grid">
                    ...
                    <div class="pd-info-item">
                        ...
                        <div class="pd-info-val">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($partner->ssn_last4): ?>
                                •••• <?php echo e($partner->ssn_last4); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($totalCarriers > 0): ?>
        <div class="pd-card">
            <div class="pd-sec-hdr">
    ...
    <div class="col-lg-7">
        ...
        <div class="pd-card">
            <div class="pd-sec-hdr">
                ...
                <span style="font-size:.6rem;font-weight:600;padding:.15rem .45rem;border-radius:1rem;background:rgba(85,110,230,.1);color:#556ee6;"><?php echo e($totalCarriers); ?> carrier<?php echo e($totalCarriers != 1 ? 's' : ''); ?></span>
            </div>
            <div class="pd-sec-body">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $groupedCarrierStates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $carrierId => $carrierStates): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                    ...
                    <div class="pd-carrier">
                        <div class="pd-carrier-hdr">
                            <div class="pd-carrier-name">
                                ...
                                <?php echo e($carrier->name ?? 'Unknown Carrier'); ?>
                            ...
                            <span style="font-size:.55rem;font-weight:700;padding:.1rem .35rem;border-radius:.2rem;background:rgba(52,195,143,.1);color:#1a8754;border:1px solid rgba(52,195,143,.15);">
                                <?php echo e($carrierStates->count()); ?> state<?php echo e($carrierStates->count() != 1 ? 's' : ''); ?>
                        ...
                        <div class="pd-carrier-body">
                            ...
                            <div class="pd-state-pills">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $carrierStates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span class="pd-state-pill"><?php echo e($cs->state); ?></span>
                            ...
                            ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($avgLevel || $avgGraded || $avgGi || $avgModified): ?>
                                ...
                                <div class="pd-rates">
                                    <div class="pd-rate">
                                        ...
                                        <div class="r-val <?php echo e(!$avgLevel ? 'empty' : ''); ?>"><?php echo e($avgLevel ? number_format($avgLevel, 1).'%' : '—'); ?></div>
                                    </div>
                                    <div class="pd-rate">
                                        <div class="r-lbl">Graded</div>
                                        <div class="r-val <?php echo e(!$avgGraded ? 'empty' : ''); ?>"><?php echo e($avgGraded ? number_format($avgGraded, 1).'%' : '—'); ?></div>
                                    </div>
                                    <div class="pd-rate">
                                        <div class="r-lbl">GI</div>
                                        <div class="r-val <?php echo e(!$avgGi ? 'empty' : ''); ?>"><?php echo e($avgGi ? number_format($avgGi, 1).'%' : '—'); ?></div>
                                    </div>
                                    <div class="pd-rate">
                                        <div class="r-lbl">Modified</div>
                                        <div class="r-val <?php echo e(!$avgModified ? 'empty' : ''); ?>"><?php echo e($avgModified ? number_format($avgModified, 1).'%' : '—'); ?></div>
                                    </div>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
...
<div class="pd-actions">
    <a href="<?php echo e(route('admin.partners.index')); ?>" class="pd-btn secondary"><i class="bx bx-arrow-back"></i> Back to List</a>
    <?php if(auth()->check() && auth()->user()->canEditModule('partners')): ?>
    <a href="<?php echo e(route('admin.partners.edit', $partner->id)); ?>" class="pd-btn primary"><i class="bx bx-edit-alt"></i> Edit Partner</a>
    <?php endif; ?>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const carriers = <?php echo json_encode($groupedCarrierStates->map(function($states, $carrierId) {
        $carrier = $states->first()->insuranceCarrier;
        return [
            'name' => $carrier->name ?? 'Unknown', 'level' => round($states->avg('settlement_level_pct') ?? 0) ?>;
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taurus-crm/resources/views/admin/partners/show.blade.php ENDPATH**/ ?>