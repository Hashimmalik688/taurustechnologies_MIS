...
<div class="container-fluid">
    ...
    <?php $__env->startComponent('components.breadcrumb'); ?>
        <?php $__env->slot('title'); ?> Ticket Details <?php $__env->endSlot(); ?>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-8">
                            <h4><?php echo e($ticket->ticket_code); ?></h4>
                            <h5><?php echo e($ticket->subject); ?></h5>
                            <p class="text-muted mb-0"><?php echo e(Str::limit($ticket->description, 150)); ?></p>
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-grid gap-2">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ticket->created_by === auth()->id() || auth()->user()->hasRole(['Super Admin', 'CEO'])): ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ticket->assigned_to === auth()->id() && $ticket->approval_status === 'PENDING'): ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ticket->created_by === auth()->id() || auth()->user()->hasRole(['Super Admin', 'CEO'])): ?>
                            <form action="<?php echo e(route('pabs.tickets.destroy', $ticket)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this ticket?');">
                                <?php echo csrf_field(); ?>
        ...
        <div class="col-lg-8">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!in_array($ticket->status, ['CLOSED']) && ($ticket->assigned_to === auth()->id() || $ticket->created_by === auth()->id())): ?>
                        <form action="<?php echo e(route('pabs.tickets.addComment', $ticket)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                    ...
                    <?php elseif(!in_array($ticket->status, ['CLOSED']) && $ticket->assigned_to === null && $ticket->created_by === auth()->id()): ?>
                        <form action="<?php echo e(route('pabs.tickets.addComment', $ticket)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="input-group">
                                <input type="text" name="comment" class="form-control form-control-sm" placeholder="Add comment..." required>
                    ...
                    <?php elseif(in_array($ticket->status, ['CLOSED'])): ?>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body small">
                    <div class="row mb-2">
                        ...
                        <div class="col-7"><strong><?php echo e($ticket->ticket_code); ?></strong></div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-5 text-muted">Section:</div>
                        <div class="col-7"><strong><?php echo e($sections[$ticket->section_id] ?? 'N/A'); ?></strong></div>
                    </div>
                    <div class="row mb-2">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-7">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ticket->quote_amount): ?>
                                <strong>PKR <?php echo e(number_format($ticket->quote_amount, 2)); ?></strong>
                            <?php else: ?>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-7">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ticket->total_cost): ?>
                                <strong>PKR <?php echo e(number_format($ticket->total_cost, 2)); ?></strong>
                            <?php else: ?>
                                <span class="text-muted">N/A</span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-7"><?php echo e($ticket->created_at->format('M d, Y H:i')); ?></div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-5 text-muted">Created By:</div>
                        <div class="col-7"><?php echo e($ticket->creator->name); ?></div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body small">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ticket->assignee): ?>
                        <div class="row mb-2">
                            ...
                            <div class="col-7"><strong><?php echo e($ticket->assignee->name); ?></strong></div>
                        </div>
                    <?php else: ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ticket->resolved_at): ?>
                        <div class="row">
                            ...
                            <div class="col-7"><?php echo e($ticket->resolved_at->format('M d, Y H:i')); ?></div>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
            ...
            <form action="<?php echo e(route('pabs.tickets.update', $ticket)); ?>" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="subject" class="form-control" value="<?php echo e($ticket->subject); ?>" required>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Description <span class="text-danger">*</span></label>
                        <textarea name="description" class="form-control" rows="4" required><?php echo e($ticket->description); ?></textarea>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="total_cost" class="form-control" placeholder="0.00" step="0.01" min="0" value="<?php echo e($ticket->total_cost ?? ''); ?>">
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">PKR</span>
                            <input type="number" name="quote_amount" class="form-control" placeholder="0.00" step="0.01" min="0" value="<?php echo e($ticket->quote_amount ?? ''); ?>">
                        </div>
                    </div>
                </div>
