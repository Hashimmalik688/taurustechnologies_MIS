        ...
        <div class="col-12">
            <div class="card bordered">
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <a href="<?php echo e(route('attendance.dashboard')); ?>" class="btn btn-outline-primary w-100 py-3">
                        ...
                        <div class="col-md-6">
                            <a href="<?php echo e(route('my-dock-records')); ?>" class="btn btn-outline-warning w-100 py-3">
        ...
        <div class="col-12">
            <div class="card bordered">
                <div class="card-body text-center py-4">
                    ...
                    <a href="<?php echo e(route('employee.leads')); ?>" class="btn btn-primary btn-lg">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taurus-crm/resources/views/employee/dashboard.blade.php ENDPATH**/ ?>