...
<div class="pt-hdr">
    ...
    <a href="<?php echo e(route('settings.reports.hub')); ?>" class="pt-back"><i class="bx bx-arrow-back"></i> Hub</a>
</div>

<div class="pt-filter">
    <form method="GET" action="<?php echo e(route('settings.reports.policy-type-report')); ?>" style="display:contents">
        <div><label for="pt-from">From</label><input type="date" id="pt-from" name="date_from" value="<?php echo e($dateFrom); ?>"></div>
        <div><label for="pt-to">To</label><input type="date" id="pt-to" name="date_to" value="<?php echo e($dateTo); ?>"></div>
        <button type="submit" class="pt-btn pt-btn-apply" style="align-self:flex-end"><i class="bx bx-search-alt"></i> Apply</button>
        <a href="<?php echo e(route('settings.reports.policy-type-report')); ?>" class="pt-btn pt-btn-reset" style="align-self:flex-end"><i class="bx bx-reset"></i> Reset</a>
...
<div class="pt-kpis">
    <div class="pt-kpi pt-k-sales">
        ...
        <div class="pt-kpi-val"><?php echo e(number_format($grandTotalSales)); ?></div>
        <div class="pt-kpi-sub"><?php echo e($policyData->count()); ?> combinations</div>
    </div>
    <div class="pt-kpi pt-k-premium">
        <i class="bx bx-dollar-circle pt-kpi-icon"></i>
        <div class="pt-kpi-lbl">Total Premium</div>
        <div class="pt-kpi-val">$<?php echo e(number_format($grandTotalPremium, 2)); ?></div>
    ...
    <div class="pt-kpi pt-k-revenue">
        ...
        <div class="pt-kpi-val">$<?php echo e(number_format($grandTotalRevenue, 2)); ?></div>
    ...
    <div class="pt-kpi pt-k-avg">
        ...
        <div class="pt-kpi-val">$<?php echo e($grandTotalSales > 0 ? number_format($grandTotalPremium/$grandTotalSales,2) : '0.00'); ?></div>
...
<div class="pt-body">
    ...
    <div class="pt-card">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($policyData->isEmpty()): ?>
        <div class="pt-empty">
        ...
        <div style="overflow-x:auto">
            <table class="pt-tbl">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $policyData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                        $rank       = $idx + 1;
                    ...
                    ?>
                    <tr class="pt-row" onclick="window.location='<?php echo e($ddUrl); ?>'">
                        <td class="pt-rank <?php echo e($rank===1?'rank-1':($rank===2?'rank-2':($rank===3?'rank-3':''))); ?>">
                        ...
                        <td>
                            <span class="pt-type-pill" style="background:<?php echo e($typeColor); ?>1a;color:<?php echo e($typeColor); ?>;border:1px solid <?php echo e($typeColor); ?>33">
                                <?php echo e($row->policy_type); ?>

                            </span>
                        </td>
                        <td>
                            <a href="<?php echo e($ddUrl); ?>" class="pt-cp-cell" onclick="event.stopPropagation()" style="text-decoration:none">
                                <span class="pt-dot" style="background:<?php echo e($typeColor); ?>;box-shadow:0 0 0 2px <?php echo e($typeColor); ?>30"></span>
                                <span class="pt-cname"><?php echo e($row->carrier_name ?: '—'); ?></span>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($row->assigned_partner): ?>
                                    <span class="pt-partner-badge <?php echo e($badgeClass); ?>"><?php echo e($row->assigned_partner); ?></span>
                                <?php else: ?>
                        ...
                        <td>
                            <div class="pt-share">
                                <div class="pt-bar-track"><div class="pt-bar-fill" style="width:<?php echo e($pct); ?>%;background:<?php echo e($typeColor); ?>"></div></div>
                                <span class="pt-pct"><?php echo e($pct); ?>%</span>
                            </div>
                        </td>
                        <td class="td-r"><span class="pt-sales-num"><?php echo e(number_format($row->total_sales)); ?></span></td>
                        <td class="td-r">
                            <span class="pt-chip pt-chip-green"><i class="bx bx-dollar"></i><?php echo e(number_format($row->total_premium, 2)); ?></span>
                        </td>
                        <td class="td-r">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasRev): ?>
                                <span class="pt-chip pt-chip-indigo"><i class="bx bx-trending-up"></i><?php echo e(number_format($row->total_revenue, 2)); ?></span>
                            <?php else: ?>
                                <span class="pt-norev"><i class="bx bx-minus"></i> no rate</span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </td>
                        <td class="pt-avg">$<?php echo e(number_format($avgPremium, 2)); ?></td>
                    </tr>
                ...
                <tfoot>
                    <tr>
                        ...
                        <td></td>
                        <td class="td-r"><span class="pt-sales-num"><?php echo e(number_format($grandTotalSales)); ?></span></td>
                        <td class="td-r"><span class="pt-chip pt-chip-green"><i class="bx bx-dollar"></i><?php echo e(number_format($grandTotalPremium, 2)); ?></span></td>
                        <td class="td-r">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($grandTotalRevenue > 0): ?>
                                <span class="pt-chip pt-chip-indigo"><i class="bx bx-trending-up"></i><?php echo e(number_format($grandTotalRevenue, 2)); ?></span>
                            <?php else: ?>
                                <span class="pt-norev"><i class="bx bx-minus"></i> —</span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </td>
                        <td class="pt-avg">$<?php echo e($grandTotalSales > 0 ? number_format($grandTotalPremium/$grandTotalSales,2) : '0.00'); ?></td>
                    </tr>
                </tfoot>
            </table>
        </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($policyData->isNotEmpty()): ?>
    <?php
    ...
    <div class="pt-donut-panel">
        ...
        <svg viewBox="0 0 164 164" style="width:100%;max-width:164px;display:block;margin:0 auto">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $slices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php $dash=$circum*$sl['pct'];$gap=$circum-$dash;$off=$circum*.25-$circum*$sl['cum']; ?>
            <circle cx="82" cy="82" r="<?php echo e($innerR); ?>" fill="none" stroke="<?php echo e($sl['color']); ?>" stroke-width="22"
                stroke-dasharray="<?php echo e(number_format($dash,4,'.',''). ' '.number_format($gap,4,'.','')); ?>"
                stroke-dashoffset="<?php echo e(number_format($off,4,'.','')); ?>" />
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <text x="82" y="77" text-anchor="middle" font-size="18" font-weight="900" fill="var(--pt-text-1)"><?php echo e(number_format($grandTotalSales)); ?></text>
            <text x="82" y="92" text-anchor="middle" font-size="7.5" fill="var(--pt-text-4)" font-weight="700" letter-spacing=".6">SALES</text>
        </svg>
        <div style="margin-top:.5rem">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $slices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php $lp=$donutTot>0?round($sl['pct']*100,1):0 ?>
            <div class="pt-legend-row">
                <span class="pt-legend-dot" style="background:<?php echo e($sl['color']); ?>"></span>
                <span class="pt-legend-name"><?php echo e($sl['type']); ?></span>
                <span class="pt-legend-pct"><?php echo e($lp); ?>%</span>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
        <div style="margin-top:.5rem;padding-top:.45rem;border-top:1px solid var(--pt-border)">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $carrierAgg; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cn=>$cnt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="pt-legend-row">
                <span class="pt-legend-dot" style="background:var(--pt-teal)"></span>
                <span class="pt-legend-name"><?php echo e($cn ?: '—'); ?></span>
                <span class="pt-legend-pct"><?php echo e($cnt); ?></span>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taurus-crm/resources/views/admin/reports/policy-type-report.blade.php ENDPATH**/ ?>