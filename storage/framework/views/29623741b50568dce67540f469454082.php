...
<head>
    ...
    <script>
    (function() {
        var carriers = <?php echo json_encode($carrierPlanData, 15, 512) ?>;
...
<body>
                ...
                <div class="position-relative">
                    ...
                    <div class="notification-dropdown" id="notificationDropdown">
                        ...
                        <div style="text-align:center;padding:.65rem 1rem;border-top:1px solid rgba(212,175,55,.1)">
                            <a href="<?php echo e(route('notifications.index')); ?>" style="font-size:.72rem;font-weight:700;color:#d4af37;text-decoration:none;display:inline-flex;align-items:center;gap:.25rem;transition:opacity .15s" onmouseover="this.style.opacity='.75'" onmouseout="this.style.opacity='1'">
 ...
 <img class="rounded-circle u-obj-cover" src="<?php echo e(Auth::user()->avatar); ?>" id="avatarPreview" alt="<?php echo e(Auth::user()->name); ?>" style="width: 100px; height: 100px">
                            <?php else: ?>
