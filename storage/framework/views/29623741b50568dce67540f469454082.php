...
<body>
        ...
        <div class="top-header">
            ...
            <div class="user-menu">
                ...
                <div style="position: relative; display: flex; align-items: center; gap: 8px;">
                    <a href="<?php echo e(route('chat.index')); ?>" class="notification-btn" title="Team Chat" style="text-decoration: none; display: flex; align-items: center; gap: 6px;">
                ...
                <div style="position: relative;">
                    <button class="notification-btn" onclick="toggleNotifications()" style="display: flex; align-items: center; gap: 6px;">
                        ...
                        <span class="notification-badge" id="notifBadge" style="font-size: 0.85rem; padding: 4px 8px; min-width: 24px; text-align: center; font-weight: 700;"><?php echo e(Auth::user()->unread_notifications_count); ?></span>
                    </button>
                ...
                <div style="display: flex; align-items: center; gap: 0.5rem; padding: 0.5rem; background: #f3f4f6; border-radius: 8px; cursor: pointer;" onclick="document.getElementById('profileSettingsModal').querySelector('.modal').classList.add('show'); document.getElementById('profileSettingsModal').querySelector('.modal').style.display='block';" data-bs-toggle="modal" data-bs-target="#profileSettingsModal">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->avatar): ?>
                        <img src="<?php echo e(asset(Auth::user()->avatar)); ?>" alt="<?php echo e(Auth::user()->name); ?>" class="user-avatar">
                    <?php else: ?>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="update-profile" enctype="multipart/form-data">
                    <div class="modal-body">
                        <input type="hidden" id="profile_id" value="<?php echo e(Auth::id()); ?>">
                        
                        <!-- Avatar Preview -->
                        <div class="text-center mb-3">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->avatar): ?>
                                <img src="<?php echo e(Auth::user()->avatar); ?>" id="avatarPreview" alt="<?php echo e(Auth::user()->name); ?>" style="width: 100px; height: 100px; border-radius: 50%; object-fit: cover;">
                            <?php else: ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="profile-name" name="name" value="<?php echo e(Auth::user()->name); ?>" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="profile-email" name="email" value="<?php echo e(Auth::user()->email); ?>" required>
    ...
    document.getElementById('update-profile')?.addEventListener('submit', function(e) {
        ...
        fetch(`<?php echo e(url('update-profile')); ?>/${profileId}`, {
            method: 'POST',
            body: formData,
            headers: {
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
...
<?php /**PATH /var/www/taurus-crm/resources/views/layouts/master.blade.php ENDPATH**/ ?>