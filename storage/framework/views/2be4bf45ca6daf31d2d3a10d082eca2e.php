...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row mb-3">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="GET" action="<?php echo e(route('validator.index')); ?>" id="filterForm">
        ...
        <div class="col-md-2">
            <div class="card border-primary">
                <div class="card-body text-center">
                    ...
                    <h3 class="mb-0 fw-bold mt-2"><?php echo e($todayStats['total_processed'] ?? 0); ?></h3>
        ...
        <div class="col-md-2">
            <div class="card border-warning">
                <div class="card-body text-center">
                    ...
                    <h3 class="mb-0 fw-bold mt-2"><?php echo e($todayStats['submitted'] ?? 0); ?></h3>
        ...
        <div class="col-md-2">
            <div class="card bg-warning">
                <div class="card-body text-center">
                    ...
                    <h2 class="mb-0 fw-bold"><?php echo e($submittedLeads->count()); ?></h2>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="POST" action="<?php echo e(route('validator.mark-failed', $lead->id)); ?>">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-check mb-2">
                                                                    <input class="form-check-input" type="radio" name="decline_reason" id="noPitch<?php echo e($lead->id); ?>" value="Declined:No Pitch (Not Interested)" required>
                                                                    <label class="form-check-label" for="noPitch<?php echo e($lead->id); ?>">
                                                                        <strong>Declined:No Pitch (Not Interested)</strong>
                                                                    </label>
                                                                </div>
                                                                <div class="form-check mb-2">
                                                                    <input class="form-check-input" type="radio" name="decline_reason" id="noAnswer<?php echo e($lead->id); ?>" value="Declined:No Answer" required>
