...
<?php $__env->startSection('content'); ?>
    <div class="pm-page-hdr">
        <h5>
            <i class="bx bx-shield-alt-2"></i> <?php echo e($role->name); ?>

            <span style="font-size:.72rem;color:var(--bs-surface-500);font-weight:400;margin-left:.2rem">Permissions</span>
        </h5>
        <div style="display:flex;gap:.35rem">
            <a href="<?php echo e(route('settings.permissions.index')); ?>" class="act-btn a-primary"><i class="bx bx-arrow-back"></i> Back</a>
    ...
    <form action="<?php echo e(route('settings.permissions.roles.update', $role)); ?>" method="POST" id="permissionForm">
        ...
        <div class="ex-card sec-card">
            <div class="sec-hdr">
                ...
                <span style="font-size:.65rem;color:var(--bs-surface-500)"><?php echo e($role->name); ?></span>
            </div>
            <div style="padding:0 0 .5rem">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $modulesByCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $modules): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="cat-hdr"><i class="bx bx-folder"></i> <?php echo e($category); ?></div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php $currentLevel = $permissions[$module->slug]['permission_level'] ?? 'none'; ?>
                        <div class="perm-row">
                            <div class="perm-name">
                                <div class="pm-title"><?php echo e($module->name); ?></div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($module->description): ?>
                                    <div class="pm-desc"><?php echo e($module->description); ?></div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                            <div class="perm-opts">
                                <label class="perm-opt opt-none">
                                    <input type="radio" name="permissions[<?php echo e($module->slug); ?>]" value="none" <?php echo e($currentLevel === 'none' ? 'checked' : ''); ?>>
                                    <span class="opt-lbl">None</span>
                                </label>
                                <label class="perm-opt opt-view">
                                    <input type="radio" name="permissions[<?php echo e($module->slug); ?>]" value="view" <?php echo e($currentLevel === 'view' ? 'checked' : ''); ?>>
                                    <span class="opt-lbl">View</span>
                                </label>
                                <label class="perm-opt opt-edit">
                                    <input type="radio" name="permissions[<?php echo e($module->slug); ?>]" value="edit" <?php echo e($currentLevel === 'edit' ? 'checked' : ''); ?>>
                                    <span class="opt-lbl">Edit</span>
                                </label>
                                <label class="perm-opt opt-full">
                                    <input type="radio" name="permissions[<?php echo e($module->slug); ?>]" value="full" <?php echo e($currentLevel === 'full' ? 'checked' : ''); ?>>
        ...
        <div style="display:flex;justify-content:flex-end;gap:.45rem;margin-top:.5rem">
            <a href="<?php echo e(route('settings.permissions.index')); ?>" class="act-btn a-danger"><i class="bx bx-x"></i> Cancel</a>
