...
<?php $__env->startSection('content'); ?>
                ...
                <div class="card border-0 shadow" style="background: <?php echo e($config['gradient']); ?> !important; min-height: 180px;">
                    <div class="card-body text-center p-4">
                        <div class="d-flex justify-content-center align-items-center mb-3">
                            <i class="mdi <?php echo e($config['icon']); ?> text-white" style="font-size: 2.5rem !important"></i>
                        </div>
                        <h6 class="mb-2 fw-semibold text-uppercase u-ls-05 text-white"><?php echo e($config['label']); ?></h6>
                        <h1 class="mb-0 fw-bold text-white u-fs-250"><?php echo e(number_format($count)); ?></h1>
                    </div>
                </div>
            </div>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasRole(Roles::QA)): ?>
                                            ...
                                            <td>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->closer_name): ?>
                                                    ...
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($peregrineClosers) && in_array($lead->closer_name, $peregrineClosers)): ?>
                                            ...
                                            <td>
 <select class="form-select form-select-sm qa-status-dropdown u-min-w-130" data-lead-id="<?php echo e($lead->id); ?>" data-current-status="<?php echo e($lead->qa_status ?? 'Pending'); ?>" >
                                                    <option value="Pending" <?php echo e(($lead->qa_status ?? Statuses::QA_PENDING) == Statuses::QA_PENDING ? 'selected' : ''); ?>>
                                                        ⏳ Pending
                                                    </option>
                                                    <option value="Good" <?php echo e(($lead->qa_status ?? '') == Statuses::QA_GOOD ? 'selected' : ''); ?>>
                                                        ✅ Good
                                                    </option>
                                                    <option value="Avg" <?php echo e(($lead->qa_status ?? '') == Statuses::QA_AVG ? 'selected' : ''); ?>>
                                                        ⚠️ Avg
                                                    </option>
                                                    <option value="Bad" <?php echo e(($lead->qa_status ?? '') == Statuses::QA_BAD ? 'selected' : ''); ?>>
                                                        ❌ Bad
                                                    </option>
                                                </select>
                                            </td>
                                        ...
                                        <?php else: ?>
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center gap-1" role="group">
                                                    ...
                                                    ?>
 <a href="<?php echo e(route('sales.prettyPrint', $lead->id)); ?>" class="btn btn-success btn-sm d-flex align-items-center justify-content-center u-rounded-6" title="Pretty Print" target="_blank" style="width: 36px; height: 36px">
                                                        <i class="fas fa-print"></i>
                                                    </a>
 <button onclick="window.location.href='<?php echo e($callUrl); ?>'" class="btn btn-warning btn-sm d-flex align-items-center justify-content-center u-rounded-6 u-w-36 u-h-36" title="Call">
                                                        <i class="fas fa-phone-alt"></i>
                                                    </button>
 <a href="<?php echo e(route('sales.show', $lead->id)); ?>" class="btn btn-info btn-sm text-white d-flex align-items-center justify-content-center u-rounded-6" title="View" style="width: 36px; height: 36px">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                    <?php if(auth()->check() && auth()->user()->canEditModule('sales')): ?>
 <a href="<?php echo e(route('sales.edit', $lead->id)); ?>" class="btn btn-primary btn-sm d-flex align-items-center justify-content-center u-rounded-6" title="Edit" style="width: 36px; height: 36px">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <?php endif; ?>
                                                    <?php if(auth()->check() && auth()->user()->canDeleteInModule('sales')): ?>
 <button type="button" class="btn btn-danger btn-sm d-flex align-items-center justify-content-center u-rounded-6" data-bs-toggle="modal" data-bs-target="#delete-<?php echo e($lead->id); ?>" title="Delete" style="width: 36px; height: 36px">
 ...
 <select class="form-select form-select-sm editable-carrier u-min-w-120" data-lead-id="<?php echo e($lead->id); ?>" >
                                            ...
                                            <td>
                                                <div class="d-flex flex-column gap-1">
                                                    ...
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    <div class="d-flex align-items-center gap-1">
 <select class="form-select form-select-sm editable-policy-type u-min-w-110" data-lead-id="<?php echo e($lead->id); ?>" >
                                                            <option value="">-- None --</option>
                                            ...
                                            <td>
                                                <div class="d-flex flex-column gap-1">
                                                    ...
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    <div class="d-flex align-items-center gap-1">
 <input type="number" step="0.01" class="form-control form-control-sm editable-coverage u-min-w-100" data-lead-id="<?php echo e($lead->id); ?>" value="<?php echo e($lead->coverage_amount ?? ''); ?>" placeholder="0.00" >
 ...
 <select class="form-select form-select-sm qa-status-dropdown u-min-w-130" data-lead-id="<?php echo e($lead->id); ?>" data-current-status="<?php echo e($lead->qa_status ?? 'Pending'); ?>" >
                                                    ...
                                                    <option value="Avg" <?php echo e(($lead->qa_status ?? '') == Statuses::QA_AVG ? 'selected' : ''); ?>>⚠️ Avg</option>
 ...
 ><?php echo e($lead->qa_reason ?? ''); ?></textarea>
                                            ...
                                            <td>
 <select class="form-select form-select-sm manager-status-dropdown u-min-w-130" data-lead-id="<?php echo e($lead->id); ?>" data-current-status="<?php echo e($lead->manager_status ?? 'pending'); ?>" >
                                                    <option value="pending" <?php echo e(($lead->manager_status ?? Statuses::MGR_PENDING) == Statuses::MGR_PENDING ? 'selected' : ''); ?>>⏳ Pending</option>
                                            ...
                                            <td>
                                                <textarea class="form-control form-control-sm manager-reason-input" 
                                                          ...
                                                          rows="2" 
 ><?php echo e($lead->manager_reason ?? ''); ?></textarea>
                                                <button class="btn btn-sm btn-success mt-1 save-manager-reason" data-lead-id="<?php echo e($lead->id); ?>">
                                                    <i class="bx bx-save"></i> Save
                                                </button>
                                                <?php if(auth()->user()->hasRole(Roles::SUPER_ADMIN) && $lead->manager_status !== Statuses::MGR_PENDING): ?>
 ...
 <form class="d-inline" action="<?php echo e(route('sales.delete', $lead->id)); ?>" method="POST" >
                                                            <?php echo csrf_field(); ?>
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <tr>
                                        <td colspan="<?php echo e(auth()->user()->hasRole(Roles::QA) ? '6' : '15'); ?>" class="text-center py-5 text-muted">
