...
><?php echo e($lead->qa_reason ?? ''); ?></textarea>
                                            ...
                                            <td>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->manager_status === Statuses::MGR_APPROVED): ?>
                                                ...
                                                <?php elseif($lead->manager_status === Statuses::MGR_DECLINED): ?>
                                                ...
                                                <?php elseif($lead->manager_status === Statuses::MGR_UNDERWRITING): ?>
