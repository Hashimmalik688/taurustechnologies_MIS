...
<div class="container-fluid">
    <div class="coa-hdr">
        ...
        <div class="d-flex gap-2 flex-wrap">
            ...
            <a href="<?php echo e(route('chart-of-accounts.create')); ?>" class="act-btn a-primary"><i class="bx bx-plus"></i> Add Account</a>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="kpi-row">
        <div class="kpi-card k-gold"><span class="k-icon"><i class="bx bx-book-open"></i></span><span class="k-val"><?php echo e($totalAccounts); ?></span><span class="k-lbl">Total Accounts</span></div>
        <div class="kpi-card k-green"><span class="k-icon"><i class="bx bx-check-circle"></i></span><span class="k-val"><?php echo e($activeAccounts); ?></span><span class="k-lbl">Active</span></div>
        <div class="kpi-card k-red"><span class="k-icon"><i class="bx bx-x-circle"></i></span><span class="k-val"><?php echo e($inactiveAccounts); ?></span><span class="k-lbl">Inactive</span></div>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $typeCounts->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="kpi-card k-<?php echo e(['blue','teal','purple','warn'][$loop->index] ?? 'gray'); ?>"><span class="k-icon"><i class="bx bx-folder"></i></span><span class="k-val"><?php echo e($count); ?></span><span class="k-lbl"><?php echo e(Str::limit($type, 12)); ?></span></div>
...
$(document).ready(function() {
    ...
    var table = $('#accountsTable').DataTable({
        ...
        ajax: { url: "<?php echo e(route('chart-of-accounts.index')); ?>", data: function(d) { d.account_type = $('#filterType').val(); d.is_active = $('#filterStatus').val(); } },
        columns: [
    ...
    <?php $typeLabels = $typeCounts->keys()->toArray(); $typeValues = $typeCounts->values()->toArray(); ?>
    new ApexCharts(document.querySelector("#accountTypeChart"), {
        series: <?php echo json_encode($typeValues, 15, 512) ?>, labels: <?php echo json_encode($typeLabels, 15, 512) ?>,
    ...
    new ApexCharts(document.querySelector("#accountStatusChart"), {
        series: [<?php echo e($activeAccounts); ?>, <?php echo e($inactiveAccounts); ?>], labels: ['Active', 'Inactive'],
        chart: { type: 'donut', height: 210, fontFamily: 'inherit' },
