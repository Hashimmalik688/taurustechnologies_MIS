...
<?php $__env->startSection('content'); ?>
    <div class="hub-page">
        ...
        <?php $canSeeQaSection = auth()->user()->canViewModule('qa-review') || auth()->user()->canViewModule('qa-scoring'); ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canSeeQaSection): ?>
        ...
        <div class="hub-grid">
            ...
            <?php if(auth()->check() && auth()->user()->canViewModule('qa-scoring')): ?>
