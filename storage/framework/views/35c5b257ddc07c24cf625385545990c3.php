                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-1">
                                <select name="policy_type" class="form-select">
                                    ...
                                    <option value="Term" <?php echo e(request('policy_type') == 'Term' ? 'selected' : ''); ?>>Term</option>
                                    <option value="Whole Life" <?php echo e(request('policy_type') == 'Whole Life' ? 'selected' : ''); ?>>Whole Life</option>
                                    <option value="Universal" <?php echo e(request('policy_type') == 'Universal' ? 'selected' : ''); ?>>Universal</option>
                                </select>
                            </div>
                            <div class="col-md-1">
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $leads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <?php if(auth()->user()->hasRole('QA')): ?>
                                            ...
                                            <td>
                                                <select class="form-select form-select-sm qa-status-dropdown" data-lead-id="<?php echo e($lead->id); ?>" style="min-width: 130px;">
                                        ...
                                        <?php else: ?>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group btn-group-sm" role="group">
                                                    ...
                                                    ?>
                                                    <button onclick="window.location.href='<?php echo e($callUrl); ?>'" class="btn btn-outline-warning" title="Call">
                                                        <i class="fas fa-phone-alt"></i>
                                                    </button>
                                                    <a href="<?php echo e(route('sales.show', $lead->id)); ?>" class="btn btn-outline-info" title="View">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                    <a href="<?php echo e(route('sales.edit', $lead->id)); ?>" class="btn btn-outline-primary" title="Edit">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#delete-<?php echo e($lead->id); ?>" title="Delete">
                                            ...
                                            <td>
                                                <select class="form-select form-select-sm qa-status-dropdown" data-lead-id="<?php echo e($lead->id); ?>" style="min-width: 130px;">
                                                    <option value="In Review" <?php echo e(($lead->qa_status ?? 'In Review') == 'In Review' ? 'selected' : ''); ?>>🔍 In Review</option>
                                                    <option value="Approved" <?php echo e(($lead->qa_status ?? '') == 'Approved' ? 'selected' : ''); ?>>✅ Approved</option>
                                                    <option value="Rejected" <?php echo e(($lead->qa_status ?? '') == 'Rejected' ? 'selected' : ''); ?>>❌ Rejected</option>
                                                </select>
                                            </td>
                                            <td>
                                                <textarea class="form-control form-control-sm qa-reason-input" 
                                            ...
                                            <td>
                                                <select class="form-select form-select-sm manager-status-dropdown" data-lead-id="<?php echo e($lead->id); ?>" style="min-width: 130px;">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\code\taurus-crm-master\resources\views/admin/sales/index.blade.php ENDPATH**/ ?>