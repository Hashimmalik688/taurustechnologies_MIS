        ...
        <div class="col-md-3 col-sm-6 mb-3">
            <div class="d-flex flex-column align-items-center">
                <div class="mb-3 d-flex flex-column align-items-center justify-content-center" style="width: 180px; height: 180px; border-radius: 50%; background: linear-gradient(135deg, #22c55e 0%, #16a34a 100%); box-shadow: 0 8px 20px rgba(34, 197, 94, 0.3);">
                    ...
                    <h1 class="fw-bold mb-0 text-white" style="font-size: 2.5rem;"><?php echo e($good_count); ?></h1>
                </div>
            </div>
        </div>
        <div class="col-md-3 col-sm-6 mb-3">
            <div class="d-flex flex-column align-items-center">
                <div class="mb-3 d-flex flex-column align-items-center justify-content-center" style="width: 180px; height: 180px; border-radius: 50%; background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%); box-shadow: 0 8px 20px rgba(245, 158, 11, 0.3);">
                    ...
                    <h1 class="fw-bold mb-0 text-white" style="font-size: 2.5rem;"><?php echo e($average_count); ?></h1>
                </div>
            </div>
        </div>
        <div class="col-md-3 col-sm-6 mb-3">
            <div class="d-flex flex-column align-items-center">
                <div class="mb-3 d-flex flex-column align-items-center justify-content-center" style="width: 180px; height: 180px; border-radius: 50%; background: linear-gradient(135deg, #ef4444 0%, #dc2626 100%); box-shadow: 0 8px 20px rgba(239, 68, 68, 0.3);">
                    ...
                    <h1 class="fw-bold mb-0 text-white" style="font-size: 2.5rem;"><?php echo e($bad_count); ?></h1>
                </div>
            </div>
        </div>
        <div class="col-md-3 col-sm-6 mb-3">
            <div class="d-flex flex-column align-items-center">
                <div class="mb-3 d-flex flex-column align-items-center justify-content-center" style="width: 180px; height: 180px; border-radius: 50%; background: linear-gradient(135deg, #8b5cf6 0%, #7c3aed 100%); box-shadow: 0 8px 20px rgba(139, 92, 246, 0.3);">
                    ...
                    <h1 class="fw-bold mb-0 text-white" style="font-size: 2.5rem;"><?php echo e($unverified_count); ?></h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form method="GET" action="<?php echo e(route('bank-verification.index')); ?>" class="mb-4">
                        <div class="row g-3">
                            <div class="col-md-4">
                                <input type="text" name="search" class="form-control" placeholder="Search by name, phone, policy..." value="<?php echo e(request('search')); ?>">
                            </div>
                            <div class="col-md-2">
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $leads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($lead->issued_policy_number ?? 'N/A'); ?></td>
                                        ...
                                        <td>
                                            <select class="form-select form-select-sm assigned-bv-dropdown" data-lead-id="<?php echo e($lead->id); ?>">
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $bankVerifiers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $verifier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($verifier->id); ?>" <?php echo e($lead->assigned_bank_verifier == $verifier->id ? 'selected' : ''); ?>>
                                                        <?php echo e($verifier->name); ?>
                                        ...
                                        <td>
                                            <textarea class="form-control form-control-sm bv-comment-field" data-lead-id="<?php echo e($lead->id); ?>" rows="2" placeholder="Enter comment..."><?php echo e($lead->bank_verification_comment); ?></textarea>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <small class="text-muted"><?php echo e($lead->bank_verification_notes ?? '—'); ?></small>
                                        </td>
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="<?php echo e(route('bank-verification.show', $lead->id)); ?>" class="btn btn-sm btn-info" title="View All Details">
                                                    <i class="bx bx-show me-1"></i>View
                                                </a>
                                                <button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#verificationModal-<?php echo e($lead->id); ?>" title="Update Status">
                                    ...
                                    <!-- Verification Modal -->
                                    <div class="modal fade" id="verificationModal-<?php echo e($lead->id); ?>" tabindex="-1">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form action="<?php echo e(route('bank-verification.update', $lead->id)); ?>" method="POST">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="notes-<?php echo e($lead->id); ?>" class="form-label fw-semibold">Reason</label>
                                                            <textarea class="form-control" id="notes-<?php echo e($lead->id); ?>" name="bank_verification_notes" rows="3" placeholder="Add reason..."><?php echo e($lead->bank_verification_notes); ?></textarea>
                                                        </div>
                                                    </div>
