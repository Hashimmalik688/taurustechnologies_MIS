...
<?php $__env->startSection('content'); ?>
    ...
    <div class="kpi-row">
        <div class="kpi-card k-blue ex-card">
            ...
            <div class="k-val"><?php echo e($totalBv); ?></div>
            <div class="k-lbl">Total Records</div>
        </div>
        <div class="kpi-card k-green ex-card">
            <i class="bx bx-check-circle k-icon"></i>
            <div class="k-val"><?php echo e($good_count); ?></div>
            <div class="k-sub" style="color:#1a8754;"><?php echo e($goodPct); ?>%</div>
            <div class="k-lbl">Good</div>
        </div>
        <div class="kpi-card k-warn ex-card">
            <i class="bx bx-error-circle k-icon"></i>
            <div class="k-val"><?php echo e($average_count); ?></div>
            <div class="k-sub" style="color:#b87a14;"><?php echo e($avgPct); ?>%</div>
            <div class="k-lbl">Average</div>
        </div>
        <div class="kpi-card k-red ex-card">
            <i class="bx bx-x-circle k-icon"></i>
            <div class="k-val"><?php echo e($bad_count); ?></div>
            <div class="k-sub" style="color:#c84646;"><?php echo e($badPct); ?>%</div>
            <div class="k-lbl">Bad</div>
        </div>
        <div class="kpi-card k-purple ex-card">
            <i class="bx bx-help-circle k-icon"></i>
            <div class="k-val"><?php echo e($unverified_count); ?></div>
            <div class="k-sub" style="color:#5b49c7;"><?php echo e($unvPct); ?>%</div>
        ...
        <div class="col-xl-9 col-lg-8">
            ...
            <div class="ex-card sec-card">
                <div class="sec-hdr">
                    ...
                    <span style="font-size:0.62rem; color:var(--bs-surface-400);"><?php echo e($leads->total()); ?> records</span>
                </div>
                <form method="GET" action="<?php echo e(route('bank-verification.index')); ?>" class="filter-form">
                    <input type="text" name="search" class="f-input" style="min-width:160px;" placeholder="Search name, phone, policy..." value="<?php echo e(request('search')); ?>">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->hasAny(['search','verification_status','month','year'])): ?>
                        <a href="<?php echo e(route('bank-verification.index')); ?>" class="f-reset"><i class="bx bx-reset"></i> Clear</a>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </form>
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $leads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td><code style="font-size:.68rem;"><?php echo e($lead->issued_policy_number ?? 'N/A'); ?></code></td>
                                    <td class="text-center"><span class="bd-mini bd-gold">$<?php echo e(number_format($lead->monthly_premium ?? 0, 2)); ?></span></td>
                                    <td style="white-space:nowrap; font-size:.7rem;"><?php echo e($lead->issuance_date ? \Carbon\Carbon::parse($lead->issuance_date)->format('M d, Y') : 'N/A'); ?></td>
                                    <td>
                                    ...
                                    <td>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->bankVerifierAssignedByUser): ?>
                                            <strong style="font-size:.72rem;"><?php echo e($lead->bankVerifierAssignedByUser->name); ?></strong>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->bank_verifier_assigned_at): ?>
                                                <div style="font-size:.62rem;color:var(--bs-surface-400);margin-top:1px">
                                                    <?php echo e(\Carbon\Carbon::parse($lead->bank_verifier_assigned_at)->format('M d, h:i A')); ?>
                                    ...
                                    <td>
                                        <textarea class="form-control form-control-sm bv-comment-field" data-lead-id="<?php echo e($lead->id); ?>" rows="1" placeholder="Add comment..." style="font-size:.7rem;"><?php echo e($lead->bank_verification_comment); ?></textarea>
                                    </td>
                                    <td>
                                    ...
                                    <td><small style="color:var(--bs-surface-400); font-size:.68rem;"><?php echo e($lead->bank_verification_notes ?? '—'); ?></small></td>
                                    <td>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->bankVerifiedByUser): ?>
                                            <strong style="font-size:.72rem;"><?php echo e($lead->bankVerifiedByUser->name); ?></strong>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->bank_verification_date): ?>
                                                <div style="font-size:.62rem;color:var(--bs-surface-400);margin-top:1px">
                                                    <?php echo e(\Carbon\Carbon::parse($lead->bank_verification_date)->format('M d, h:i A')); ?>
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            <a href="<?php echo e(route('bank-verification.show', $lead->id)); ?>" class="a-btn a-view" title="View">
                                                <i class="bx bx-show"></i>
                                            </a>
                                            <button class="a-btn a-edit" data-bs-toggle="modal" data-bs-target="#verificationModal-<?php echo e($lead->id); ?>" title="Update">
                                ...
                                <!-- Verification Modal -->
                                <div class="modal fade bv-modal" id="verificationModal-<?php echo e($lead->id); ?>" tabindex="-1">
                                    <div class="modal-dialog modal-dialog-centered modal-sm">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">
                                                    <i class="bx bx-building-house"></i> <?php echo e($lead->cn_name); ?>
                                            ...
                                            <form action="<?php echo e(route('bank-verification.update', $lead->id)); ?>" method="POST">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-2">
                                                        <label for="notes-<?php echo e($lead->id); ?>" class="form-label fw-semibold" style="font-size:.72rem;">Reason / Notes</label>
                                                        <textarea class="form-control" id="notes-<?php echo e($lead->id); ?>" name="bank_verification_notes" rows="2" placeholder="Add notes..." style="font-size:.75rem;"><?php echo e($lead->bank_verification_notes); ?></textarea>
                                                    </div>
                                                </div>
                ...
                <div class="sec-body">
                    <div style="display:flex; gap:0.4rem;">
                        <div style="flex:1; text-align:center; padding:0.5rem 0.3rem; border-radius:0.45rem; border:1px solid rgba(52,195,143,.3); background:rgba(52,195,143,.04);">
                            <div style="font-size:1.2rem; font-weight:700; color:#1a8754;"><?php echo e($goodPct); ?>%</div>
                        ...
                        <div style="flex:1; text-align:center; padding:0.5rem 0.3rem; border-radius:0.45rem; border:1px solid rgba(241,180,76,.3); background:rgba(241,180,76,.04);">
                            <div style="font-size:1.2rem; font-weight:700; color:#b87a14;"><?php echo e($avgPct); ?>%</div>
                    ...
                    <div style="display:flex; gap:0.4rem; margin-top:0.4rem;">
                        <div style="flex:1; text-align:center; padding:0.5rem 0.3rem; border-radius:0.45rem; border:1px solid rgba(244,106,106,.3); background:rgba(244,106,106,.04);">
                            <div style="font-size:1.2rem; font-weight:700; color:#c84646;"><?php echo e($badPct); ?>%</div>
                        ...
                        <div style="flex:1; text-align:center; padding:0.5rem 0.3rem; border-radius:0.45rem; border:1px solid rgba(124,105,239,.3); background:rgba(124,105,239,.04);">
                            <div style="font-size:1.2rem; font-weight:700; color:#5b49c7;"><?php echo e($unvPct); ?>%</div>
