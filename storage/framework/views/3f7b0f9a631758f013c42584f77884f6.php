...
<?php $__env->startSection('css'); ?>
    ...
    <style>
        .agents-header {
            background: linear-gradient(135deg, var(--bs-surface-800) 0%, var(--bs-surface-900) 100%);
            padding: 2rem;
            border-radius: 20px;
            margin-bottom: 2rem;
...
<?php $__env->startSection('content'); ?>
 ...
 <small class="u-fw-600" style="color: var(--bs-ui-success)">Active</small>
                                        ...
                                        <td>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($agent->userDetail && $agent->userDetail->phone): ?>
 ...
 <span class="text-surface-600" >-</span>
                                        ...
                                        <td>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($agent->userDetail && $agent->userDetail->ssn_last4): ?>
 ...
 <span class="text-surface-600" >-</span>
                                        ...
                                        <td>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($agent->userDetail && $agent->userDetail->dob): ?>
                                                <span class="text-white-50">
 ...
 <span class="text-surface-600" >-</span>
                                        ...
                                        <td>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($agent->userDetail && $agent->userDetail->state): ?>
                                                <span class="badge-gold">
 ...
 <span class="text-surface-600" >Not specified</span>
                                        ...
                                        <td>
                                            <div class="carriers-list">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($agent->carrierCommissions && $agent->carrierCommissions->count() > 0): ?>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $agent->carrierCommissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $commission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <span class="badge-carrier">
                                                            <i class="bx bx-car me-1"></i>
                                                            <?php echo e($commission->insuranceCarrier->name); ?>
 ...
 <span class="text-surface-600" >
                                        ...
                                        <td>
                                            <div class="states-list">
                                                ...
                                                ?>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($uniqueStates->count() > 0): ?>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $uniqueStates->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <span class="badge-state">
                                                            <?php echo e($state); ?>

                                                        </span>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($uniqueStates->count() > 5): ?>
                                                        <span class="badge-state" style="background-color: var(--bs-surface-600);">
                                                            +<?php echo e($uniqueStates->count() - 5); ?>

                                                        </span>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    <div class="mt-2">
 <small class="text-surface-400 u-fw-600" >
                                                            <?php echo e($uniqueStates->count()); ?> state(s)
                                                        </small>
                                                    </div>
                                                <?php else: ?>
 <span class="text-surface-600" >
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (\Illuminate\Support\Facades\Blade::check('hasanyrole', [Roles::SUPER_ADMIN, Roles::MANAGER])): ?>
                                                        <li>
                                                            <a class="dropdown-item"
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taurus-crm/resources/views/admin/agents/index.blade.php ENDPATH**/ ?>