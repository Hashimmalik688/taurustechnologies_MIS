...
window.addEventListener('message', async function(e) {
    ...
    switch (type) {
        ...
        case 'zp-contact-search-event':
            try {
                const resp = await fetch(
                    `<?php echo e(route('zoom.phone.search-leads')); ?>?q=${encodeURIComponent(data.searchString)}`,
        ...
        case 'zp-contact-match-event':
            ...
            try {
                const resp = await fetch('<?php echo e(route("zoom.phone.match-contacts")); ?>', {
                    method: 'POST',
                    headers: {
        ...
        case 'zp-call-log-completed-event':
            fetch('<?php echo e(route("zoom.phone.auto-log")); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
