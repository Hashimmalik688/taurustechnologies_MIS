...
<?php $__env->startSection('content'); ?>
    <div class="zp-page-hdr">
        ...
        <div style="display:flex;gap:.5rem;align-items:center">
            <a href="<?php echo e(route('settings.reports.zoom-logs')); ?>" class="act-btn a-primary" style="font-size:.72rem;padding:.3rem .65rem">
        ...
        <div>
            ...
            <div class="zp-card">
                <div class="zp-card-hdr">
                    ...
                    <a href="<?php echo e(route('settings.reports.zoom-logs')); ?>" style="font-size:.65rem;color:var(--bs-gold,#d4af37);text-decoration:none;font-weight:600">View All →</a>
                </div>
                <div class="zp-scroll">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recentCalls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $call): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="zp-call-item">
                            <div style="flex:1;min-width:0">
                                <div class="zp-call-caller"><?php echo e($call->caller_name ?: $call->caller_number ?: '—'); ?></div>
                                <div class="zp-call-callee">→ <?php echo e($call->callee_name ?: $call->callee_number ?: '—'); ?></div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($call->callee_number): ?>
                                    <button class="zp-redial-btn" onclick="dialNumber('<?php echo e($call->callee_number); ?>')">
                                        <i class="bx bx-revision"></i> Redial
                                    </button>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                            <div>
                                <div class="zp-call-time"><?php echo e($call->call_start_time ? $call->call_start_time->format('M d, h:i A') : '—'); ?></div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($call->duration_seconds): ?>
                                    <div class="zp-call-dur" style="margin-top:.2rem"><?php echo e(gmdate('i:s', $call->duration_seconds)); ?></div>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taurus-crm/resources/views/admin/zoom/phone-embed.blade.php ENDPATH**/ ?>