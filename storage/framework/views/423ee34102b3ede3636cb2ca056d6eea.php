...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-5">
                            <div class="input-group">
                                ...
                                <input type="text" id="instantSearch" class="form-control" placeholder="Search by name, phone, SSN, carrier, state, closer..." value="<?php echo e(request('search')); ?>" autofocus>
                                <button id="clearSearch" class="btn btn-outline-secondary <?php echo e(request('search') ? '' : 'd-none'); ?>" type="button"><i class="bx bx-x"></i></button>
                            </div>
                        </div>
                        <div class="col-md-3 d-flex align-items-center">
                            <small class="text-muted" id="resultCount">Showing <?php echo e($leads->total()); ?> leads</small>
                        </div>
                    </div>
 ...
 <form class="d-inline" action="<?php echo e(route('leads.delete', $lead->id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete <?php echo e(addslashes($lead->cn_name)); ?>?');">
                                                    <?php echo csrf_field(); ?>
                                        ...
                                        <td>
 <div contenteditable="true" class="editable-comment u-min-w-150 u-rounded-4 u-max-w-300 border-surface-200" data-lead-id="<?php echo e($lead->id); ?>" style="padding: 4px"><?php echo e($lead->comments ?? 'Click to add...'); ?></div>
                                        </td>
                                    </tr>
