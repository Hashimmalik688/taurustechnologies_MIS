...
<?php $__env->startSection('content'); ?>
    ...
    <div class="sl-card">
        ...
        <form method="GET" action="<?php echo e(route('leads.index')); ?>" id="leadsFilterForm" class="sl-filter-pills">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->hasAny(['carrier','closer','state','date_from','date_to','search'])): ?>
