...
<div class="container-fluid">
    <div class="form-page-hdr">
        <div>
            <h4><i class="bx bx-book-add"></i> Add Account</h4>
            <p>Create a new chart of account entry</p>
        </div>
...
unset($__errorArgs, $__bag); ?>" name="account_code" value="<?php echo e(old('account_code')); ?>" placeholder="e.g., 1000, 2000" required>
...
unset($__errorArgs, $__bag); ?>" name="account_name" value="<?php echo e(old('account_name')); ?>" placeholder="e.g., Cash in Bank" required>
...
unset($__errorArgs, $__bag); ?>" name="account_type" required>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $accountTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($type); ?>" <?php echo e(old('account_type') == $type ? 'selected' : ''); ?>><?php echo e($type); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>" name="opening_balance" value="<?php echo e(old('opening_balance', 0)); ?>" placeholder="0.00">
...
unset($__errorArgs, $__bag); ?>" name="description" rows="3" placeholder="Account description"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="col-md-12">
                        <label style="font-size:.72rem;font-weight:600;display:flex;align-items:center;gap:.35rem;cursor:pointer;">
                            <input type="checkbox" name="is_active" value="1" class="crm-check" <?php echo e(old('is_active', true) ? 'checked' : ''); ?>>
                            Account is Active
                        </label>
                    </div>
                </div>
        ...
        <div class="d-flex justify-content-end gap-2 mt-2">
            ...
            <button type="submit" class="act-btn a-success"><i class="bx bx-save"></i> Save Account</button>
        </div>
    </form>
</div>
<?php $__env->stopSection(); ?>
