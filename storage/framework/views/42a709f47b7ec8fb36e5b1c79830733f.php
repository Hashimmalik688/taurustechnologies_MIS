...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <form action="<?php echo e(route('chart-of-accounts.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="account_code" name="account_code" value="<?php echo e(old('account_code')); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $accountTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($type); ?>" <?php echo e(old('account_type') == $type ? 'selected' : ''); ?>>
                                                <?php echo e($type); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $accountCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($category); ?>" <?php echo e(old('account_category') == $category ? 'selected' : ''); ?>>
                                                <?php echo e($category); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $parentAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($parent->id); ?>" <?php echo e(old('parent_account_id') == $parent->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="opening_balance" name="opening_balance" value="<?php echo e(old('opening_balance', 0)); ?>" 
                                           placeholder="0.00">
...
unset($__errorArgs, $__bag); ?>" 
                                              ...
                                              placeholder="Enter account description"><?php echo e(old('description')); ?></textarea>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taurus-crm/resources/views/admin/chart-of-accounts/create.blade.php ENDPATH**/ ?>