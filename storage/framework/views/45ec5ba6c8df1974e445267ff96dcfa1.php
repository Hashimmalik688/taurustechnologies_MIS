...
<div id="sidebar">
    ...
    <nav class="sidebar-menu">
        ...
        <?php if (! \Illuminate\Support\Facades\Blade::check('role', 'Verifier|Paraguins Closer|Paraguins Validator|Employee|Ravens Closer|Retention Officer|QA|HR')): ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (\Illuminate\Support\Facades\Blade::check('hasrole', 'Verifier|Super Admin')): ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (\Illuminate\Support\Facades\Blade::check('hasrole', 'Paraguins Closer|Super Admin')): ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (\Illuminate\Support\Facades\Blade::check('hasrole', 'Paraguins Validator|Manager|Super Admin')): ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (\Illuminate\Support\Facades\Blade::check('hasrole', 'Ravens Closer|Super Admin')): ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (\Illuminate\Support\Facades\Blade::check('hasrole', 'QA|HR|Super Admin|Manager')): ?>
            <div class="menu-label">QA / HR</div>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (\Illuminate\Support\Facades\Blade::check('hasrole', 'QA|Super Admin')): ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (\Illuminate\Support\Facades\Blade::check('hasrole', 'HR|Super Admin')): ?>
            <a href="<?php echo e(route('admin.public-holidays.index')); ?>" class="menu-item <?php echo e(Request::is('admin/public-holidays*') ? 'active' : ''); ?>">
        ...
        <?php if (! \Illuminate\Support\Facades\Blade::check('role', 'Verifier|Paraguins Closer|Paraguins Validator|Employee|Ravens Closer')): ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (\Illuminate\Support\Facades\Blade::check('hasrole', 'Super Admin')): ?>
                ...
                <a href="<?php echo e(route('admin.insurance-carriers.index')); ?>" class="menu-item <?php echo e(Request::is('admin/insurance-carriers*') ? 'active' : ''); ?>">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (\Illuminate\Support\Facades\Blade::check('hasrole', 'Super Admin|Manager')): ?>
        ...
        <a href="<?php echo e(route('my-dock-records')); ?>" class="menu-item <?php echo e(Request::is('my-dock-records*') ? 'active' : ''); ?>">
            <i class="mdi mdi-cash-minus"></i>
