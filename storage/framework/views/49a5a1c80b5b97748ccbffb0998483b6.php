...
<div class="acct-page">
    ...
    <div class="d-flex align-items-center gap-3 mb-3">
        <div>
            ...
            <small class="text-muted"><?php echo e(\Carbon\Carbon::parse($dateFrom)->format('M j, Y')); ?> — <?php echo e(\Carbon\Carbon::parse($dateTo)->format('M j, Y')); ?></small>
        </div>
    ...
    <div class="kpi-strip d-print-none">
        <div class="kpi-card">
            ...
            <div class="kpi-value text-success">$ <?php echo e(number_format($salesIncome, 2)); ?></div>
        </div>
        <div class="kpi-card">
            <div class="kpi-label">Sales Returns</div>
            <div class="kpi-value text-danger">$ <?php echo e(number_format($salesReturns, 2)); ?></div>
        </div>
        <div class="kpi-card">
            <div class="kpi-label">Total Expenses</div>
            <div class="kpi-value" style="color:#d97706">$ <?php echo e(number_format($totalExpenses, 2)); ?></div>
        </div>
        <div class="kpi-card">
            <div class="kpi-label">Net <?php echo e($netProfit >= 0 ? 'Profit' : 'Loss'); ?></div>
            <div class="kpi-value <?php echo e($netProfit >= 0 ? 'text-profit' : 'text-loss'); ?>">
                <?php echo e($netProfit < 0 ? '(' : ''); ?>$ <?php echo e(number_format(abs($netProfit), 2)); ?><?php echo e($netProfit < 0 ? ')' : ''); ?>
    ...
    <div class="rpt-card">
        <div class="rpt-card-header">
            ...
            Profit & Loss — <?php echo e(\Carbon\Carbon::parse($dateFrom)->format('M j, Y')); ?> to <?php echo e(\Carbon\Carbon::parse($dateTo)->format('M j, Y')); ?>
        ...
        <div class="rpt-row">
            ...
            <span class="rpt-row-value text-success">$ <?php echo e(number_format($salesIncome, 2)); ?></span>
        </div>
        <div class="rpt-row" style="color:#b91c1c">
            <span class="rpt-row-label">Less: Sales Returns & Chargebacks (4200)</span>
            <span class="rpt-row-value">($ <?php echo e(number_format($salesReturns, 2)); ?>)</span>
        </div>
        <div class="rpt-subtotal">
            <span>Gross Profit</span>
            <span class="<?php echo e($grossProfit >= 0 ? 'text-profit' : 'text-loss'); ?>">$ <?php echo e(number_format($grossProfit, 2)); ?></span>
        </div>

        
        <div class="rpt-section-header">Operating Expenses</div>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $expenseRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="rpt-row">
            <span class="rpt-row-label">
                <span class="text-muted font-monospace me-2" style="font-size:.78rem"><?php echo e($exp->account_code); ?></span>
                <?php echo e($exp->account_name); ?>

            </span>
            <span class="rpt-row-value" style="color:#d97706">$ <?php echo e(number_format(max(0, $exp->total_debit - $exp->total_credit), 2)); ?></span>
        </div>
        ...
        <div class="rpt-subtotal">
            ...
            <span style="color:#d97706">$ <?php echo e(number_format($totalExpenses, 2)); ?></span>
        </div>

        
        <div class="rpt-total">
            <span>NET <?php echo e($netProfit >= 0 ? 'PROFIT' : 'LOSS'); ?></span>
            <span class="<?php echo e($netProfit >= 0 ? 'text-profit' : 'text-loss'); ?>">
                <?php echo e($netProfit < 0 ? '(' : ''); ?>$ <?php echo e(number_format(abs($netProfit), 2)); ?><?php echo e($netProfit < 0 ? ')' : ''); ?>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taurus-crm/resources/views/admin/accounting/reports/profit-loss.blade.php ENDPATH**/ ?>