...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php $__env->slot('title'); ?> Edit Lead <?php $__env->endSlot(); ?>
    <?php echo $__env->renderComponent(); ?>

    <form method="POST" action="<?php echo e(route('validator.update', $lead->id)); ?>">
        <?php echo csrf_field(); ?>
                ...
                <div class="card">
                    <div class="card-header bg-info">
                        <h5 class="mb-0">
                            ...
                            Validate Lead - <?php echo e($lead->cn_name); ?>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-4 pt-3 border-top d-flex flex-wrap gap-2">
                            ...
                            <form method="POST" action="<?php echo e(route('validator.mark-forwarded', $lead->id)); ?>" class="d-inline">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PUT'); ?>
                            ...
                            <form method="POST" action="<?php echo e(route('validator.return-to-closer', $lead->id)); ?>" class="d-inline">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PUT'); ?>
                            ...
                            <a href="<?php echo e(route('validator.index')); ?>" class="btn btn-outline-secondary btn-lg">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taurus-crm/resources/views/validator/edit.blade.php ENDPATH**/ ?>