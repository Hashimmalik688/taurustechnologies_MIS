...
<div class="container-fluid">
    ...
    <?php $__env->startComponent('components.breadcrumb'); ?>
        <?php $__env->slot('title'); ?> Create New Support Ticket <?php $__env->endSlot(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                   placeholder="Brief description of the issue" value="<?php echo e(old('subject')); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                      placeholder="Provide detailed information about the issue..." required><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="assigned_to" id="assigned_to" class="form-select <?php $__errorArgs = ['assigned_to'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       placeholder="0.00" step="0.01" min="0" value="<?php echo e(old('total_cost')); ?>">
                            </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">PKR</span>
                                <input type="number" name="quote_amount" id="quote_amount" class="form-control <?php $__errorArgs = ['quote_amount'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                       placeholder="0.00" step="0.01" min="0" value="<?php echo e(old('quote_amount')); ?>">
                            </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <a href="<?php echo e(route('pabs.tickets.index')); ?>" class="btn btn-secondary w-100">Cancel</a>
                            </div>
                            <div class="col-md-6">
