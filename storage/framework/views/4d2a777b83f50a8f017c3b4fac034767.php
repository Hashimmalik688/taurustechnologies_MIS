                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <div class="d-grid gap-2">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasRole('Super Admin') && $lead->bank_verification_status !== null): ?>
