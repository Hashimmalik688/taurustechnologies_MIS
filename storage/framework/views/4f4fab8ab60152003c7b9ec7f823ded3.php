...
<?php $__env->startSection('content'); ?>
    <div class="pm-page-hdr">
        ...
        <div style="display:flex;gap:.35rem;align-items:center">
            ...
            <a href="<?php echo e(route('settings.hub')); ?>" class="act-btn a-primary"><i class="bx bx-arrow-back"></i> Settings</a>
        </div>
    </div>
        ...
        <div class="sec-body" style="padding:.75rem">
            <div class="role-grid">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="role-tile">
                        <h6><i class="bx bx-shield-alt"></i> <?php echo e($role->name); ?></h6>
                        <div class="role-mod"><?php echo e($roleStats[$role->id]['total_modules']); ?> modules</div>
                        ...
                        <div class="perm-pills">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($roleStats[$role->id]['full_access'] > 0): ?>
                                <span class="pp pp-full"><i class="bx bx-check-double"></i> <?php echo e($roleStats[$role->id]['full_access']); ?> Full</span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($roleStats[$role->id]['edit_access'] > 0): ?>
                                <span class="pp pp-edit"><i class="bx bx-edit"></i> <?php echo e($roleStats[$role->id]['edit_access']); ?> Edit</span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($roleStats[$role->id]['view_access'] > 0): ?>
                                <span class="pp pp-view"><i class="bx bx-show"></i> <?php echo e($roleStats[$role->id]['view_access']); ?> View</span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($roleStats[$role->id]['no_access'] > 0): ?>
                                <span class="pp pp-none"><i class="bx bx-block"></i> <?php echo e($roleStats[$role->id]['no_access']); ?> None</span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>

                        <a href="<?php echo e(route('settings.permissions.roles.edit', $role)); ?>" class="pipe-pill-apply" style="font-size:.68rem;padding:.25rem .6rem;display:inline-flex;align-items:center;gap:.2rem;width:100%;justify-content:center">
    ...
    <div class="ex-card sec-card">
        ...
        <div class="sec-body" style="padding:.75rem">
            <div style="font-size:.78rem;color:var(--bs-body-color);line-height:1.5">
                ...
                <a href="<?php echo e(route('users.index')); ?>" style="color:#d4af37;font-weight:600">Users Management</a> and click "Manage Permissions".
            </div>
