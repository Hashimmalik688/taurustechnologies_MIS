...
<head>
    ...
    <title>Payslip - <?php echo e($component->user->name); ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <!-- Header -->
        <div class="header">
            <div class="company-name"><?php echo e($company ?? 'TAURUS CRM'); ?></div>
        ...
        <div class="employee-info">
            <div>
                <div class="info-group">
                    ...
                    <div class="info-value"><?php echo e($component->user->name); ?></div>
                </div>
                <div class="info-group">
                    <div class="info-label">Email</div>
                    <div class="info-value"><?php echo e($component->user->email); ?></div>
                </div>
                <div class="info-group">
            ...
            <div>
                <div class="info-group">
                    ...
                    <div>
                        <span class="component-type <?php echo e($component->component_type); ?>">
                            <?php echo e(ucfirst($component->component_type)); ?> Salary
                        </span>
                    </div>
                </div>
                <div class="info-group">
                    <div class="info-label">Payment Date</div>
                    <div class="info-value"><?php echo e($component->payment_date->format('d M Y')); ?></div>
                </div>
                <div class="info-group">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($component->component_type === 'basic'): ?>
            ...
            <table class="table">
                <tr>
                    <td>Basic Salary</td>
                    <td class="text-right amount">Rs <?php echo e(number_format($component->basic_salary, 2)); ?></td>
                </tr>
                ...
                <tr class="highlight-row">
                    ...
                    <td class="text-right amount text-ui-success-dark">+ Rs <?php echo e(number_format($component->attendance_bonus, 2)); ?></td>
                </tr>
            ...
            <table class="table">
                <tr>
                    <td>Working Days</td>
                    <td class="text-right"><?php echo e($component->working_days ?? 22); ?></td>
                </tr>
                <tr>
                    <td>Days Present</td>
                    <td class="text-right"><?php echo e($component->present_days); ?></td>
                </tr>
                <tr>
                    <td>Leave Days</td>
                    <td class="text-right"><?php echo e($component->leave_days); ?></td>
                </tr>                <tr>
                    <td>Half Days:</td>
                    <td class="text-right"><?php echo e($component->half_days ?? 0); ?></td>
                </tr>
                <tr>
                    <td>Late Days:</td>
                    <td class="text-right"><?php echo e($component->late_days ?? 0); ?></td>
                </tr>                <tr>
                    <td>Half Days</td>
                    <td class="text-right"><?php echo e($component->half_days ?? 0); ?></td>
                </tr>
                <tr>
                    <td>Late Arrivals</td>
                    <td class="text-right"><?php echo e($component->late_days); ?></td>
                </tr>
                <tr>
                    <td>Daily Salary Rate</td>
                    <td class="text-right amount">Rs <?php echo e(number_format($component->daily_salary, 2)); ?></td>
                </tr>
            </table>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($component->attendance_deduction < 0 || $component->dock_deductions > 0): ?>
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td class="text-right amount deduction">- Rs <?php echo e(number_format(abs($component->attendance_deduction), 2)); ?></td>
                </tr>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <tr>
                    ...
                    <td class="text-right amount deduction">- Rs <?php echo e(number_format($component->dock_deductions, 2)); ?></td>
                </tr>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </table>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <?php else: ?>
            ...
            <table class="table">
                <tr>
                    <td>Target Sales</td>
                    <td class="text-right"><?php echo e($component->target_sales); ?> units</td>
                </tr>
                <tr>
                    <td>Actual Sales</td>
                    <td class="text-right"><?php echo e($component->actual_sales); ?> units</td>
                </tr>
                <tr>
                    <td>Chargebacks</td>
                    <td class="text-right"><?php echo e($component->chargeback_count); ?> units</td>
                </tr>
                <tr>
                    <td>Net Approved Sales</td>
                    <td class="text-right amount"><?php echo e($component->net_approved_sales); ?> units</td>
                </tr>
                ...
                <tr class="highlight-row">
                    ...
                    <td class="text-right"><?php echo e($component->extra_sales); ?> units</td>
                </tr>
                <tr class="highlight-row">
                    <td>Bonus Per Extra Sale</td>
                    <td class="text-right amount">Rs <?php echo e(number_format($component->bonus_per_extra_sale, 2)); ?></td>
                </tr>
                <tr class="highlight-row">
                    <td><strong>Bonus Amount</strong></td>
                    <td class="text-right amount text-ui-success-dark"><strong>Rs <?php echo e(number_format($component->calculated_amount, 2)); ?></strong></td>
                </tr>
                <?php else: ?>
        ...
        <table class="table" style="margin-top: 30px;">
            <tr class="subtotal-row">
                ...
                <td class="text-right">Rs <?php echo e(number_format($component->calculated_amount, 2)); ?></td>
            </tr>
            ...
            <tr class="subtotal-row">
                ...
                <td class="text-right deduction">- Rs <?php echo e(number_format($component->deductions, 2)); ?></td>
            </tr>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <tr class="total-row">
                <td>NET AMOUNT PAYABLE</td>
                <td class="text-right net-amount">Rs <?php echo e(number_format($component->net_amount, 2)); ?></td>
            </tr>
        </table>
        ...
        <div class="footer">
            ...
            <p>Generated on <?php echo e(now()->format('d M Y, h:i A')); ?> | Payslip ID: <?php echo e($component->id); ?></p>
        </div>
    </div>
</body>
</html>
<?php /**PATH /var/www/taurus-crm/resources/views/admin/salary/component-payslip.blade.php ENDPATH**/ ?>