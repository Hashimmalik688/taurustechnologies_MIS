<?php $__env->startSection('title'); ?> Edit Insurance Carrier <?php $__env->stopSection(); ?>
...
<?php $__env->startComponent('components.breadcrumb'); ?>
    <?php $__env->slot('li_1'); ?> <a href="<?php echo e(route('admin.insurance-carriers.index')); ?>">Insurance Clusters</a> <?php $__env->endSlot(); ?>
    <?php $__env->slot('title'); ?> Edit <?php echo e($insuranceCarrier->name); ?> <?php $__env->endSlot(); ?>
<?php echo $__env->renderComponent(); ?>

<div class="ce-hdr">
    <h5><i class="bx bx-shield-quarter"></i> Edit Carrier</h5>
    <a href="<?php echo e(route('admin.insurance-carriers.index')); ?>" class="ce-back"><i class="bx bx-arrow-back"></i> Back</a>
</div>
...
<form action="<?php echo e(route('admin.insurance-carriers.update', $insuranceCarrier->id)); ?>" method="POST" id="carrierForm">
    <?php echo csrf_field(); ?>
                ...
                <div class="ce-card-body">
                    <div class="row g-2 mb-2">
                        <div class="col-7">
                            ...
                            <input type="text" name="name" class="ce-input <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('name', $insuranceCarrier->name)); ?>" required>
                            <div class="ce-hint">e.g., American Amicable, Foresters</div>
                        </div>
                        <div class="col-5">
                            <div class="ce-label">Payment Module <span class="text-danger">*</span></div>
                            <select name="payment_module" class="ce-select <?php $__errorArgs = ['payment_module'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required>
                                <option value="on_draft" <?php echo e(old('payment_module', $insuranceCarrier->payment_module) == 'on_draft' ? 'selected' : ''); ?>>On Draft</option>
                                <option value="on_issue" <?php echo e(old('payment_module', $insuranceCarrier->payment_module) == 'on_issue' ? 'selected' : ''); ?>>On Issue</option>
                                <option value="as_earned" <?php echo e(old('payment_module', $insuranceCarrier->payment_module) == 'as_earned' ? 'selected' : ''); ?>>As Earned</option>
                            </select>
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" name="plan_types" class="ce-input <?php $__errorArgs = ['plan_types'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('plan_types', is_array($insuranceCarrier->plan_types) ? implode(', ', $insuranceCarrier->plan_types) : $insuranceCarrier->plan_types)); ?>" placeholder="G.I, Graded, Level, Modified">
                    ...
                    <div class="row g-2 mb-2">
                        <div class="col-6">
                            ...
                            <input type="number" step="0.01" min="0" max="100" name="base_commission_percentage" class="ce-input <?php $__errorArgs = ['base_commission_percentage'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('base_commission_percentage', $insuranceCarrier->base_commission_percentage)); ?>">
                            ...
                            <div>
                                <div class="ce-switch-wrap">
                                    ...
                                    <div class="form-check form-switch mb-0">
                                        <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" <?php echo e(old('is_active', $insuranceCarrier->is_active) ? 'checked' : ''); ?>>
                    ...
                    <div>
                        ...
                        <textarea name="calculation_notes" class="ce-textarea <?php $__errorArgs = ['calculation_notes'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Special rules, exceptions..."><?php echo e(old('calculation_notes', $insuranceCarrier->calculation_notes)); ?></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="ce-info-bar">
                ...
                This carrier has <strong>&nbsp;<?php echo e($insuranceCarrier->leads()->count()); ?>&nbsp;</strong> associated lead(s)
            </div>
        </div>
            ...
            <div class="ce-card">
                ...
                <div class="ce-card-body">
                    ...
                    <div id="brackets-container">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $insuranceCarrier->commissionBrackets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $bracket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="ce-bracket" data-index="<?php echo e($index); ?>">
                            <button type="button" class="ce-bracket-rm remove-bracket"><i class="bx bx-x"></i></button>
                            <input type="hidden" name="brackets[<?php echo e($index); ?>][id]" value="<?php echo e($bracket->id); ?>">
                            <div class="row g-2">
                                <div class="col-3">
                                    <div class="ce-label">Min Age</div>
                                    <input type="number" name="brackets[<?php echo e($index); ?>][age_min]" class="ce-input" value="<?php echo e($bracket->age_min); ?>" min="0" max="120" required>
                                </div>
                                <div class="col-3">
                                    <div class="ce-label">Max Age</div>
                                    <input type="number" name="brackets[<?php echo e($index); ?>][age_max]" class="ce-input" value="<?php echo e($bracket->age_max); ?>" min="0" max="120" required>
                                </div>
                                <div class="col-3">
                                    <div class="ce-label">Commission %</div>
                                    <input type="number" name="brackets[<?php echo e($index); ?>][commission_percentage]" class="ce-input" value="<?php echo e($bracket->commission_percentage); ?>" step="0.01" min="0" max="100" required>
                                </div>
                                <div class="col-3">
                                    <div class="ce-label">Notes</div>
                                    <input type="text" name="brackets[<?php echo e($index); ?>][notes]" class="ce-input" value="<?php echo e($bracket->notes); ?>" placeholder="Optional">
                                </div>
                            </div>
                        </div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($insuranceCarrier->commissionBrackets->isEmpty()): ?>
    ...
    <div class="ce-actions">
        ...
        <a href="<?php echo e(route('admin.insurance-carriers.index')); ?>" class="ce-btn-cancel"><i class="bx bx-x"></i> Cancel</a>
    </div>
</form>
<?php $__env->stopSection(); ?>
...
<script>
let bracketIndex = <?php echo e($insuranceCarrier->commissionBrackets->count()); ?>;
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taurus-crm/resources/views/admin/insurance-carriers/edit.blade.php ENDPATH**/ ?>