            ...
            <form method="POST" action="<?php echo e(route('payroll.working-days.update')); ?>" class="row align-items-end g-3">
                ...
                <div class="col-md-2">
                    ...
                    <input type="number" name="working_days" class="form-control form-control-lg text-center fw-bold payroll-working-days-input" 
                           value="<?php echo e($totalWorkingDays); ?>" min="1" max="31" required <?php if(!auth()->user()->hasAnyRole(['CEO', 'Super Admin', 'Co-ordinator'])): ?> readonly <?php endif; ?>>
                </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasAnyRole(['CEO', 'Super Admin', 'Co-ordinator'])): ?>
                <div class="col-md-2">
                ...
                <table class="table table-hover payroll-table mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="amount text-muted" style="font-size: 0.85rem;"><?php echo e(number_format($perDayWage, 2)); ?></span></td>
                            ...
                            <td><span class="badge bg-success" style="font-size: 0.9rem;"><?php echo e($fullDays); ?></span></td>
                            <td><span class="badge bg-warning text-dark" style="font-size: 0.9rem;"><?php echo e($halfDays); ?></span></td>
                            <td><span class="badge bg-info" style="font-size: 0.9rem;"><?php echo e($lateDays); ?></span></td>
                            <td>
                                <span class="badge" style="background-color: <?php echo e($isQualified ? '#10b981' : '#ef4444'); ?>;">
                                    <?php echo e($isQualified ? 'Yes' : 'No'); ?>

                                </span>
                            </td>
                            <td><span class="amount" style="color: #ef4444;"><?php echo e(number_format($dockAmount, 2)); ?></span></td>
                            <td><span class="amount" style="color: #ef4444;"><?php echo e(number_format($taxDeduction + $otherDeductions, 2)); ?></span></td>
                            <td><span class="amount" style="color: #667eea;"><?php echo e(number_format($netSalary, 2)); ?></span></td>
                            <td><span class="amount" style="color: #ff6b6b;"><?php echo e(number_format($advance, 2)); ?></span></td>
                            <td>
                                                    ...
                                                    <div class="alert border payroll-breakdown-alert">
                                                        <div class="row text-sm">
                                                            <div class="col-md-6">
                                                                ...
                                                                <small style="color: #10b981;"><strong>Other Allowances:</strong> Rs <span id="otherAllow<?php echo e($employee->id); ?>"><?php echo e(number_format($otherAllowances, 2)); ?></span></small>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <small style="color: #667eea;"><strong>Gross Salary:</strong> Rs <?php echo e(number_format($grossSalary, 2)); ?></small><br>
                                                                <small style="color: #ef4444;"><strong>Total Deductions:</strong> Rs <span id="totalDed<?php echo e($employee->id); ?>"><?php echo e(number_format($totalDeductions, 2)); ?></span></small><br>
                                                                <small style="color: #ff6b6b;"><strong>Advance:</strong> Rs <span id="advanceAmt<?php echo e($employee->id); ?>"><?php echo e(number_format($advance, 2)); ?></span></small><br>
                                                                <small style="color: #10b981; font-weight: bold; font-size: 1.1rem;"><strong>Final Payable:</strong> Rs <span id="finalPayable<?php echo e($employee->id); ?>"><?php echo e(number_format($payable, 2)); ?></span></small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <tr style="background-color: #fff3cd; border-left: 3px solid #ffc107;">
                            ...
                            <td style="color: #ef4444;"><?php echo e(number_format($dockAmount, 2)); ?></td>
                            <td style="color: #ef4444;"><?php echo e(number_format($otherDeductions, 2)); ?></td>
                            <td><strong style="color: #667eea;"><?php echo e(number_format($netSalary, 2)); ?></strong></td>
                            <td style="color: #ff6b6b;"><?php echo e(number_format($salaryAdvance, 2)); ?></td>
                            <td><strong style="color: #10b981; font-size: 1.1rem;"><?php echo e(number_format($payable, 2)); ?></strong></td>
                            <td>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasAnyRole(['CEO', 'Super Admin', 'Co-ordinator'])): ?>
                                ...
                                <form id="delete-manual-<?php echo e($entry->id); ?>" action="<?php echo e(route('payroll.manual.destroy', $entry->id)); ?>" method="POST" style="display:none;">
                                    <?php echo csrf_field(); ?>
                    ...
                    <tfoot class="payroll-table-footer" style="font-weight: 700; font-size: 1rem;">
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td class="amount" style="color: #ef4444;"><?php echo e(number_format($totalDockAmount, 2)); ?></td>
                            <td class="amount" style="color: #ef4444;"><?php echo e(number_format($totalOtherDeductions, 2)); ?></td>
                            <td class="amount" style="color: #667eea;"><?php echo e(number_format($totalNetSalary, 2)); ?></td>
                            <td class="amount" style="color: #ff6b6b;"><?php echo e(number_format($totalAdvance, 2)); ?></td>
                            <td class="amount" style="color: #10b981;"><?php echo e(number_format($totalPayable, 2)); ?></td>
                            <td></td>
                        </tr>
                    </tfoot>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
