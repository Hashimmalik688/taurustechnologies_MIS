...
<style>
    ...
    [data-theme="dark"] .payroll-card {
        background: var(--bg-card, var(--bs-surface-800)) !important;
    ...
    [data-theme="dark"] .payroll-card .stat-label {
        color: var(--text-secondary, var(--bs-surface-muted)) !important;
    }
    [data-theme="dark"] .payroll-card small {
        color: var(--text-muted, var(--bs-surface-500)) !important;
    }
    ...
    [data-theme="dark"] .table-header {
        ...
        border-bottom-color: var(--border-color, var(--bs-surface-700)333) !important;
    }
    ...
    [data-theme="dark"] .alert {
        background: var(--bg-tertiary, var(--bs-print-header-bg)) !important;
        color: var(--text-primary, var(--bs-print-border)) !important;
        border-color: var(--border-color, var(--bs-surface-700)333) !important;
    }
    ...
    [data-theme="dark"] .alert code {
        ...
        color: var(--bs-ui-info) !important;
    }
    ...
    [data-theme="dark"] .modal-footer {
        background: var(--bg-tertiary, var(--bs-print-header-bg)) !important;
        border-top-color: var(--border-color, var(--bs-surface-700)333) !important;
    }
...
<div class="container-fluid">
 ...
 <h1 class="h3 mb-1 text-gold" >
    ...
    <div class="stats-grid">
        <div class="payroll-card card-primary">
            ...
            <div class="stat-value"><?php echo e($employees->count() + $manualEntries->count()); ?></div>
            <small>Active: <?php echo e($employees->where('status', 'Active')->count()); ?> | Manual: <?php echo e($manualEntries->count()); ?></small>
        </div>
        <div class="payroll-card card-warning">
            <div class="stat-label">Total Basic Salary</div>
            <div class="stat-value">Rs <?php echo e(number_format($totalBasicSalary, 0)); ?></div>
            <small>Monthly payroll</small>
        </div>
        <div class="payroll-card card-success">
            <div class="stat-label">Qualified for Bonus</div>
            <div class="stat-value"><?php echo e($qualifiedForBonus); ?></div>
            <small>Perfect attendance</small>
        </div>
        <div class="payroll-card card-info">
            <div class="stat-label">Total Bonus</div>
            <div class="stat-value">Rs <?php echo e(number_format($totalBonus, 0)); ?></div>
 ...
 <i class="bx bx-info-circle u-fs-2 text-ui-info" style="margin-right: 1rem"></i>
            <div>
                <h5 class="alert-heading mb-2"><strong>📅 Payroll Period: <?php echo e($periodDisplay); ?></strong></h5>
                <p class="mb-2"><strong>Current Selection:</strong> <?php echo e(Carbon\Carbon::create()->month((int) request('month', now()->month))->format('F')); ?> <?php echo e(request('year', now()->year)); ?> payroll covers <strong><?php echo e($startDate->format('M d, Y')); ?></strong> to <strong><?php echo e($endDate->format('M d, Y')); ?></strong></p>
                <p class="mb-2"><strong>💰 Payment Date:</strong> Salary paid 15 days after period ends (approx. <?php echo e($endDate->copy()->addDays(15)->format('M d, Y')); ?>)</p>
    ...
    <div class="filter-section">
        <form method="GET" action="<?php echo e(route('payroll.index')); ?>" class="row g-3">
            <div class="col-md-2">
                ...
                <select name="month" class="form-select">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 1; $i <= 12; $i++): ?>
                        <option value="<?php echo e($i); ?>" <?php if($month == $i): ?> selected <?php endif; ?>>
                            <?php echo e(Carbon\Carbon::create()->month((int) $i)->format('F')); ?>
    ...
    <div class="card border-0 shadow-sm mb-3 payroll-working-days-card" style="border-left: 4px solid var(--bs-gold) !important;">
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('payroll.working-days.update')); ?>" class="row align-items-end g-3">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="month" value="<?php echo e($month); ?>">
                <input type="hidden" name="year" value="<?php echo e($year); ?>">
                <div class="col-md-8">
                    <h6 class="mb-2 text-gold">
                        <i class="bx bx-calendar-check me-2"></i>Total Working Days for <?php echo e(Carbon\Carbon::create()->month((int) $month)->format('F')); ?> <?php echo e($year); ?>
                ...
                <div class="col-md-2">
                    ...
                    <input type="number" name="working_days" class="form-control form-control-lg text-center fw-bold payroll-working-days-input" 
                           value="<?php echo e($totalWorkingDays); ?>" min="1" max="31" required <?php if(!auth()->user()->hasAnyRole([Roles::CEO, Roles::SUPER_ADMIN, Roles::COORDINATOR])): ?> readonly <?php endif; ?>>
                </div>
        ...
        <div class="card-header border-bottom">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center gap-2">
                    <small class="text-muted me-2">Date Range: <?php echo e($startDate->format('Y-m-d')); ?> to <?php echo e($endDate->format('Y-m-d')); ?></small>
                    ...
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <a href="<?php echo e(route('payroll.print', ['month' => request('month', now()->month), 'year' => request('year', now()->year)])); ?>" class="btn btn-sm btn-success" target="_blank">
                ...
                <table class="table table-hover payroll-table mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><strong><?php echo e($employee->name); ?></strong></td>
                            <td><?php echo e($joinDate); ?></td>
                            <td><span class="amount"><?php echo e(number_format($basicSalary, 2)); ?></span></td>
 <td><span class="amount text-muted u-fs-085" ><?php echo e(number_format($perDayWage, 2)); ?></span></td>
                            <td><span class="amount"><?php echo e(number_format($punctualityBonus, 2)); ?></span></td>
                            <td><span class="amount"><?php echo e(number_format($total, 2)); ?></span></td>
                            <td><span class="badge bg-success u-fs-090"><?php echo e($fullDays); ?></span></td>
                            <td><span class="badge bg-warning text-dark u-fs-090"><?php echo e($halfDays); ?></span></td>
                            <td><span class="badge bg-info u-fs-090"><?php echo e($lateDays); ?></span></td>
                            <td>
                                <span class="badge" style="background-color: <?php echo e($isQualified ? 'var(--bs-ui-success)' : 'var(--bs-ui-danger)'); ?>;">
                                    <?php echo e($isQualified ? 'Yes' : 'No'); ?>

                                </span>
                            </td>
 <td><span class="amount text-ui-danger" ><?php echo e(number_format($dockAmount, 2)); ?></span></td>
 <td><span class="amount text-ui-danger" ><?php echo e(number_format($taxDeduction + $otherDeductions, 2)); ?></span></td>
                            <td><span class="amount text-gradient-start"><?php echo e(number_format($netSalary, 2)); ?></span></td>
                            <td><span class="amount text-ui-danger"><?php echo e(number_format($advance, 2)); ?></span></td>
                            <td>
 <strong class="text-ui-success u-fs-110">
                            ...
                            <td>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasAnyRole([Roles::CEO, Roles::SUPER_ADMIN, Roles::COORDINATOR])): ?>
                                <button class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#editPayrollModal<?php echo e($employee->id); ?>" title="Edit">
                                ...
                                <div class="modal-content">
                                    <form method="POST" action="<?php echo e(route('payroll.update', $employee->id)); ?>">
                                        ...
                                        <div class="modal-header border-bottom">
                                            <h5 class="modal-title"><i class="bx bx-edit me-2"></i>Edit Payroll - <?php echo e($employee->name); ?></h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                        </div>
 <div class="modal-body u-overflow-y-auto" style="max-height: 70vh">
                                            <div class="row">
                                                <!-- Left Column -->
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" name="basic_salary" step="0.01" class="form-control form-control-lg" value="<?php echo e($basicSalary); ?>" required>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" name="punctuality_bonus" step="0.01" class="form-control" value="<?php echo e($employee->punctuality_bonus ?? 0); ?>">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="number" name="full_days" class="form-control form-control-lg" 
                                                                   value="<?php echo e($fullDays); ?>" min="0" max="31" required>
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="number" name="half_days" class="form-control form-control-lg" 
                                                                   value="<?php echo e($halfDays); ?>" min="0" max="31" required>
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="number" name="late_days" class="form-control form-control-lg" 
                                                                   value="<?php echo e($lateDays); ?>" min="0" max="31" required>
                                                    ...
                                                    <div class="alert alert-info">
                                                        ...
                                                        <ul class="mb-0 small">
                                                            <li>Total working days: <strong><?php echo e($totalWorkingDays); ?> days</strong></li>
                                                            ...
                                                            <li>1 half day is acceptable if you have at least <?php echo e($totalWorkingDays - 1); ?> full days</li>
                                                            <li>Example: <?php echo e($totalWorkingDays); ?> full + 0 half + 0-3 late = ✅ YES punctuality</li>
                                                            <li>Example: <?php echo e($totalWorkingDays - 1); ?> full + 1 half + 0-3 late = ✅ YES punctuality</li>
                                                            <li>Example: <?php echo e($totalWorkingDays - 2); ?> full + 2 half = ❌ NO punctuality</li>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" name="override_punctuality_bonus" step="0.01" class="form-control" value="<?php echo e($employee->override_punctuality_bonus ?? 0); ?>" placeholder="Leave blank to use default">
                                                        <small class="text-muted">Leave blank to use default Rs <?php echo e(number_format($punctualityBonus, 2)); ?></small>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" name="tax_deduction" step="0.01" class="form-control form-control-md" value="<?php echo e($employee->tax_deduction ?? 0); ?>">
                                                    </div>

                                                    <div class="mb-3">
                                                        <label class="form-label">Other Deductions (Rs)</label>
                                                        <input type="number" name="other_deductions" step="0.01" class="form-control" value="<?php echo e($employee->other_deductions ?? 0); ?>" placeholder="Additional deductions if any">
                                                    </div>

                                                    <div class="mb-3">
                                                        <label class="form-label">Other Allowances (Rs)</label>
                                                        <input type="number" name="other_allowances" step="0.01" class="form-control" value="<?php echo e($employee->other_allowances ?? 0); ?>" placeholder="Bonuses, incentives, etc.">
                                                    </div>

                                                    <div class="mb-3">
                                                        <label class="form-label">Salary Advance (Rs)</label>
                                                        <input type="number" name="salary_advance" step="0.01" class="form-control form-control-md" value="<?php echo e($employee->salary_advance ?? 0); ?>">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="alert border payroll-breakdown-alert">
                                                        <div class="row text-sm">
                                                            <div class="col-md-6">
                                                                <small><strong>Basic Salary:</strong> Rs <?php echo e(number_format($basicSalary, 2)); ?></small><br>
                                                                <small><strong>Punctuality Bonus:</strong> Rs <?php echo e(number_format($punctualityBonus, 2)); ?></small><br>
                                                                <small><strong>Sales Bonus:</strong> Rs <?php echo e(number_format($bonus, 2)); ?></small><br>
 <small class="text-ui-success" ><strong>Other Allowances:</strong> Rs <span id="otherAllow<?php echo e($employee->id); ?>"><?php echo e(number_format($otherAllowances, 2)); ?></span></small>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <small class="text-gradient-start"><strong>Gross Salary:</strong> Rs <?php echo e(number_format($grossSalary, 2)); ?></small><br>
 <small class="text-ui-danger" ><strong>Total Deductions:</strong> Rs <span id="totalDed<?php echo e($employee->id); ?>"><?php echo e(number_format($totalDeductions, 2)); ?></span></small><br>
                                                                <small class="text-ui-danger"><strong>Advance:</strong> Rs <span id="advanceAmt<?php echo e($employee->id); ?>"><?php echo e(number_format($advance, 2)); ?></span></small><br>
 <small class="text-ui-success fw-bold u-fs-110"><strong>Final Payable:</strong> Rs <span id="finalPayable<?php echo e($employee->id); ?>"><?php echo e(number_format($payable, 2)); ?></span></small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-12">
                                                    ...
                                                    <textarea name="payroll_notes" class="form-control" rows="3" maxlength="500" placeholder="Add any notes for payroll processing..."><?php echo e($employee->payroll_notes ?? ''); ?></textarea>
                        ...
                        <?php
                            ...
                            $totalPayable += $payable;
                        ?>
                        <tr class="bg-surface-50" style="border-left: 3px solid var(--bs-status-leave)">
                            <td><?php echo e($employees->count() + $loop->iteration); ?></td>
                            <td>
                                <?php echo e($entry->employee_name); ?>

                                <span class="badge bg-warning text-dark ms-1" title="Manual Entry">M</span>
                            </td>
                            <td><?php echo e($joinDate); ?></td>
                            <td><?php echo e(number_format($basicSalary, 2)); ?></td>
                            <td><?php echo e(number_format($perDayWage, 2)); ?></td>
                            <td><?php echo e(number_format($punctualityBonus, 2)); ?></td>
                            <td><strong><?php echo e(number_format($total, 2)); ?></strong></td>
                            <td><span class="badge bg-success"><?php echo e($fullDays); ?></span></td>
                            <td><span class="badge bg-warning text-dark"><?php echo e($halfDays); ?></span></td>
                            <td><span class="badge bg-danger"><?php echo e($lateDays); ?></span></td>
                            <td>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($entry->is_qualified): ?>
                                    <span class="badge bg-success">Yes</span>
                                <?php else: ?>
                                    <span class="badge bg-danger">No</span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </td>
 <td class="text-ui-danger" ><?php echo e(number_format($dockAmount, 2)); ?></td>
 <td class="text-ui-danger" ><?php echo e(number_format($otherDeductions, 2)); ?></td>
                            <td><strong class="text-gradient-start"><?php echo e(number_format($netSalary, 2)); ?></strong></td>
                            <td class="text-ui-danger"><?php echo e(number_format($salaryAdvance, 2)); ?></td>
 <td><strong class="text-ui-success u-fs-110"><?php echo e(number_format($payable, 2)); ?></strong></td>
                            <td>
                                <?php if(auth()->check() && auth()->user()->canEditModule('payroll')): ?>
                                <button class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#editManualEntryModal<?php echo e($entry->id); ?>" title="Edit Manual Entry">
                                    <i class="bx bx-edit"></i>
                                </button>
                                <?php endif; ?>
                                <?php if(auth()->check() && auth()->user()->canDeleteInModule('payroll')): ?>
                                <button class="btn btn-sm btn-danger" onclick="if(confirm('Delete manual entry for <?php echo e($entry->employee_name); ?>?')) { document.getElementById('delete-manual-<?php echo e($entry->id); ?>').submit(); }" title="Delete Manual Entry">
                                    <i class="bx bx-trash"></i>
                                </button>
                                <form id="delete-manual-<?php echo e($entry->id); ?>" action="<?php echo e(route('payroll.manual.destroy', $entry->id)); ?>" method="POST" class="d-none">
                                    <?php echo csrf_field(); ?>
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <form method="POST" action="<?php echo e(route('payroll.manual.update', $entry->id)); ?>">
                                        ...
                                        <div class="modal-header border-bottom">
                                            <h5 class="modal-title"><i class="bx bx-edit me-2"></i>Edit Manual Entry - <?php echo e($entry->employee_name); ?></h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                        </div>
 <div class="modal-body u-overflow-y-auto" style="max-height: 70vh">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="employee_name" class="form-control" value="<?php echo e($entry->employee_name); ?>" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Join Date</label>
                                                        <input type="date" name="join_date" class="form-control" value="<?php echo e($entry->join_date ? $entry->join_date->format('Y-m-d') : ''); ?>">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label fw-bold">Basic Salary (Rs) <span class="text-danger">*</span></label>
                                                        <input type="number" name="basic_salary" step="0.01" class="form-control" value="<?php echo e($entry->basic_salary); ?>" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Punctuality Bonus (Rs)</label>
                                                        <input type="number" name="punctuality_bonus" step="0.01" class="form-control" value="<?php echo e($entry->punctuality_bonus); ?>">
                                                    </div>
                                                    <div class="row mb-3">
                                                        <div class="col-4">
                                                            <label class="form-label">Full Days</label>
                                                            <input type="number" name="full_days" class="form-control" value="<?php echo e($entry->full_days); ?>" min="0">
                                                        </div>
                                                        <div class="col-4">
                                                            <label class="form-label">Half Days</label>
                                                            <input type="number" name="half_days" class="form-control" value="<?php echo e($entry->half_days); ?>" min="0">
                                                        </div>
                                                        <div class="col-4">
                                                            <label class="form-label">Late Days</label>
                                                            <input type="number" name="late_days" class="form-control" value="<?php echo e($entry->late_days); ?>" min="0">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="is_qualified" class="form-select">
                                                            <option value="0" <?php echo e(!$entry->is_qualified ? 'selected' : ''); ?>>No</option>
                                                            <option value="1" <?php echo e($entry->is_qualified ? 'selected' : ''); ?>>Yes</option>
                                                        </select>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Dock Amount (Rs)</label>
                                                        <input type="number" name="dock_amount" step="0.01" class="form-control" value="<?php echo e($entry->dock_amount); ?>">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Other Deductions (Rs)</label>
                                                        <input type="number" name="other_deductions" step="0.01" class="form-control" value="<?php echo e($entry->other_deductions); ?>">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Other Allowances (Rs)</label>
                                                        <input type="number" name="other_allowances" step="0.01" class="form-control" value="<?php echo e($entry->other_allowances); ?>">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Salary Advance (Rs)</label>
                                                        <input type="number" name="salary_advance" step="0.01" class="form-control" value="<?php echo e($entry->salary_advance); ?>">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label">Notes</label>
                                                        <textarea name="notes" class="form-control" rows="3"><?php echo e($entry->notes); ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
 ...
 <tfoot class="payroll-table-footer u-fw-700 u-fs-1" >
                        <tr>
                            <td colspan="3" class="text-end pe-3"><strong>TOTAL:</strong></td>
                            <td class="amount"><?php echo e(number_format($totalBasicSalary, 2)); ?></td>
                            <td></td> <!-- Per Day Wage - no total needed -->
                            <td class="amount"><?php echo e(number_format($totalPunctuality, 2)); ?></td>
                            <td class="amount"><?php echo e(number_format($totalGross, 2)); ?></td>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td></td>
 <td class="amount text-ui-danger" ><?php echo e(number_format($totalDockAmount, 2)); ?></td>
 <td class="amount text-ui-danger" ><?php echo e(number_format($totalOtherDeductions, 2)); ?></td>
                            <td class="amount text-gradient-start"><?php echo e(number_format($totalNetSalary, 2)); ?></td>
                            <td class="amount text-ui-danger"><?php echo e(number_format($totalAdvance, 2)); ?></td>
 <td class="amount text-ui-success" ><?php echo e(number_format($totalPayable, 2)); ?></td>
                            <td></td>
                        </tr>
                    </tfoot>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
