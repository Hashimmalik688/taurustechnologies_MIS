                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="zoomNumber" name="zoom_number"
                                        value="<?php echo e(old('zoom_number', $user->zoom_number ?? '')); ?>"
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="zoomUserId" name="zoom_user_id"
                                        value="<?php echo e(old('zoom_user_id', $user->zoom_user_id ?? '')); ?>"
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="zoomExtension" name="zoom_extension"
                                        value="<?php echo e(old('zoom_extension', $user->zoom_extension ?? '')); ?>"
