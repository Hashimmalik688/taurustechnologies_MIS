                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    ...
                                    <tr class="employee-row <?php echo e($existingRecord ? 'table-light' : ''); ?>">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <?php if($employee->roles->isNotEmpty()): ?>
                                                        <div class="mt-1">
                                                    ...
                                                    <?php endif; ?>
                                                    <?php if(!$employee->basic_salary || $employee->basic_salary <= 0): ?>
                                                        <div class="mt-1">
                                        ...
                                        <td>
                                            <?php if($employee->is_sales_employee): ?>
                                        ...
                                        <td>
                                            <?php if($employee->is_sales_employee && $extraSales > 0): ?>
                                        ...
                                        <td>
                                            <?php if($existingRecord): ?>
                                                <?php if($existingRecord->status == 'paid'): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\code\taurus-crm-master\resources\views/admin/salary/index.blade.php ENDPATH**/ ?>