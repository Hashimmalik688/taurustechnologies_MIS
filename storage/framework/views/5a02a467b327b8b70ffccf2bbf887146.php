            ...
            <div class="detail-card">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($component->component_type === 'basic'): ?>
                    ...
                    <div class="breakdown-table">
                        ...
                        <div class="breakdown-row">
                            ...
                            <span class="breakdown-value" style="color: #10b981;">+ Rs <?php echo e(number_format($component->attendance_bonus, 2)); ?></span>
                        </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="breakdown-row" style="font-size: 1.1rem;">
                            ...
                            <span class="breakdown-value" style="color: #667eea; font-size: 1.25rem;">Rs <?php echo e(number_format($component->calculated_amount, 2)); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="breakdown-table">
                        ...
                        <div class="breakdown-row">
                            ...
                            <span class="breakdown-value" style="color: #ef4444;">Rs <?php echo e(number_format(abs($component->attendance_deduction), 2)); ?></span>
                        </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                ...
                <?php else: ?>
                    ...
                    <div class="breakdown-table">
                        ...
                        <div class="breakdown-row">
                            ...
                            <span class="breakdown-value" style="color: #10b981;">Rs <?php echo e(number_format($component->calculated_amount, 2)); ?></span>
                        </div>
                        <?php else: ?>
                        <div class="breakdown-row">
                        ...
                        <div class="breakdown-row" style="font-size: 1.1rem;">
                            ...
                            <span class="breakdown-value" style="color: #198754; font-size: 1.25rem;">Rs <?php echo e(number_format($component->calculated_amount, 2)); ?></span>
                        </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="breakdown-table">
                    ...
                    <div class="breakdown-row">
                        ...
                        <span class="breakdown-value" style="color: #ef4444;">Rs <?php echo e(number_format($component->dock_deductions, 2)); ?></span>
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="breakdown-row">
                        ...
                        <span class="breakdown-value" style="color: #ef4444;">Rs <?php echo e(number_format($component->manual_deductions, 2)); ?></span>
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="breakdown-row">
                        ...
                        <span class="breakdown-value" style="color: #ef4444;">Rs <?php echo e(number_format($component->deductions, 2)); ?></span>
                    </div>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="detail-card" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; border: none; margin-top: 2rem;">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div style="font-size: 1.5rem; font-weight: 700;">Rs <?php echo e(number_format($component->calculated_amount, 2)); ?></div>
                        </div>
                        <div class="col-md-6 text-end">
                            <div class="detail-field-label" style="color: rgba(255,255,255,0.8);">Net Amount</div>
                            <div style="font-size: 1.5rem; font-weight: 700;">Rs <?php echo e(number_format($component->net_amount, 2)); ?></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="detail-card">
                ...
                <div class="breakdown-table">
                    ...
                    <div class="breakdown-row">
                        ...
                        <span class="breakdown-value" style="font-size: 0.9rem;"><?php echo e($component->calculated_at->format('d M Y, h:i A')); ?></span>
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="breakdown-row">
                        ...
                        <span class="breakdown-value" style="font-size: 0.9rem;"><?php echo e($component->approved_at->format('d M Y, h:i A')); ?></span>
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="breakdown-row">
                        ...
                        <span class="breakdown-value" style="font-size: 0.9rem;"><?php echo e($component->paid_at->format('d M Y, h:i A')); ?></span>
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
                    ...
                    <div class="timeline-item" style="margin-bottom: 1.5rem;">
                        <div style="display: flex; align-items: flex-start;">
                            <div style="
                                width: 24px;
                                height: 24px;
                                background: <?php echo e($component->approved_at ? '#10b981' : '#d1d5db'); ?>;
                                border-radius: 50%;
                                display: flex;
                                align-items: center;
                                justify-content: center;
                    ...
                    <div class="timeline-item">
                        <div style="display: flex; align-items: flex-start;">
                            <div style="
                                width: 24px;
                                height: 24px;
                                background: <?php echo e($component->paid_at ? '#0d6efd' : '#d1d5db'); ?>;
                                border-radius: 50%;
                                display: flex;
                                align-items: center;
                                justify-content: center;
