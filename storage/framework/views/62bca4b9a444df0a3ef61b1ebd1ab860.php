...
<?php $__env->startSection('content'); ?>
        ...
        <div class="ld-stepper">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <span class="ld-sp <?php echo e($cls); ?>">
                    <span class="sp-check">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isDanger): ?> <i class="mdi mdi-alert-circle" style="color:#dc3545;"></i>
                        <?php elseif($isDone): ?> <i class="mdi mdi-check-bold"></i>
    ...
    <div class="ld-cols">
        ...
        <div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($insurance->closer_qna)): ?>
            <div class="ld-card">
                <div class="ld-card-hdr"><h5><i class="mdi mdi-chat-question"></i> Closer Q &amp; A</h5></div>
                <div class="ld-card-body">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = (is_string($insurance->closer_qna) ? json_decode($insurance->closer_qna, true) : $insurance->closer_qna); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $pair): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="ld-f" style="align-items:flex-start;margin-bottom:.6rem">
                        <span class="ld-fl" style="padding-top:.15rem">Q<?php echo e($i + 1); ?></span>
                        <span class="ld-fv" style="display:flex;flex-direction:column;gap:.25rem">
                            <strong><?php echo e($pair['question'] ?? ''); ?></strong>
                            <span style="color:var(--bs-secondary-color)"><?php echo e($pair['answer'] ?? '—'); ?></span>
                        </span>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
