<?php $__env->startSection('title', 'Reset Password | CRM – Taurus Technologies'); ?>
    ...
    <div class="inner">
      <div class="auth-header">
        ...
        <div class="icon-circle">
          <i class="bx bx-key u-fs-32 text-gold"></i>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master-without-nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taurus-crm/resources/views/auth/passwords/reset.blade.php ENDPATH**/ ?>