                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    ...
                                                    <select name="employee" class="form-select">
                                                        ...
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = \App\Models\User::role(Roles::EMPLOYEE)->excludePartners()->orderBy('name')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <select name="status" class="form-select">
                                                        ...
                                                        <option value="draft"
                                                            <?php echo e(request('status') == Statuses::SALARY_DRAFT ? 'selected' : ''); ?>>Draft
                                                        </option>
                                                        <option value="calculated"
                                                            <?php echo e(request('status') == Statuses::SALARY_CALCULATED ? 'selected' : ''); ?>>
                                                            Calculated</option>
                                                        <option value="approved"
                                                            <?php echo e(request('status') == Statuses::SALARY_APPROVED ? 'selected' : ''); ?>>
                                                            Approved</option>
                                                        <option value="paid"
                                                            <?php echo e(request('status') == Statuses::SALARY_PAID ? 'selected' : ''); ?>>Paid
                                                        </option>
                                                    </select>
                                                </div>
                                                <div class="col-md-3">
                                ...
                                <tbody>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $salaryRecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr class="salary-record-row" data-record-id="<?php echo e($record->id); ?>">
                                            ...
                                            <td>
                                                <span
                                                    class="badge bg-<?php echo e($record->status == Statuses::SALARY_PAID ? 'success' : ($record->status == Statuses::SALARY_APPROVED ? 'info' : ($record->status == Statuses::SALARY_CALCULATED ? 'warning' : 'secondary'))); ?>">
                                                    <?php echo e(ucfirst($record->status)); ?>

                                                </span>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($record->status == Statuses::SALARY_PAID && $record->paid_at): ?>
                                                    <br><small
                                                        class="text-muted"><?php echo e($record->paid_at->format('M d')); ?></small>
                                                <?php elseif($record->status == Statuses::SALARY_APPROVED && $record->approved_at): ?>
                                                    <br><small
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($record->status == Statuses::SALARY_CALCULATED): ?>
                                                            <li>
                                                        ...
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($record->status == Statuses::SALARY_APPROVED): ?>
                                                            <li>
                                                                <hr class="dropdown-divider">
                                                            </li>
                                                            <li>
