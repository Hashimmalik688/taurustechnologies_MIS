<?php $__env->startSection('title'); ?> Edit Partner — <?php echo e($partner->name); ?> <?php $__env->stopSection(); ?>
...
<div class="ep-page-hdr">
    <h5><i class="bx bx-edit" style="color:#556ee6"></i> Edit Partner — <?php echo e($partner->name); ?></h5>
    <a href="<?php echo e(route('admin.partners.index')); ?>" class="ep-back-btn"><i class="bx bx-arrow-back"></i> Back to Partners</a>
</div>
...
<form method="POST" action="<?php echo e(route('admin.partners.update', $partner->id)); ?>" id="partnerForm">
        ...
        <div class="ep-card-body">
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <input type="text" class="ep-input <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e(old('name', $partner->name)); ?>" required>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="ep-input <?php $__errorArgs = ['code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="code" value="<?php echo e(old('code', $partner->code)); ?>" required>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="col-md-4">
                    ...
                    <input type="email" class="ep-input <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(old('email', $partner->email)); ?>">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="ep-input <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="phone" value="<?php echo e(old('phone', $partner->phone)); ?>" placeholder="(555) 123-4567">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="ep-input <?php $__errorArgs = ['ssn_last4'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="ssn_last4" value="<?php echo e(old('ssn_last4', $partner->ssn_last4)); ?>" maxlength="4" pattern="[0-9]{4}" placeholder="1234">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" class="ep-input <?php $__errorArgs = ['our_commission_percentage'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="our_commission_percentage" value="<?php echo e(old('our_commission_percentage', $partner->our_commission_percentage ?? 0)); ?>" min="0" max="100" step="0.01">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="col-md-3">
                    ...
                    <div class="ep-switch" style="margin-top:.3rem">
                        <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" <?php echo e(old('is_active', $partner->is_active) ? 'checked' : ''); ?>>
        ...
        <div class="ep-card-body">
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <div class="ep-status-box <?php echo e($partner->password ? 'set' : 'unset'); ?>">
                        <i class="bx <?php echo e($partner->password ? 'bx-check-circle' : 'bx-error-circle'); ?>"></i>
                        <?php echo e($partner->password ? 'Password set — partner can login' : 'No password — partner cannot login'); ?>

                    </div>
                </div>
                <div class="col-md-4">
                    <label class="ep-label">New Password</label>
                    <input type="password" class="ep-input <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="password" placeholder="Min 8 characters">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="ep-card">
        ...
        <div class="ep-card-body">
            ...
            <?php echo $__env->make('admin.partners.partials.carrier-states', [
    ...
    <div class="ep-actions">
        <a href="<?php echo e(route('admin.partners.index')); ?>" class="ep-btn secondary"><i class="bx bx-x"></i> Cancel</a>
...
$(document).ready(function() {
    ...
    <?php $__currentLoopData = $insuranceCarriers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $carrier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if(isset($partnerCarrierStates[$carrier->id]) && $partnerCarrierStates[$carrier->id]->isNotEmpty()): ?>
            $('#carrier-state-section-<?php echo e($carrier->id); ?>').removeClass('d-none');
        <?php endif; ?>
...
function openCreateCarrierModal() {
    ...
    window.open('<?php echo e(route("admin.insurance-carriers.create")); ?>?modal=1', 'CreateCarrier', `width=${w},height=${h},left=${l},top=${t},scrollbars=yes,resizable=yes`);
    window.addEventListener('message', function(e) { if (e.data.type === 'carrierCreated') location.reload(); });
}
</script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taurus-crm/resources/views/admin/partners/edit.blade.php ENDPATH**/ ?>