...
unset($__errorArgs, $__bag); ?>"
                                        id="name" name="name" value="<?php echo e(old('name', $partner->name)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                        id="code" name="code" value="<?php echo e(old('code', $partner->code)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                        id="email" name="email" value="<?php echo e(old('email', $partner->email)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                        id="phone" name="phone" value="<?php echo e(old('phone', $partner->phone)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                        id="ssn_last4" name="ssn_last4" value="<?php echo e(old('ssn_last4', $partner->ssn_last4)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        value="<?php echo e(old('our_commission_percentage', $partner->our_commission_percentage ?? 0)); ?>"
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <div class="alert alert-<?php echo e($partner->password ? 'success' : 'warning'); ?> mb-0">
    ...
    <script>
        ...
        function openCreateCarrierModal() {
            ...
            const carrierWindow = window.open(
                '<?php echo e(route("admin.insurance-carriers.create")); ?>?modal=1',
                'CreateCarrier',
