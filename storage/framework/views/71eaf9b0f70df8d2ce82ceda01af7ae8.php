    ...
    <div class="row">
        <div class="col-lg-8 offset-lg-2">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('admin.holidays.update', $holiday)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                      ...
                                      name="description" 
                                      rows="3" 
                                      placeholder="Optional description for this holiday"><?php echo e(old('description', $holiday->description)); ?></textarea>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" 
                                       ...
                                       name="is_recurring" 
                                       value="1"
                                       <?php echo e(old('is_recurring', $holiday->is_recurring) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taurus-crm/resources/views/admin/holidays/edit.blade.php ENDPATH**/ ?>