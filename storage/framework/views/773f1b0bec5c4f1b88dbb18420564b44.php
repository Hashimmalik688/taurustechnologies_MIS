                        ...
                        <div class="modal-body" style="max-height:70vh;overflow-y:auto;padding:1rem 1.25rem">
                            ...
                            <div style="display:grid;grid-template-columns:1fr 1fr;gap:.65rem;margin-top:.75rem">
                                ...
                                <div>
                                    ...
                                    <input type="text" class="f-input" name="zoom_user_id" value="<?php echo e($user->zoom_user_id ?? ''); ?>" placeholder="From Zoom admin panel">
                                </div>
                                <div>
                                    <label class="f-label">Zoom Extension</label>
                                    <input type="text" class="f-input" name="zoom_extension" value="<?php echo e($user->zoom_extension ?? ''); ?>" placeholder="e.g. 1234">
                                </div>
                            </div>
                        </div>
