                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="roles[]" value="<?php echo e(Roles::SUPER_ADMIN); ?>" id="modal-role-super-admin-<?php echo e($user->id); ?>" 
                                                <?php echo e(in_array(Roles::SUPER_ADMIN, $currentRoles) ? 'checked' : ''); ?>>
                                            <label class="form-check-label" for="modal-role-super-admin-<?php echo e($user->id); ?>">Super Admin</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="roles[]" value="<?php echo e(Roles::MANAGER); ?>" id="modal-role-manager-<?php echo e($user->id); ?>"
                                                <?php echo e(in_array(Roles::MANAGER, $currentRoles) ? 'checked' : ''); ?>>
                                            <label class="form-check-label" for="modal-role-manager-<?php echo e($user->id); ?>">Manager</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="roles[]" value="<?php echo e(Roles::HR); ?>" id="modal-role-hr-<?php echo e($user->id); ?>"
                                                <?php echo e(in_array(Roles::HR, $currentRoles) ? 'checked' : ''); ?>>
                                            <label class="form-check-label" for="modal-role-hr-<?php echo e($user->id); ?>">HR</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="roles[]" value="<?php echo e(Roles::EMPLOYEE); ?>" id="modal-role-employee-<?php echo e($user->id); ?>"
                                                <?php echo e(in_array(Roles::EMPLOYEE, $currentRoles) ? 'checked' : ''); ?>>
                                            <label class="form-check-label" for="modal-role-employee-<?php echo e($user->id); ?>">Employee</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="roles[]" value="<?php echo e(Roles::COORDINATOR); ?>" id="modal-role-co-ordinator-<?php echo e($user->id); ?>"
                                                <?php echo e(in_array(Roles::COORDINATOR, $currentRoles) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="roles[]" value="<?php echo e(Roles::PEREGRINE_CLOSER); ?>" id="modal-role-peregrine-closer-<?php echo e($user->id); ?>"
                                                <?php echo e(in_array(Roles::PEREGRINE_CLOSER, $currentRoles) ? 'checked' : ''); ?>>
                                            <label class="form-check-label" for="modal-role-peregrine-closer-<?php echo e($user->id); ?>">Peregrine Closer</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="roles[]" value="<?php echo e(Roles::PEREGRINE_VALIDATOR); ?>" id="modal-role-peregrine-validator-<?php echo e($user->id); ?>"
                                                <?php echo e(in_array(Roles::PEREGRINE_VALIDATOR, $currentRoles) ? 'checked' : ''); ?>>
                                            <label class="form-check-label" for="modal-role-peregrine-validator-<?php echo e($user->id); ?>">Peregrine Validator</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="roles[]" value="<?php echo e(Roles::VERIFIER); ?>" id="modal-role-verifier-<?php echo e($user->id); ?>"
                                                <?php echo e(in_array(Roles::VERIFIER, $currentRoles) ? 'checked' : ''); ?>>
                                            <label class="form-check-label" for="modal-role-verifier-<?php echo e($user->id); ?>">Verifier</label>
                                        </div>
                                        <hr class="my-2">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="roles[]" value="<?php echo e(Roles::RAVENS_CLOSER); ?>" id="modal-role-ravens-closer-<?php echo e($user->id); ?>"
                                                <?php echo e(in_array(Roles::RAVENS_CLOSER, $currentRoles) ? 'checked' : ''); ?>>
                                            <label class="form-check-label" for="modal-role-ravens-closer-<?php echo e($user->id); ?>">Ravens Closer</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="roles[]" value="<?php echo e(Roles::RETENTION_OFFICER); ?>" id="modal-role-retention-officer-<?php echo e($user->id); ?>"
                                                <?php echo e(in_array(Roles::RETENTION_OFFICER, $currentRoles) ? 'checked' : ''); ?>>
                                            <label class="form-check-label" for="modal-role-retention-officer-<?php echo e($user->id); ?>">Retention Officer</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="roles[]" value="<?php echo e(Roles::QA); ?>" id="modal-role-qa-<?php echo e($user->id); ?>"
                                                <?php echo e(in_array(Roles::QA, $currentRoles) ? 'checked' : ''); ?>>
                                            <label class="form-check-label" for="modal-role-qa-<?php echo e($user->id); ?>">QA</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="roles[]" value="<?php echo e(Roles::CEO); ?>" id="modal-role-ceo-<?php echo e($user->id); ?>"
                                                <?php echo e(in_array(Roles::CEO, $currentRoles) ? 'checked' : ''); ?>>
