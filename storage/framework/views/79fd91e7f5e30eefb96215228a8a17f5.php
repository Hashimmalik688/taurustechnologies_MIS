    ...
    <nav class="pp-nav">
        <div class="pp-nav-inner">
            ...
            <div class="pp-nav-right">
                <a href="<?php echo e(route('partner.dashboard')); ?>" class="pp-nav-link active"><i class="bx bx-grid-alt"></i> Dashboard</a>
                ...
                <div class="pp-user-badge">
                    <div class="pp-user-avatar"><?php echo e(strtoupper(substr(Auth::guard('partner')->user()->name, 0, 1))); ?></div>
                    <div>
                        <div class="pp-user-name"><?php echo e(Auth::guard('partner')->user()->name); ?></div>
                        <div class="pp-user-code"><?php echo e(Auth::guard('partner')->user()->code); ?></div>
                    </div>
                </div>
