...
<body>
    <nav class="pp-nav">
        ...
        <div class="pp-nav-bottom">
            <a href="<?php echo e(route('partner.dashboard')); ?>" class="pp-nav-tab <?php echo e(request()->routeIs('partner.dashboard') ? 'active' : ''); ?>">
                <i class="bx bx-grid-alt"></i> Dashboard
            </a>
            <a href="<?php echo e(route('partner.sales')); ?>" class="pp-nav-tab <?php echo e(request()->routeIs('partner.sales') ? 'active' : ''); ?>">
                <i class="bx bx-trending-up"></i> Sales
            </a>
            <a href="<?php echo e(route('partner.ledger')); ?>" class="pp-nav-tab <?php echo e(request()->routeIs('partner.ledger') ? 'active' : ''); ?>">
                <i class="bx bx-receipt"></i> Ledger
            </a>
            <a href="<?php echo e(route('partner.carriers')); ?>" class="pp-nav-tab <?php echo e(request()->routeIs('partner.carriers') ? 'active' : ''); ?>">
