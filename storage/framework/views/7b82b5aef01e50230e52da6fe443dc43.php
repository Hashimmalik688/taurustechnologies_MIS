            ...
            <div class="glassmorphism-card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div>
                            <a href="<?php echo e(route('vendors.create')); ?>" class="gold-gradient-btn">
                        ...
                        <table id="vendorsTable" class="table table-dark-custom table-bordered dt-responsive nowrap w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('vendors.show', 1)); ?>" class="action-btn action-btn-view">
                                            <i class="mdi mdi-eye"></i>
                                        </a>
                                        <a href="<?php echo e(route('vendors.edit', 1)); ?>" class="action-btn action-btn-edit">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('vendors.show', 2)); ?>" class="action-btn action-btn-view">
                                            <i class="mdi mdi-eye"></i>
                                        </a>
                                        <a href="<?php echo e(route('vendors.edit', 2)); ?>" class="action-btn action-btn-edit">
                                            <i class="mdi mdi-pencil"></i>
                                        </a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('vendors.show', 3)); ?>" class="action-btn action-btn-view">
                                            <i class="mdi mdi-eye"></i>
                                        </a>
                                        <a href="<?php echo e(route('vendors.edit', 3)); ?>" class="action-btn action-btn-edit">
                                            <i class="mdi mdi-pencil"></i>
                                        </a>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taurus-crm/resources/views/admin/vendors/index.blade.php ENDPATH**/ ?>