                        ...
                        <table id="vendorLedgerTable" class="table table-dark-custom table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('ledger.show', 1)); ?>" class="btn btn-sm" style="background: rgba(59, 130, 246, 0.2); color: #60a5fa;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('ledger.show', 2)); ?>" class="btn btn-sm" style="background: rgba(59, 130, 246, 0.2); color: #60a5fa;">
                                            <i class="mdi mdi-eye"></i>
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('ledger.show', 3)); ?>" class="btn btn-sm" style="background: rgba(59, 130, 246, 0.2); color: #60a5fa;">
                                            <i class="mdi mdi-eye"></i>
                                        </a>
                                    </td>
                                </tr>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taurus-crm/resources/views/admin/ledger/vendor.blade.php ENDPATH**/ ?>