                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $leads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="lead-row" data-lead-id="<?php echo e($lead->id); ?>" data-phone="<?php echo e($lead->phone_number); ?>">
                                        ...
                                        <td class="text-center">
                                            <button class="btn btn-primary btn-sm dial-btn" onclick="dialLead('<?php echo e($lead->id); ?>', '<?php echo e($lead->phone_number); ?>', this)">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\code\taurus-crm-master\resources\views/ravens/calling.blade.php ENDPATH**/ ?>