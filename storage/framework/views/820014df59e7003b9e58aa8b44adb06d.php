...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($lead->closer_qna)): ?>
Closer Q&A:
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = (is_array($lead->closer_qna) ? $lead->closer_qna : (json_decode($lead->closer_qna, true) ?? [])); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $pair): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  Q<?php echo e($i + 1); ?>: <?php echo e($pair['question'] ?? ''); ?>

  A<?php echo e($i + 1); ?>: <?php echo e($pair['answer'] ?? ''); ?>
