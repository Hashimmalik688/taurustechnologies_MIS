...
Closer Q&A:
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $lead->closer_qna; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $pair): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
