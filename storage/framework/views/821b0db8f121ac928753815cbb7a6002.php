    ...
    <div class="pd-card">
        ...
        <form method="GET" action="<?php echo e(route('pending-draft.index')); ?>" class="pd-filters">
            ...
            <div class="pd-filter-group">
                <label>Search</label>
                <input type="text" name="search" value="<?php echo e($search); ?>" placeholder="Name, phone, policy#..." style="width:180px;">
            </div>
            <div class="pd-filter-group">
                <label>Carrier</label>
            ...
            <table class="pd-table">
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->policy_number): ?>
                                    <code style="font-size:.7rem;color:var(--bs-primary);"><?php echo e($lead->policy_number); ?></code>
                                <?php else: ?>
                            ...
                            <td>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->not_paid_comment): ?>
                                    <div class="pd-meta" style="font-style:italic;margin-top:2px;" title="<?php echo e($lead->not_paid_comment); ?>">
                                        💬 <?php echo e(Str::limit($lead->not_paid_comment, 60)); ?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td colspan="<?php echo e($tab === 'not_paid' ? 12 : 11); ?>">
                                <div class="pd-empty">
