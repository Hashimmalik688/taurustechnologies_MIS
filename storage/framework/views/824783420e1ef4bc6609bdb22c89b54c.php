                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                ?>
 <span class="badge <?php echo e($statusClass); ?> u-fs-085" style="padding: 0.5rem 0.75rem">
                            ...
                            <td>
                                ...
                                ?>
 <span class="badge <?php echo e($misClass); ?> u-fs-085" style="padding: 0.5rem 0.75rem">
                            ...
                            <td>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($emp->passport_image): ?>
                                    <img src="<?php echo e(asset('storage/'.$emp->passport_image)); ?>" alt="<?php echo e($emp->name); ?>" class="employee-avatar u-obj-cover u-rounded-4" style="width:40px; height:40px">
                                <?php else: ?>
                                    ...
                                    <form method="POST" action="<?php echo e(route('employee.update', $emp)); ?>" enctype="multipart/form-data">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($emp->passport_image): ?>
                                                    <img src="<?php echo e(asset('storage/'.$emp->passport_image)); ?>" alt="Passport" class="u-obj-cover u-rounded-4" style="width:60px; height:60px; margin-top:8px">
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </div>
                                        </div>
 ...
 <span class="badge badge-danger u-fs-085" style="padding: 0.5rem 0.75rem">
                                    ...
                                    <td>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($emp->passport_image): ?>
                                            <img src="<?php echo e(asset('storage/'.$emp->passport_image)); ?>" alt="<?php echo e($emp->name); ?>" class="employee-avatar u-obj-cover u-rounded-4" style="width:40px; height:40px">
                                        <?php else: ?>
                                            <div class="no-avatar u-opacity-50"><?php echo e(strtoupper(substr($emp->name, 0, 1))); ?></div>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </td>
                                    <td>
