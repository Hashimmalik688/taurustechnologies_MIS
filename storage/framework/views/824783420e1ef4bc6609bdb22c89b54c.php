                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-1 flex-wrap">
                                            ...
                                            <button class="act-btn <?php echo e($isPinned ? 'a-chill' : 'a-secondary'); ?> cp-toggle-btn"
                                                onclick="cpToggle(<?php echo e($emp->id); ?>, '<?php echo e(addslashes($emp->name)); ?>', '<?php echo e(addslashes($empPhoto)); ?>')"
                                                title="<?php echo e($isPinned ? 'Remove from Chill Party' : 'Pin to Chill Party'); ?>"
                                                data-emp-id="<?php echo e($emp->id); ?>"
                                            >🏖️</button>
                                        </div>
                                    </td>
                                </tr>
...
function cpToggle(id, name, photo) {
    ...
    fetch('<?php echo e(route("api.chill-party.toggle")); ?>', {
        method: 'POST',
        headers: {
