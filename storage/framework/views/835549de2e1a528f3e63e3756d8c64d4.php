            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form id="notificationPreferencesForm">
                        ...
                        <div class="mb-4">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="notifyOnMessage" 
                                    name="notify_on_message" <?php echo e($preferences->notify_on_message ? 'checked' : ''); ?>>
                        ...
                        <div class="mb-4">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="notifyOnMention" 
                                    name="notify_on_mention" <?php echo e($preferences->notify_on_mention ? 'checked' : ''); ?>>
                        ...
                        <div class="mb-4">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="notifyDesktop" 
                                    name="notify_desktop" <?php echo e($preferences->notify_desktop ? 'checked' : ''); ?>>
                        ...
                        <div class="mb-4">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="notifySoundEnabled" 
                                    name="notify_sound_enabled" <?php echo e($preferences->notify_sound_enabled ? 'checked' : ''); ?>>
                        ...
                        <div class="mb-4">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="quietHoursEnabled" 
                                    name="quiet_hours_enabled" <?php echo e($preferences->quiet_hours_enabled ? 'checked' : ''); ?>>
                        ...
                        <!-- Quiet Hours Times -->
                        <div id="quietHoursSection" style="display: <?php echo e($preferences->quiet_hours_enabled ? 'block' : 'none'); ?>;" class="ms-4 mb-4">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="quietHoursStart" class="form-label">Start Time</label>
                                    <input type="time" class="form-control" id="quietHoursStart" 
                                        name="quiet_hours_start" value="<?php echo e($preferences->quiet_hours_start); ?>">
                                </div>
                                <div class="col-md-6">
                                    <label for="quietHoursEnd" class="form-label">End Time</label>
                                    <input type="time" class="form-control" id="quietHoursEnd" 
                                        name="quiet_hours_end" value="<?php echo e($preferences->quiet_hours_end); ?>">
                                </div>
                            </div>
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?php echo e(url('/chat')); ?>" class="btn btn-secondary">
                                Cancel
                            </a>
                        </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taurus-crm/resources/views/chat/notifications/settings.blade.php ENDPATH**/ ?>