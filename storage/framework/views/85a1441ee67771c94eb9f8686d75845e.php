...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php $__env->slot('title'); ?> <?php echo e(ucfirst($team ?? 'paraguins')); ?> - New Submission <?php $__env->endSlot(); ?>
            ...
            <div class="card bordered">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(isset($team) ? route('verifier.store.team', ['team' => $team]) : route('verifier.store')); ?>">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="team" value="<?php echo e($team ?? 'paraguins'); ?>">
...
unset($__errorArgs, $__bag); ?>" required>
                                    ...
                                    <?php $__currentLoopData = $closers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $closer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($closer->id); ?>" <?php echo e(old('closer_id') == $closer->id ? 'selected' : ''); ?>><?php echo e($closer->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <?php $__errorArgs = ['closer_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="invalid-feedback"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('state')); ?>" placeholder="State" maxlength="2" required>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\code\taurus-crm-master\resources\views/verifier/create.blade.php ENDPATH**/ ?>