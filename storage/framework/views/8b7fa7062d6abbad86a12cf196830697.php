...
<head>
    ...
    <title>Payroll Print - <?php echo e(\Carbon\Carbon::createFromFormat('!m', $month)->format('F')); ?> <?php echo e($year); ?></title>
    <style>
...
<body>
    <div class="print-buttons no-print">
        ...
        <a href="<?php echo e(route('payroll.export', ['month' => $month, 'year' => $year])); ?>" class="btn-xlsx">⬇️ Export XLSX</a>
        <a href="<?php echo e(route('payroll.index')); ?>" class="btn-back">← Back to Payroll</a>
    </div>

    <div class="header">
        <div class="company-name">TAURUS TECHNOLOGIES</div>
        <div class="company-subtext">Payroll System</div>
        <div class="report-title">📅 Payroll Period: <?php echo e($payrollPeriod); ?></div>
        <div class="payment-due">💰 Payment Date: Salary paid 15 days after period ends (approx. <?php echo e(\Carbon\Carbon::create($year, $month, 25)->addDays(15)->format('F d, Y')); ?>)</div>
    </div>
    ...
    <div class="report-info">
        ...
        <div class="info-item">
            ...
            <span class="info-value"><?php echo e(count($payrollData)); ?></span>
        </div>
    </div>
    ...
    <table>
        ...
        <tbody>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $payrollData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr <?php if(isset($data['isManual']) && $data['isManual']): ?> style="background-color:rgba(184,134,11,.06) !important" <?php endif; ?>>
                    <td class="text-center"><?php echo e($index + 1); ?></td>
                    <td class="employee-name">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($data['isManual']) && $data['isManual']): ?>
                            <?php echo e($data['employeeName']); ?>

                            <span class="manual-tag">MANUAL</span>
                        <?php else: ?>
                            <?php echo e($data['employee']->name); ?>

                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($data['isTerminated'])): ?>
                    ...
                    <td class="text-center"><?php echo e($data['joinDate']); ?></td>
                    <td class="number"><?php echo e(number_format($data['basicSalary'], 2)); ?></td>
                    <td class="number"><?php echo e(number_format($data['perDayWage'], 2)); ?></td>
                    <td class="number"><?php echo e(number_format($data['punctualityBonus'], 2)); ?></td>
                    <td class="number"><?php echo e(number_format($data['total'], 2)); ?></td>
                    <td class="text-center"><?php echo e($data['fullDays']); ?></td>
                    <td class="text-center"><?php echo e($data['halfDays']); ?></td>
                    <td class="text-center"><?php echo e($data['lateDays']); ?></td>
                    <td class="text-center">
                        <span class="badge <?php echo e($data['isQualified'] ? 'badge-yes' : 'badge-no'); ?>">
                            <?php echo e($data['isQualified'] ? 'Yes' : 'No'); ?>

                        </span>
                    </td>
                    <td class="number"><?php echo e(number_format($data['dockAmount'], 2)); ?></td>
                    <td class="number"><?php echo e(number_format($data['otherDeductions'], 2)); ?></td>
                    <td class="number" style="font-weight:700"><?php echo e(number_format($data['netSalary'], 2)); ?></td>
                    <td class="number"><?php echo e(number_format($data['advance'], 2)); ?></td>
                    <td class="number" style="font-weight:700"><?php echo e(number_format($data['payable'], 2)); ?></td>
                </tr>
        ...
        <tfoot>
            <tr>
                ...
                <td class="number"><strong><?php echo e(number_format($totalBasicSalary, 2)); ?></strong></td>
                <td class="text-center">-</td>
                <td class="number"><strong><?php echo e(number_format($totalPunctuality, 2)); ?></strong></td>
                <td class="number"><strong><?php echo e(number_format($totalTotal ?? ($totalBasicSalary + $totalPunctuality), 2)); ?></strong></td>
                <td class="text-center">-</td>
                <td class="text-center">-</td>
                <td class="text-center">-</td>
                <td class="text-center">-</td>
                <td class="number"><strong><?php echo e(number_format($totalDock, 2)); ?></strong></td>
                <td class="number"><strong><?php echo e(number_format($totalDeductions - $totalDock, 2)); ?></strong></td>
                <td class="number"><strong><?php echo e(number_format($totalNetSalary, 2)); ?></strong></td>
                <td class="number"><strong><?php echo e(number_format($totalAdvance ?? 0, 2)); ?></strong></td>
                <td class="number"><strong><?php echo e(number_format($totalPayable ?? $totalNetSalary, 2)); ?></strong></td>
            </tr>
        </tfoot>
    </table>

    <div class="summary-section">
        <div class="summary-title">PAYROLL SUMMARY — <?php echo e(\Carbon\Carbon::createFromFormat('!m', $month)->format('F')); ?> <?php echo e($year); ?></div>
        <div class="summary-grid">
            <div class="summary-item">
                <span class="summary-label">Total Employees</span>
                <span class="summary-value"><?php echo e(count($payrollData)); ?></span>
            </div>
            <div class="summary-item">
                <span class="summary-label">Total Basic Salary</span>
                <span class="summary-value">Rs <?php echo e(number_format($totalBasicSalary, 0)); ?></span>
            </div>
            <div class="summary-item">
                <span class="summary-label">Total Punctuality Bonus</span>
                <span class="summary-value">Rs <?php echo e(number_format($totalPunctuality, 0)); ?></span>
            </div>
            <div class="summary-item">
                <span class="summary-label">Total Dock Amount</span>
                <span class="summary-value">Rs <?php echo e(number_format($totalDock, 0)); ?></span>
            </div>
            <div class="summary-item">
                <span class="summary-label">Total Deductions</span>
                <span class="summary-value">Rs <?php echo e(number_format($totalDeductions, 0)); ?></span>
            </div>
            <div class="summary-item">
                <span class="summary-label">Total Net Salary</span>
                <span class="summary-value">Rs <?php echo e(number_format($totalNetSalary, 0)); ?></span>
            </div>
            <div class="summary-item">
                <span class="summary-label">Total Advance</span>
                <span class="summary-value">Rs <?php echo e(number_format($totalAdvance ?? 0, 0)); ?></span>
            </div>
            <div class="summary-item">
                <span class="summary-label">Total Payable</span>
                <span class="summary-value">Rs <?php echo e(number_format($totalPayable ?? $totalNetSalary, 0)); ?></span>
            </div>
            <div class="summary-item">
                <span class="summary-label">Employees Qualified</span>
                <span class="summary-value"><?php echo e($qualifiedForBonus); ?> of <?php echo e(count($payrollData)); ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="footer">
        ...
        <p style="margin-top:6px">Generated: <?php echo e(now()->format('F d, Y h:i A')); ?></p>
        <p style="margin-top:4px;font-style:italic">Taurus Technologies — Management Information System</p>
    </div>
</body>
</html>
<?php /**PATH /var/www/taurus-crm/resources/views/admin/payroll/print.blade.php ENDPATH**/ ?>