    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <!-- Search Bar -->
                    <form method="GET" action="<?php echo e(route('leads.peregrine')); ?>" class="mb-3">
                        <div class="row g-2">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-2">
                                <a href="<?php echo e(route('leads.peregrine')); ?>" class="btn btn-outline-secondary w-100"><i class="bx bx-reset"></i> Clear</a>
                            </div>
                        </div>
                    </form>
