<?php $__env->startSection('title', $partner->name . ' — Carrier Ledger Overview'); ?>
...
<div class="container-fluid">
    ...
    <div class="d-flex align-items-center gap-2 mb-3" style="font-size:.82rem;color:#888;">
        ...
        <i class="bx bx-chevron-right"></i>
        <span style="color:#495057;font-weight:600;"><?php echo e($partner->name); ?></span>
    </div>
    ...
    <div class="partner-hdr">
        <div>
            ...
            <div class="partner-hdr-name"><?php echo e($partner->name); ?></div>
            <div class="partner-hdr-meta">
                ...
                <?php echo e($carrierSummaries->count()); ?> carrier ledger(s)
    ...
    <div class="quick-actions">
        <a href="<?php echo e(route('admin.accounting.opening-balance')); ?>"
    ...
    <div class="section-label">
        ...
        Carrier Ledgers (<?php echo e($carrierSummaries->count()); ?>)
    </div>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($carrierSummaries->isEmpty()): ?>
    ...
    <div class="carrier-cards-grid">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $carrierSummaries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
            $url = $cs['carrier_id'] > 0
            ...
            $bal = $cs['balance'];
        ?>
        <a href="<?php echo e($url); ?>" class="carrier-card <?php echo e($cs['tx_count'] === 0 ? 'no-tx' : ''); ?>">
            <i class="bx bx-chevron-right cc-arrow"></i>
            <div class="cc-name">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cs['carrier_id'] === 0): ?>
                    <span class="cc-unassigned"><?php echo e($cs['carrier_name']); ?></span>
                <?php else: ?>
                    <?php echo e($cs['carrier_name']); ?>
            ...
            <div class="cc-financials">
                <div class="cc-fin-cell">
                    ...
                    <div class="cc-fin-val dr"><?php echo e(number_format($cs['total_dr'], 2)); ?></div>
                </div>
                <div class="cc-fin-cell">
                    <div class="cc-fin-label">Credit (USD)</div>
                    <div class="cc-fin-val cr"><?php echo e(number_format($cs['total_cr'], 2)); ?></div>
                </div>
            </div>
            <div class="cc-balance-row">
                <div>
                    <span class="cc-balance-val <?php echo e($bal >= 0 ? 'pos' : 'neg'); ?>">
                        $<?php echo e(number_format(abs($bal), 2)); ?>

                    </span>
                    <span class="cc-badge-side"><?php echo e($bal >= 0 ? 'Dr' : 'Cr'); ?></span>
                </div>
                <div class="cc-tx-count">
                    <?php echo e($cs['tx_count']); ?> txn<?php echo e($cs['tx_count'] !== 1 ? 's' : ''); ?>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taurus-crm/resources/views/admin/accounting/partner-ledger/overview.blade.php ENDPATH**/ ?>