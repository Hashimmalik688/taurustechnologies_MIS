    ...
    <div class="card mb-3">
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('attendance.index')); ?>" id="filterForm">
                ...
                <div class="row mt-2">
                    <div class="col-12">
                        <a href="<?php echo e(route('attendance.index')); ?>" class="btn btn-sm btn-outline-secondary">
    ...
    <div class="row">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-centered table-nowrap mb-0" id="attendance-table">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $attendanceDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <?php if($attendance->login_time): ?>
                                                <span class="badge badge-soft-info">
                                                    <?php echo e($attendance->login_time->format('h:i A')); ?>
                                        ...
                                        <td>
                                            <?php if($attendance->logout_time): ?>
                                                <span class="badge badge-soft-secondary">
                                                    <?php echo e($attendance->logout_time->format('h:i A')); ?>
        ...
        <div class="col-xl-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <?php $__empty_1 = true; $__currentLoopData = $absentEmployees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="employee_select" name="user_id" required>
                                ...
                                <?php $__currentLoopData = $allEmployees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        document.getElementById('manualEntryForm').addEventListener('submit', function(e) {
            ...
            fetch('<?php echo e(route('attendance.mark-manual')); ?>', {
                    method: 'POST',
                    body: formData,
                    headers: {
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\code\taurus-crm-master\resources\views/admin/attendance/index.blade.php ENDPATH**/ ?>