        ...
        <div class="col-12">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form method="GET" action="<?php echo e(route('retention.incomplete')); ?>" class="mb-4">
                        <div class="row g-3">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-2">
                                <select name="disposition" class="form-select">
                                    ...
                                    <option value="Via Portal" <?php echo e(request('disposition') == 'Via Portal' ? 'selected' : ''); ?>>Via Portal</option>
                                    <option value="Via Email" <?php echo e(request('disposition') == 'Via Email' ? 'selected' : ''); ?>>Via Email</option>
                                    <option value="By Carrier" <?php echo e(request('disposition') == 'By Carrier' ? 'selected' : ''); ?>>By Carrier</option>
                                    <option value="By Bank" <?php echo e(request('disposition') == 'By Bank' ? 'selected' : ''); ?>>By Bank</option>
                                </select>
                            </div>
                            <div class="col-md-2">
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <div class="btn-group btn-group-sm" role="group">
                                                <a href="<?php echo e(route('retention.incompleteDetails', $lead->id)); ?>" class="btn btn-outline-info" title="View Details">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <button type="button" class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#dispositionModal-<?php echo e($lead->id); ?>" title="Set Disposition">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header" style="background: linear-gradient(135deg, #d4af37 0%, #b8a000 100%); color: white;">
                                                    <h5 class="modal-title">
                                                        <i class="mdi mdi-clipboard-list me-2"></i>Set Disposition - <?php echo e($lead->cn_name); ?>
                                                ...
                                                <div class="modal-body">
                                                    <form id="dispositionForm-<?php echo e($lead->id); ?>" class="disposition-form">
                                                        <?php echo csrf_field(); ?>
                                                        <div class="mb-3">
                                                            <label for="disposition-<?php echo e($lead->id); ?>" class="form-label fw-bold">
                                                                Select Disposition Channel <span class="text-danger">*</span>
                                                            </label>
                                                            <select id="disposition-<?php echo e($lead->id); ?>" name="issuance_disposition" class="form-select disposition-select" data-lead-id="<?php echo e($lead->id); ?>" required>
                                                                <option value="">-- Choose One --</option>
                                                                <option value="Via Portal" <?php echo e($lead->issuance_disposition == 'Via Portal' ? 'selected' : ''); ?>>📱 Via Portal</option>
                                                                <option value="Via Email" <?php echo e($lead->issuance_disposition == 'Via Email' ? 'selected' : ''); ?>>📧 Via Email</option>
                                                                <option value="By Carrier" <?php echo e($lead->issuance_disposition == 'By Carrier' ? 'selected' : ''); ?>>🏢 By Carrier</option>
                                                                <option value="By Bank" <?php echo e($lead->issuance_disposition == 'By Bank' ? 'selected' : ''); ?>>🏦 By Bank</option>
                                                            </select>
                                                        </div>

                                                        <!-- Conditional: Check Other Insurances -->
                                                        <div class="check-other-insurances-container" id="checkContainer-<?php echo e($lead->id); ?>" style="display: none;">
                                                            ...
                                                            <div class="other-insurances-list mt-3" id="otherList-<?php echo e($lead->id); ?>"></div>
                                                        </div>

                                                        <div class="mb-3">
                                                            <label for="reason-<?php echo e($lead->id); ?>" class="form-label fw-bold">Reason/Notes</label>
                                                            <textarea id="reason-<?php echo e($lead->id); ?>" name="issuance_reason" class="form-control" rows="4" placeholder="Enter reason for this disposition..." style="max-width: 100%;"><?php echo e($lead->issuance_reason ?? ''); ?></textarea>
                                                            ...
                                                            <div class="card-body">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <p><strong>Coverage:</strong> $<?php echo e(number_format($lead->coverage_amount ?? 0, 2)); ?></p>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taurus-crm/resources/views/admin/retention/incomplete.blade.php ENDPATH**/ ?>