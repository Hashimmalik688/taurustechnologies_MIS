                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $attendanceDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <span
                                    class="u-fs-10 text-white" style="padding: 2px 6px; border-radius: 3px; background: <?php echo e($attendance->status == 'present' ? 'var(--bs-status-present)' : ($attendance->status == 'leave' ? 'var(--bs-status-absent)' : 'var(--bs-status-leave)')); ?>">
                                    <?php echo e(strtoupper($attendance->status)); ?>

                                </span>
                            </td>
                            <td><?php echo e($attendance->check_in ? $attendance->check_in->format('g:i A') : '-'); ?></td>
                            <td><?php echo e($attendance->check_out ? $attendance->check_out->format('g:i A') : '-'); ?></td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($sale->email): ?>
                                    <br><small class="text-surface-500"><?php echo e($sale->email); ?></small>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </td>
                            <td class="amount">
