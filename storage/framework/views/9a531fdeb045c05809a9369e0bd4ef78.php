    ...
    <div id="followupSection">
        <div class="sl-card">
            ...
            <form method="GET" action="<?php echo e(route('followup.my-followups')); ?>" class="sl-filter-pills">
                ...
                <input type="date" name="date_from" class="sl-pill-select" style="min-width:130px;" value="<?php echo e(request('date_from')); ?>" title="From date" onchange="this.form.submit()">
                <input type="date" name="date_to" class="sl-pill-select" style="min-width:130px;" value="<?php echo e(request('date_to')); ?>" title="To date" onchange="this.form.submit()">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->hasAny(['search','carrier','followup_status','date_from','date_to'])): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->followup_required && $lead->followup_scheduled_at): ?>
                                        <div style="font-size:.82rem;font-weight:600;color:#1e293b"><?php echo e(\Carbon\Carbon::parse($lead->followup_scheduled_at)->format('M d, Y')); ?></div>
                                        <div style="font-size:.74rem;color:#64748b"><?php echo e(\Carbon\Carbon::parse($lead->followup_scheduled_at)->format('h:i A')); ?></div>
                                    <?php else: ?>
                                        <span style="color:#94a3b8">—</span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </td>
