...
<?php $__env->startSection('content'); ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('error')): ?>
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <i class="mdi mdi-alert me-2"></i><?php echo e(session('error')); ?>
        ...
        <div class="col-lg-4">
            <div class="card dupe-card h-100">
                <div class="card-body text-center">
                    ...
                    <form action="<?php echo e(route('admin.dupe-checker.self-check')); ?>" method="POST" class="mt-4">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
        ...
        <div class="col-lg-4">
            <div class="card dupe-card h-100">
                <div class="card-body text-center">
                    ...
                    <form action="<?php echo e(route('admin.dupe-checker.file-comparison')); ?>" method="POST" enctype="multipart/form-data" class="mt-4">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
