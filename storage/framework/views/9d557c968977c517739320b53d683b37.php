<?php $__env->startSection('title', 'Duplicate Checker'); ?>
...
<div class="page-hdr">
    ...
    <a href="<?php echo e(route('settings.hub')); ?>" class="pipe-pill" style="text-decoration:none"><i class="bx bx-arrow-back"></i> Settings</a>
</div>
...
<div style="display:flex;align-items:center;gap:.4rem;padding:.5rem .75rem;border-radius:.5rem;background:rgba(52,195,143,.06);border:1px solid rgba(52,195,143,.12);font-size:.72rem;color:#1a8754;margin-bottom:.65rem">
    <i class="bx bx-check-circle" style="font-size:.95rem"></i> <?php echo e(session('success')); ?>
...
<div style="display:flex;align-items:center;gap:.4rem;padding:.5rem .75rem;border-radius:.5rem;background:rgba(244,106,106,.06);border:1px solid rgba(244,106,106,.12);font-size:.72rem;color:#c84646;margin-bottom:.65rem">
    <i class="bx bx-error-circle" style="font-size:.95rem"></i> <?php echo e(session('error')); ?>
...
<div class="feat-grid">
    ...
    <div class="ex-card feat-tile ft-blue">
        ...
        <div class="feat-body">
            <form action="<?php echo e(route('admin.dupe-checker.self-check')); ?>" method="POST">
                <?php echo csrf_field(); ?>
    ...
    <div class="ex-card feat-tile ft-green">
        ...
        <div class="feat-body">
            <form action="<?php echo e(route('admin.dupe-checker.file-comparison')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
    ...
    <div class="ex-card feat-tile ft-warn">
        ...
        <div class="feat-body">
            ...
            <form action="<?php echo e(route('admin.dupe-checker.run-deduplication')); ?>" method="POST" onsubmit="return confirm('Are you sure you want to run automatic deduplication? This will merge duplicate leads and cannot be undone.');">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taurus-crm/resources/views/admin/dupe-checker/index.blade.php ENDPATH**/ ?>