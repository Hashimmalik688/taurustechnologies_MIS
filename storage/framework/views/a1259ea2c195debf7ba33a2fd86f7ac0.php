                                    ...
                                    <div class="modal fade" id="statusModal-<?php echo e($lead->id); ?>" tabindex="-1">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <form action="<?php echo e(route('issuance.updateIssuanceStatus', $lead->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="policy-number-<?php echo e($lead->id); ?>" class="form-label fw-semibold">
                                                                ...
                                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->policy_number_set_at): ?>
                                                                    ...
                                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasRole('Super Admin')): ?>
                                                                        <button type="button" class="btn btn-sm btn-outline-primary ms-2 unlock-field" data-target="policy-number-<?php echo e($lead->id); ?>">
                                                            ...
                                                            <input 
                                                                ...
                                                                <?php echo e(($lead->policy_number_set_at && !auth()->user()->hasRole('Super Admin')) ? 'readonly' : 'required'); ?>

                                                                placeholder="Enter policy number"
                                                            >
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->policy_number_set_at): ?>
                                                                <small class="text-muted">
                                                                    Set on <?php echo e(\Carbon\Carbon::parse($lead->policy_number_set_at)->format('M d, Y H:i')); ?>
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="partner-<?php echo e($lead->id); ?>" class="form-label fw-semibold">
                                                                ...
                                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->partner_set_at): ?>
                                                                    <span class="badge bg-warning text-dark ms-2">
                                                                        <i class="mdi mdi-lock"></i> Locked
                                                                    </span>
                                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasRole('Super Admin')): ?>
                                                                        <button type="button" class="btn btn-sm btn-outline-primary ms-2 unlock-field" data-target="partner-<?php echo e($lead->id); ?>">
                                                                            <i class="mdi mdi-lock-open"></i> Unlock
                                                                        </button>
                                                                        <button type="button" class="btn btn-sm btn-outline-danger ms-2 unassign-partner-btn" data-lead-id="<?php echo e($lead->id); ?>">
                                                            ...
                                                            <select 
                                                                ...
                                                                name="partner_id"
                                                                <?php echo e(($lead->partner_set_at && !auth()->user()->hasRole('Super Admin')) ? 'disabled' : 'required'); ?>
                                                            ...
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->partner_set_at): ?>
                                                                <small class="text-muted">
                                                                    Set on <?php echo e(\Carbon\Carbon::parse($lead->partner_set_at)->format('M d, Y H:i')); ?>
                                                                ...
                                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!auth()->user()->hasRole('Super Admin')): ?>
                                                                    <input type="hidden" name="partner_id" value="<?php echo e($lead->partner_id); ?>">
                                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                        </div>
                                                        ...
                                                        <div class="mb-3">
                                                            <label class="form-label fw-semibold">
                                                                ...
                                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->issuance_date): ?>
                                                                    ...
                                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasRole('Super Admin')): ?>
                                                                        <button type="button" class="btn btn-sm btn-outline-primary ms-2 unlock-field" data-target="status-buttons-<?php echo e($lead->id); ?>">
                                                                            <i class="mdi mdi-lock-open"></i> Unlock
                                                                        </button>
                                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                            </label>
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->issuance_date && !auth()->user()->hasRole('Super Admin')): ?>
                                                                <!-- Status is locked, show current status for non-Super Admin -->
                                                                <div class="alert alert-info">
                                                                    <i class="mdi mdi-information me-2"></i>
                                                                    <strong>Current Status:</strong> <?php echo e($lead->issuance_status); ?>

                                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->issuance_date): ?>
                                                                        <br><small>Set on <?php echo e(\Carbon\Carbon::parse($lead->issuance_date)->format('M d, Y H:i')); ?></small>
                                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                            ...
                                                            <?php else: ?>
                                                                ...
                                                                <div class="d-grid gap-2" id="status-buttons-<?php echo e($lead->id); ?>">
                                                                    <button type="submit" name="issuance_status" value="Issued" class="btn btn-success btn-lg" <?php echo e(($lead->issuance_date && !auth()->user()->hasRole('Super Admin')) ? 'disabled' : ''); ?>>
                                                                        <i class="mdi mdi-check-circle me-2"></i>Issued
                                                                    </button>
                                                                    <button type="submit" name="issuance_status" value="Incomplete" class="btn btn-warning btn-lg" <?php echo e(($lead->issuance_date && !auth()->user()->hasRole('Super Admin')) ? 'disabled' : ''); ?>>
                                                                        <i class="mdi mdi-clock-outline me-2"></i>Incomplete
                                                                    </button>
                                                                </div>
                                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->issuance_date): ?>
                                                                    <small class="text-muted d-block mt-2">
                                                                        Current: <strong><?php echo e($lead->issuance_status); ?></strong>
                                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->issuance_date): ?>
                                                                            - Set on <?php echo e(\Carbon\Carbon::parse($lead->issuance_date)->format('M d, Y H:i')); ?>
