                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (\Illuminate\Support\Facades\Blade::check('hasrole', 'Super Admin')): ?>
                            ...
                            <td>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->preset_line): ?>
                                    <span class="badge" style="background: var(--gold); color: white;"><?php echo e($lead->preset_line); ?></span>
                                <?php else: ?>
                                    —
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </td>
                            <td>
                                <div class="comment-editable" data-lead-id="<?php echo e($lead->id); ?>" style="max-width: 200px;">
                                    ...
                                    <div class="comment-edit" style="display: none;">
                                        <textarea class="form-control form-control-sm comment-input" rows="2" style="font-size: 12px;"><?php echo e($lead->comments); ?></textarea>
                                        <div class="mt-1">
