...
<div class="ret-kpi-row">
    ...
    <div class="ret-kpi-pill k-waitcx">
        ...
        <div><div class="rk-lbl">Waiting On Cx</div><div class="rk-val"><?php echo e($kpi['waiting_on_cx'] ?? 0); ?></div></div>
    </div>
    <div class="ret-kpi-pill k-recalled">
        <div class="rk-icon"><i class="bx bx-undo"></i></div>
        <div><div class="rk-lbl">Recalled</div><div class="rk-val"><?php echo e($kpi['recalled'] ?? 0); ?></div></div>
    </div>
    <div class="ret-kpi-pill k-fixed">
        <div class="rk-icon"><i class="bx bx-check-circle"></i></div>
        <div><div class="rk-lbl">Fixed</div><div class="rk-val"><?php echo e($kpi['fixed'] ?? 0); ?></div></div>
    </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php elseif($retStatus !== 'pending'): ?>
                                    <br><span class="ret-status-badge rsb-<?php echo e($retStatus); ?>" style="margin-top:.15rem;"><?php echo e(Statuses::RET_ACTION_STATUSES[$retStatus] ?? $retStatus); ?></span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </td>
                            ...
                            <td>
                                <div class="d-flex gap-1 flex-wrap">
                                    <button type="button" class="a-btn a-call btn-call-lead"
                                        data-phone="<?php echo e(preg_replace('/\D/', '', $lead->phone_number ?? '')); ?>"
                                        title="Call <?php echo e($lead->cn_name); ?>">
            ...
            <div class="modal-footer py-2 px-3 justify-content-between">
                ...
                <div class="d-flex gap-2 align-items-center">
                    <select id="dm-status-select" class="form-select form-select-sm" style="font-size:.72rem;width:auto;border-radius:.4rem;">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = Statuses::RET_ACTION_STATUSES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
