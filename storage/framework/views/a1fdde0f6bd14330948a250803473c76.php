                                            ...
                                            <tr data-lead-id="<?php echo e($lead->id); ?>" data-customer-name="<?php echo e($lead->cn_name); ?>" data-phone="<?php echo e($lead->phone_number); ?>" data-days-ago="<?php echo e($daysAgo); ?>">
                                                ...
                                                <td>
                                                    <select class="form-select form-select-sm retention-status-dropdown" 
                                                        ...
                                                        <option value="pending" <?php echo e(($lead->retention_status == 'pending' || !$lead->retention_status) ? 'selected' : ''); ?>>
                                                            Yet to Retain
                                                        </option>
                                                        <option value="retained" <?php echo e($lead->retention_status == 'retained' ? 'selected' : ''); ?>>
                                                            Retained
                                                        </option>
                                                        <option value="rewrite" <?php echo e($lead->retention_status == 'rewrite' ? 'selected' : ''); ?>>
                                                            Rewrite
                                                        </option>
                                                    </select>
                                                </td>
                                                            ...
                                                            <form id="dispositionForm-<?php echo e($lead->id); ?>" class="disposition-form">
                                                                ...
                                                                <div class="mb-4">
                                                                    ...
                                                                    <div class="btn-group w-100" role="group">
                                                                        ...
                                                                        <label class="btn btn-outline-secondary" for="notApplicable-<?php echo e($lead->id); ?>" style="flex: 1;">
                                                                            <i class="mdi mdi-close-circle me-2"></i>Not Applicable
                                                                        </label>

                                                                        <input type="radio" class="btn-check disposition-radio" name="issuance_disposition" id="issued-<?php echo e($lead->id); ?>" value="Issued" <?php echo e($lead->issuance_disposition == 'Issued' ? 'checked' : ''); ?> data-lead-id="<?php echo e($lead->id); ?>">
                                                                        <label class="btn btn-outline-success" for="issued-<?php echo e($lead->id); ?>" style="flex: 1;">
