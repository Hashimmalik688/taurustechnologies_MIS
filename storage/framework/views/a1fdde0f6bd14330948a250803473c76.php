...
<style>
    ...
    :is(:is([data-theme="emerald-glass"],[data-theme="midnight-black"],[data-theme="ocean-blue"],[data-theme="royal-purple"],[data-theme="rose-gold"],[data-theme="copper-steel"]),[data-theme="emerald-glass"],[data-theme="midnight-black"],[data-theme="ocean-blue"],[data-theme="royal-purple"],[data-theme="rose-gold"],[data-theme="copper-steel"]) .sl-tabs { background: rgba(15,23,42,.3); border-color: rgba(255,255,255,.05); }
    :is(:is([data-theme="emerald-glass"],[data-theme="midnight-black"],[data-theme="ocean-blue"],[data-theme="royal-purple"],[data-theme="rose-gold"],[data-theme="copper-steel"]),[data-theme="emerald-glass"],[data-theme="midnight-black"],[data-theme="ocean-blue"],[data-theme="royal-purple"],[data-theme="rose-gold"],[data-theme="copper-steel"]) .sl-tab { color: #94a3b8; }
    :is(:is([data-theme="emerald-glass"],[data-theme="midnight-black"],[data-theme="ocean-blue"],[data-theme="royal-purple"],[data-theme="rose-gold"],[data-theme="copper-steel"]),[data-theme="emerald-glass"],[data-theme="midnight-black"],[data-theme="ocean-blue"],[data-theme="royal-purple"],[data-theme="rose-gold"],[data-theme="copper-steel"]) .sl-tab:hover { color: #d4af37; background: rgba(212,175,55,.08); }
    :is(:is([data-theme="emerald-glass"],[data-theme="midnight-black"],[data-theme="ocean-blue"],[data-theme="royal-purple"],[data-theme="rose-gold"],[data-theme="copper-steel"]),[data-theme="emerald-glass"],[data-theme="midnight-black"],[data-theme="ocean-blue"],[data-theme="royal-purple"],[data-theme="rose-gold"],[data-theme="copper-steel"]) .sl-tab.active { color: #0f172a; }
    ...
    :is(:is([data-theme="emerald-glass"],[data-theme="midnight-black"],[data-theme="ocean-blue"],[data-theme="royal-purple"],[data-theme="rose-gold"],[data-theme="copper-steel"]),[data-theme="emerald-glass"],[data-theme="midnight-black"],[data-theme="ocean-blue"],[data-theme="royal-purple"],[data-theme="rose-gold"],[data-theme="copper-steel"]) .sl-status-select {
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="sl-topbar">
        ...
        <div class="sl-topbar-right">
            <div class="sl-search-wrap">
                ...
                <input type="text" id="retentionSearch" class="sl-search-input" placeholder="Search name, phone, carrier, closer..." value="<?php echo e($search); ?>">
            </div>
        </div>
    </div>
    ...
    <div class="sl-kpi-row mb-3">
        <div class="sl-kpi-pill">
            ...
            <div>
                ...
                <div class="kpi-value text-danger"><?php echo e($cb_count); ?></div>
            </div>
        </div>
        <div class="sl-kpi-pill">
            ...
            <div>
                ...
                <div class="kpi-value text-warning"><?php echo e($rewrite_count); ?></div>
            </div>
        </div>
        <div class="sl-kpi-pill">
            ...
            <div>
                ...
                <div class="kpi-value text-info"><?php echo e($yet_to_retain_count); ?></div>
            </div>
        </div>
        <div class="sl-kpi-pill">
            ...
            <div>
                ...
                <div class="kpi-value text-success"><?php echo e($retained_count); ?></div>
            </div>
        </div>
    </div>
    ...
    <div class="sl-card">
        ...
        <form method="GET" action="<?php echo e(route('retention.index')); ?>" id="retFilterForm" class="sl-filter-pills">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->hasAny(['search', 'month', 'year', 'date_from', 'date_to'])): ?>
                <a href="<?php echo e(route('retention.index')); ?>" class="sl-pill-clear" title="Clear filters"><i class="bx bx-x"></i> Clear</a>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </form>
        ...
        <div class="sl-tabs" role="tablist">
            <a class="sl-tab active" data-bs-toggle="tab" href="#yet-to-retain" role="tab">
                ...
                <span class="badge bg-info"><?php echo e($yet_to_retain_count); ?></span>
            </a>
            <a class="sl-tab" data-bs-toggle="tab" href="#retained" role="tab">
                <i class="bx bx-check-circle"></i> Retained
                <span class="badge bg-success"><?php echo e($retained_count); ?></span>
            </a>
            <a class="sl-tab" data-bs-toggle="tab" href="#rewrite" role="tab">
                <i class="bx bx-refresh"></i> Rewrite
                <span class="badge bg-warning"><?php echo e($rewrite_count); ?></span>
            </a>
            <a class="sl-tab" data-bs-toggle="tab" href="#disposition" role="tab">
                <i class="bx bx-history"></i> Unissued
                <span class="badge bg-danger"><?php echo e($disposition_count); ?></span>
            </a>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($not_issued_count) && $not_issued_count > 0): ?>
            ...
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($not_paid_count) && $not_paid_count > 0): ?>
            ...
            <div class="tab-pane active" id="yet-to-retain" role="tabpanel">
                <div class="sl-tbl-wrap">
                    <table class="sl-tbl">
                        ...
                        <tbody>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $yet_to_retain_leads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <?php
                                            ...
                                            ?>
                                            <tr data-lead-id="<?php echo e($lead->id); ?>" data-customer-name="<?php echo e($lead->cn_name); ?>" data-phone="<?php echo e($lead->phone_number); ?>" data-days-ago="<?php echo e($daysAgo); ?>">
                                                <td>
                                                    <div class="sl-act-group">
                                                        <button class="btn btn-success dial-lead-btn" 
                                                                ...
                                                                data-days-ago="<?php echo e($daysAgo); ?>"
                                                                title="Call Customer">
                                                            <i class="bx bx-phone-call"></i>
                                                        </button>
                                                        <button class="btn btn-info show-lead-details-btn" 
                                                                data-lead-id="<?php echo e($lead->id); ?>"
                                                                data-lead-json="<?php echo e(htmlspecialchars(json_encode($lead->toArray()), ENT_QUOTES, 'UTF-8')); ?>"
                                                                title="View Details">
                                                            <i class="fas fa-info-circle"></i>
                                                        </button>
                                                        <a href="<?php echo e(route('leads.show', $lead->id)); ?>" class="btn btn-primary" title="View Full Profile" target="_blank">
                                                ...
                                                <td>
                                                    <select class="sl-status-select retention-status-dropdown" 
                                                            data-lead-id="<?php echo e($lead->id); ?>">
                                                        <option value="pending" <?php echo e(($lead->retention_status == Statuses::RETENTION_PENDING || !$lead->retention_status) ? 'selected' : ''); ?>>
                                                            Yet to Retain
                                                        </option>
                                                        <option value="retained" <?php echo e($lead->retention_status == Statuses::RETENTION_RETAINED ? 'selected' : ''); ?>>
                                                            Retained
                                                        </option>
                                                        <option value="rewrite" <?php echo e($lead->retention_status == Statuses::RETENTION_REWRITE ? 'selected' : ''); ?>>
                                                            Rewrite
                                                        </option>
                                                    </select>
                                                </td>
                                                <td>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->is_rewrite): ?>
                                                ...
                                                <td>
                                                    <span class="text-muted" style="font-size:.74rem"><?php echo e($lead->submission_reason ?? 'No comments'); ?></span>
                                                </td>
                                            </tr>
                        ...
                        <div class="tab-pane" id="retained" role="tabpanel">
                            <div class="sl-tbl-wrap">
                                <table class="sl-tbl">
                                    ...
                                    <tbody>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $retained_leads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                <td>
                                                    <div class="sl-act-group">
                                                        <a href="<?php echo e(route('leads.show', $lead->id)); ?>" class="btn btn-primary" title="View Details" target="_blank">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <span class="badge bg-success">
                                                        <i class="bx bx-calendar-check me-1"></i><?php echo e($lead->retained_at ? $lead->retained_at->format('M d, Y') : 'N/A'); ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($retained_leads->hasPages()): ?>
                                <div class="mt-3">
                                    <?php echo e($retained_leads->appends(['search' => $search, 'month' => $month, 'year' => $year, 'date_from' => $date_from ?? '', 'date_to' => $date_to ?? ''])->links()); ?>
                        ...
                        <div class="tab-pane" id="rewrite" role="tabpanel">
                            <div class="sl-tbl-wrap">
                                <table class="sl-tbl">
                                    ...
                                    <tbody>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $rewrite_leads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                <td>
                                                    <div class="sl-act-group">
                                                        <a href="<?php echo e(route('leads.show', $lead->id)); ?>" class="btn btn-primary" title="View Details" target="_blank">
                                                ...
                                                <td><strong><?php echo e($lead->id); ?></strong></td>
                                                <td><?php echo e($lead->sale_date ? $lead->sale_date->format('M d, Y') : 'N/A'); ?></td>
                                                <td><?php echo e($lead->chargeback_marked_date ? $lead->chargeback_marked_date->format('M d, Y') : 'N/A'); ?></td>
                                                <td>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->chargeback_marked_date && $lead->sale_date): ?>
                                                        <span class="badge bg-warning-subtle text-warning"><?php echo e($lead->chargeback_marked_date->diffInDays($lead->sale_date)); ?> days</span>
                                                    <?php else: ?>
                                                        -
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                </td>
                                                ...
                                                <td>
                                                    <select class="sl-status-select retention-status-dropdown" 
                                                        ...
                                                        <option value="lost" <?php echo e($lead->retention_status == 'lost' ? 'selected' : ''); ?>>
                                                            Lost
                                                        </option>
                                                    </select>
                                                </td>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rewrite_leads->hasPages()): ?>
                                <div class="mt-3">
                                    <?php echo e($rewrite_leads->appends(['search' => $search, 'month' => $month, 'year' => $year, 'date_from' => $date_from ?? '', 'date_to' => $date_to ?? ''])->links()); ?>
                        ...
                        <div class="tab-pane" id="disposition" role="tabpanel">
                            <div class="sl-tbl-wrap">
                                <table class="sl-tbl">
                                    ...
                                    <tbody>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $disposition_leads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                <td>
                                                    <div class="sl-act-group">
                                                        <a href="<?php echo e(route('leads.show', $lead->id)); ?>" class="btn btn-outline-primary" title="View Details" target="_blank">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                        <a href="#" class="btn btn-outline-info" data-bs-toggle="modal" data-bs-target="#dispositionModal-<?php echo e($lead->id); ?>" title="Set Unissued Status">
                                            ...
                                            <!-- Unissued Modal -->
                                            <div class="modal fade" id="dispositionModal-<?php echo e($lead->id); ?>" tabindex="-1">
 ...
 <div class="modal-header text-white" style="background: linear-gradient(135deg, var(--bs-gold) 0%, var(--bs-gold-dark) 100%)">
                                                            <h5 class="modal-title">
                                                                <i class="mdi mdi-clipboard-list me-2"></i>Set Issuance Status - <?php echo e($lead->cn_name); ?>

                                                            </h5>
                                                            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <form id="dispositionForm-<?php echo e($lead->id); ?>" class="disposition-form">
                                                                <?php echo csrf_field(); ?>
                                                                ...
                                                                <div class="mb-4">
                                                                    ...
                                                                    <div class="btn-group w-100" role="group">
                                                                        <input type="radio" class="btn-check disposition-radio" name="issuance_disposition" id="notApplicable-<?php echo e($lead->id); ?>" value="Not Applicable" <?php echo e($lead->issuance_disposition == 'Not Applicable' ? 'checked' : ''); ?>>
 <label class="btn btn-outline-secondary flex-grow-1" for="notApplicable-<?php echo e($lead->id); ?>" >
                                                                            <i class="mdi mdi-close-circle me-2"></i>Not Applicable
                                                                        </label>

                                                                        <input type="radio" class="btn-check disposition-radio" name="issuance_disposition" id="issued-<?php echo e($lead->id); ?>" value="Issued" <?php echo e($lead->issuance_disposition == Statuses::ISSUANCE_ISSUED ? 'checked' : ''); ?> data-lead-id="<?php echo e($lead->id); ?>">
 <label class="btn btn-outline-success flex-grow-1" for="issued-<?php echo e($lead->id); ?>" >
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="reason-<?php echo e($lead->id); ?>" class="form-label fw-bold">Reason/Notes</label>
                                                                    <textarea id="reason-<?php echo e($lead->id); ?>" name="issuance_reason" class="form-control" rows="3" placeholder="Enter reason for this disposition..." style="max-width: 100%;"><?php echo e($lead->issuance_reason ?? ''); ?></textarea>
                                                                    <div class="form-text">Maximum 1000 characters</div>
                                                                </div>

                                                                <!-- View Details Button -->
                                                                <div class="mb-3">
                                                                    <a href="<?php echo e(route('leads.show', $lead->id)); ?>" class="btn btn-outline-info w-100" target="_blank">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="button" class="btn btn-success btn-sm save-disposition" data-lead-id="<?php echo e($lead->id); ?>">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($disposition_leads->hasPages()): ?>
                                <div class="mt-3">
                                    <?php echo e($disposition_leads->appends(['search' => $search, 'month' => $month, 'year' => $year, 'date_from' => $date_from ?? '', 'date_to' => $date_to ?? ''])->links()); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="badge bg-warning text-dark">
                                                        <?php echo e($niLabels[$lead->not_issued_disposition] ?? $lead->not_issued_disposition); ?>

                                                    </span>
                                                </td>
                                                <td><?php echo e($lead->notIssuedBy->name ?? '—'); ?></td>
                                                <td><?php echo e($lead->not_issued_at ? $lead->not_issued_at->format('M d, Y') : '—'); ?></td>
                                                <td>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->not_issued_resolved_at): ?>
                                                        ...
                                                        <div style="font-size:.65rem;color:#6c757d;">by <?php echo e($lead->notIssuedResolvedBy->name ?? '—'); ?></div>
                                                    <?php else: ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="badge bg-danger">
                                                        <?php echo e($fdfpLabels[$lead->not_paid_fdfp_type] ?? $lead->not_paid_fdfp_type); ?>
                                                    ...
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->not_paid_fdfp_type === 'manual_action' && $lead->not_paid_manual_disposition): ?>
                                                        <?php $niLabels = \App\Support\Statuses::NOT_ISSUED_DISPOSITIONS; ?>
                                                        <div style="font-size:.65rem;color:#6c757d;">
                                                            <?php echo e($niLabels[$lead->not_paid_manual_disposition] ?? $lead->not_paid_manual_disposition); ?>

                                                        </div>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                </td>
                                                <td><?php echo e($lead->notPaidBy->name ?? '—'); ?></td>
                                                <td><?php echo e($lead->not_paid_at ? $lead->not_paid_at->format('M d, Y') : '—'); ?></td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                            <tr>
...
function submitRetentionSale() {
    ...
    $.ajax({
        ...
        data: {
            ...
            sale_date: '<?php echo e(now()->toDateString()); ?>',
