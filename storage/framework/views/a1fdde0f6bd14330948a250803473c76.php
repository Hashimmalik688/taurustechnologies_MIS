...
<?php $__env->startSection('content'); ?>
            ...
            <div class="metric-card shadow-sm">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <h3 class="mb-0 text-danger fw-bold"><?php echo e($cb_count); ?></h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="metric-card shadow-sm">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <h3 class="mb-0 text-warning fw-bold"><?php echo e($rewrite_count); ?></h3>
            ...
            <div class="metric-card shadow-sm">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <h3 class="mb-0 text-info fw-bold"><?php echo e($yet_to_retain_count); ?></h3>
            ...
            <div class="metric-card shadow-sm">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <h3 class="mb-0 text-success fw-bold"><?php echo e($retained_count); ?></h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form method="GET" action="<?php echo e(route('retention.index')); ?>" class="mb-3">
                        <div class="row g-2">
                            <div class="col-md-5">
                            ...
                            <div class="col-md-2">
                                <a href="<?php echo e(route('retention.index')); ?>" class="btn btn-outline-secondary btn-sm w-100">
                    ...
                    <ul class="nav nav-tabs nav-tabs-custom nav-justified mb-3" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="tab" href="#yet-to-retain" role="tab">
                                ...
                                <span class="badge bg-info ms-1"><?php echo e($yet_to_retain_count); ?></span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#retained" role="tab">
                                ...
                                <span class="badge bg-success ms-1"><?php echo e($retained_count); ?></span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#rewrite" role="tab">
                                ...
                                <span class="badge bg-warning ms-1"><?php echo e($rewrite_count); ?></span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#disposition" role="tab">
                                ...
                                <span class="badge bg-danger ms-1"><?php echo e($disposition_count); ?></span>
                            </a>
                        </li>
                    </ul>
 ...
 <th class="u-min-w-200" >Manager Reason</th>
                                    ...
                                    <tbody>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $retained_leads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                <td class="text-center">
                                                    <a href="<?php echo e(route('leads.show', $lead->id)); ?>" class="btn btn-primary btn-sm" title="View Details" target="_blank">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                </td>
                                                <td><strong><?php echo e($lead->id); ?></strong></td>
                                                ...
                                                <td>
                                                    <span class="badge bg-success">
                                                        ...
                                                        <?php echo e($lead->retained_at ? $lead->retained_at->format('M d, Y') : 'N/A'); ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($retained_leads->hasPages()): ?>
                                <div class="d-flex justify-content-center mt-4">
                                    <?php echo e($retained_leads->appends(['search' => $search, 'month' => $month, 'year' => $year])->links()); ?>
                                                ...
                                                <td>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->chargeback_marked_date && $lead->sale_date): ?>
                                                        <span class="badge bg-warning-subtle text-warning">
                                                            <?php echo e($lead->chargeback_marked_date->diffInDays($lead->sale_date)); ?> days
                                                        </span>
                                                    <?php else: ?>
                                                        -
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
 ...
 >
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rewrite_leads->hasPages()): ?>
                                <div class="d-flex justify-content-center mt-4">
                                    <?php echo e($rewrite_leads->appends(['search' => $search, 'month' => $month, 'year' => $year])->links()); ?>
 ...
 <label class="btn btn-outline-success flex-grow-1" for="issued-<?php echo e($lead->id); ?>" >
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($disposition_leads->hasPages()): ?>
                                <div class="d-flex justify-content-center mt-4">
                                    <?php echo e($disposition_leads->appends(['search' => $search, 'month' => $month, 'year' => $year])->links()); ?>
