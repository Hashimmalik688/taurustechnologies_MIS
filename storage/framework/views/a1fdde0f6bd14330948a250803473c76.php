...
<div class="ret-kpi-row">
    ...
    <a href="<?php echo e($kpiLinks['unable_to_connect']); ?>" class="ret-kpi-pill k-unable_to_connect <?php echo e(($disp_filter ?? '') === 'unable_to_connect' ? 'kpi-active' : ''); ?>">
        <div class="rk-icon"><i class="bx bx-phone-off"></i></div>
        <div><div class="rk-lbl">Unable to Connect</div><div class="rk-val"><?php echo e($kpi['unable_to_connect'] ?? 0); ?></div></div>
    </a>
    <a href="<?php echo e($kpiLinks['not_answering']); ?>" class="ret-kpi-pill k-not_answering <?php echo e(($disp_filter ?? '') === 'not_answering' ? 'kpi-active' : ''); ?>">
        <div class="rk-icon"><i class="bx bx-phone-x"></i></div>
        <div><div class="rk-lbl">Not Answering</div><div class="rk-val"><?php echo e($kpi['not_answering'] ?? 0); ?></div></div>
    </a>
</div>
...
<div class="sl-card">
    ...
    <div class="sl-tabs" role="tablist">
        <div style="display:flex;gap:2px;flex-wrap:wrap;">
            <a class="sl-tab <?php echo e($activeTab === 'not-issued' ? 'active' : ''); ?>" data-bs-toggle="tab" href="#tab-not-issued" role="tab">
                <i class="bx bx-x-circle"></i> Not Issued
                <span class="badge bg-warning text-dark"><?php echo e($not_issued_count); ?></span>
            </a>
            <a class="sl-tab <?php echo e($activeTab === 'not-paid' ? 'active' : ''); ?>" data-bs-toggle="tab" href="#tab-not-paid" role="tab">
                <i class="bx bx-error-circle"></i> Not Paid / FDFP
                <span class="badge bg-danger"><?php echo e($not_paid_count); ?></span>
            </a>
            <a class="sl-tab <?php echo e($activeTab === 'cancelled' ? 'active' : ''); ?>" data-bs-toggle="tab" href="#tab-cancelled" role="tab">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane <?php echo e($activeTab === 'not-issued' ? 'show active' : ''); ?>" id="tab-not-issued" role="tabpanel">
                ...
                <table class="sl-tbl">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="font-size:.7rem;font-family:monospace;"><?php echo e($lead->policy_number ?? '—'); ?></td>
                            ...
                            <td style="font-size:.7rem;min-width:140px;">
                                <?php $lastHL = $lead->fieldHighlights->sortByDesc('updated_at')->first(); ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lastHL && $lastHL->updatedBy): ?>
                                    <strong style="font-size:.7rem;color:#334155;display:block;white-space:nowrap;"><?php echo e($lastHL->updatedBy->name); ?></strong>
                                    <span style="color:var(--bs-surface-400);font-size:.65rem;white-space:nowrap;"><?php echo e($lastHL->updated_at->format('m/d/Y h:i A')); ?></span>
                                <?php elseif($lead->updated_at): ?>
                                    <span style="color:var(--bs-surface-400);font-size:.65rem;white-space:nowrap;"><?php echo e($lead->updated_at->format('m/d/Y h:i A')); ?></span>
                                <?php else: ?>
                                    <span style="color:var(--bs-surface-400);">—</span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </td>
                            ...
                            <td style="min-width:180px;max-width:220px;vertical-align:middle;">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->retention_notes): ?>
                                    <div style="display:flex;align-items:center;gap:.35rem;min-width:0;">
                                        <button type="button" class="ret-note-pop-btn" style="flex-shrink:0;margin-top:.05rem;"
                                            ...
                                            data-bs-content="<?php echo e(nl2br(e($lead->retention_notes))); ?>"
                                            title="Retention Notes">
                                            <i class="bx bx-notepad"></i>
                                        </button>
                                        <span style="font-size:.68rem;color:#334155;line-height:1.3;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;"><?php echo e(Str::limit(str_replace(["\r\n", "\n", "\r"], ' ', $lead->retention_notes), 55)); ?></span>
                                    </div>
                                <?php else: ?>
                            ...
                            <td>
                                <div class="d-flex gap-1 flex-wrap">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->retention_disposition === 'rewrite'): ?>
                                        <button class="a-btn a-send-back btn-send-back-rewrite" data-id="<?php echo e($lead->id); ?>" data-name="<?php echo e($lead->cn_name); ?>">
                                            <i class="bx bx-left-arrow-circle"></i> Revert
                                        </button>
                                    <?php elseif(!$lead->recall_requested_at && !$disposed): ?>
        ...
        <div class="tab-pane <?php echo e($activeTab === 'not-paid' ? 'show active' : ''); ?>" id="tab-not-paid" role="tabpanel">
            <div class="sl-tbl-wrap">
                <table class="sl-tbl">
                    <thead>
                        <tr>
        ...
        <div class="tab-pane <?php echo e($activeTab === 'cancelled' ? 'show active' : ''); ?>" id="tab-cancelled" role="tabpanel">
            <div class="sl-tbl-wrap">
                <table class="sl-tbl">
                    <thead>
                        <tr>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer py-2 px-3 flex-column align-items-stretch gap-1">
                ...
                <div class="d-flex gap-1 flex-wrap align-items-center">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $allModalDisps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dispKey => $dispLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
