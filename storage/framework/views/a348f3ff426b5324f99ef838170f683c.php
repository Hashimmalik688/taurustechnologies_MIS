...
<?php $__env->startSection('content'); ?>
    <div class="settings-hub">
        ...
        <div class="settings-grid">
            <a href="<?php echo e(route('settings.index')); ?>" class="settings-card">
            ...
            <a href="<?php echo e(route('settings.permissions.index')); ?>" class="settings-card">
                <div class="settings-card-icon">
        ...
        <div class="settings-grid">
            <a href="<?php echo e(route('admin.dupe-checker.index')); ?>" class="settings-card">
                <div class="settings-card-icon">
            ...
            <a href="<?php echo e(route('admin.account-switching-log')); ?>" class="settings-card">
                <div class="settings-card-icon">
