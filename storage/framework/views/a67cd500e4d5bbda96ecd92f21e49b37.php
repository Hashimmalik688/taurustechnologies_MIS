...
<body>
    ...
    <div class="top-bar">
        <div>
            ...
            <small>Welcome, <?php echo e($agent->name); ?></small>
        </div>
        <div>
 <form class="d-inline" action="<?php echo e(route('logout')); ?>" method="POST" >
                <?php echo csrf_field(); ?>
    ...
    <div class="container-fluid" style="padding: 2rem;">
        ...
        <div class="row mb-4">
            <div class="col-md-2">
                <div class="stat-card">
                    <h2><?php echo e(number_format($stats['total_sales'])); ?></h2>
                    <p>Total Sales</p>
                </div>
            </div>
            <div class="col-md-2">
                <div class="stat-card stat-card-approved">
                    <h2><?php echo e(number_format($stats['approved'])); ?></h2>
                    <p>Approved</p>
                </div>
            </div>
            <div class="col-md-2">
                <div class="stat-card stat-card-declined">
                    <h2><?php echo e(number_format($stats['declined'])); ?></h2>
                    <p>Declined</p>
                </div>
            </div>
            <div class="col-md-2">
                <div class="stat-card stat-card-revenue">
                    <h2>$<?php echo e(number_format($stats['revenue'], 2)); ?></h2>
                    <p>Total Revenue</p>
                </div>
            </div>
            <div class="col-md-2">
                <div class="stat-card stat-card-company">
                    <h2>$<?php echo e(number_format($stats['company_share'], 2)); ?></h2>
                    <p>Company Share (30%)</p>
                </div>
            </div>
            <div class="col-md-2">
                <div class="stat-card stat-card-issued">
                    <h2><?php echo e(number_format($stats['issued_count'])); ?></h2>
                    <p>Issued Apps</p>
                </div>
            </div>
        </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($issuedLeads->count() > 0): ?>
 ...
 <h5 class="mb-3 text-gold u-fw-600" >
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <div class="alert alert-success" role="alert">
                        ...
                        $<?php echo e(number_format($stats['issued_revenue'], 2)); ?>/month
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="alert alert-info" role="alert">
                        <strong><i class="bx bx-shield me-2"></i>Total Coverage:</strong> 
                        $<?php echo e(number_format($stats['issued_coverage'], 0)); ?>
            ...
            <div class="table-responsive">
                <table class="table table-hover table-bordered">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $issuedLeads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $issued): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td>
                                    <span class="badge bg-primary"><?php echo e($issued->issued_policy_number); ?></span>
                                </td>
                                <td><strong><?php echo e($issued->cn_name); ?></strong></td>
                                <td><?php echo e($issued->phone_number); ?></td>
                                <td>
                                    <span class="badge bg-info"><?php echo e($issued->carrier_name ?? 'N/A'); ?></span>
                                </td>
                                <td><?php echo e($issued->policy_type ?? 'N/A'); ?></td>
                                <td class="text-success fw-semibold">$<?php echo e(number_format($issued->coverage_amount ?? 0, 0)); ?></td>
                                <td class="text-success fw-semibold">$<?php echo e(number_format($issued->monthly_premium ?? 0, 2)); ?></td>
                                <td><?php echo e($issued->issuance_date ? \Carbon\Carbon::parse($issued->issuance_date)->format('M d, Y') : 'N/A'); ?></td>
                                <td>
                    ...
                    <tfoot class="table-light">
                        <tr>
                            ...
                            <td class="text-success fw-bold">$<?php echo e(number_format($stats['issued_coverage'], 0)); ?></td>
                            <td class="text-success fw-bold">$<?php echo e(number_format($stats['issued_revenue'], 2)); ?>/mo</td>
                            <td colspan="2"></td>
                        </tr>
                    </tfoot>
                </table>
 ...
 <h5 class="mb-3 u-fw-600" style="color: var(--bs-status-default)">
            ...
            <div class="filter-bar">
                ...
                <select class="form-select u-max-w-200" id="carrierFilter">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $leads->unique('carrier_name')->pluck('carrier_name')->filter(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $carrier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <table class="table table-hover table-striped" id="leadsTable">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $leads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr data-status="<?php echo e($lead->status); ?>" data-carrier="<?php echo e($lead->carrier_name); ?>" data-name="<?php echo e(strtolower($lead->cn_name)); ?>" data-phone="<?php echo e($lead->phone_number); ?>">
...
<?php /**PATH /var/www/taurus-crm/resources/views/agent/dashboard.blade.php ENDPATH**/ ?>