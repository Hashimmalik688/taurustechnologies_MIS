            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-centered mb-0">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $dockRecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-sm btn-info" 
                                            onclick="editDock(<?php echo e(json_encode($record)); ?>)"
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\code\taurus-crm-master\resources\views/admin/dock/index.blade.php ENDPATH**/ ?>