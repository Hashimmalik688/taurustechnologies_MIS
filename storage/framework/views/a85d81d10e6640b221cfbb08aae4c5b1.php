<?php $__env->startSection('title', 'Audit Log #' . $auditLog->id); ?>
...
<!-- Page Header -->
<div class="page-hdr">
    <h5><i class="bx bx-detail"></i> Audit Log <span class="ph-sub">#<?php echo e($auditLog->id); ?></span></h5>
    <a href="<?php echo e(route('admin.audit-logs.index')); ?>" class="act-btn a-primary" style="text-decoration:none">
...
<div class="dtl-grid">
    ...
    <div>
        ...
        <div class="ex-card sec-card" style="margin-bottom:.65rem">
            ...
            <div class="sec-body" style="padding:.55rem .75rem">
                <div class="kv-row">
                    ...
                    <span class="kv-value" style="font-weight:700">#<?php echo e($auditLog->id); ?></span>
                </div>
                <div class="kv-row">
                    <span class="kv-label">Action</span>
                    <span class="kv-value"><span class="action-pill"><?php echo e(ucfirst(str_replace('_', ' ', $auditLog->action))); ?></span></span>
                </div>
                <div class="kv-row">
                    <span class="kv-label">Date & Time</span>
                    <span class="kv-value">
                        <i class="bx bx-time" style="font-size:.72rem;opacity:.4;vertical-align:middle"></i>
                        <?php echo e($auditLog->created_at->format('M d, Y h:i A')); ?>

                    </span>
                </div>
                <div class="kv-row">
                    <span class="kv-label">Timestamp</span>
                    <span class="kv-value"><span class="code-tag"><?php echo e($auditLog->created_at->timestamp); ?></span></span>
                </div>
            </div>
        </div>
        ...
        <div class="ex-card sec-card" style="margin-bottom:.65rem">
            ...
            <div class="sec-body" style="padding:.55rem .75rem">
                <div class="kv-row">
                    ...
                    <span class="kv-value">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($auditLog->user): ?>
                            <a href="<?php echo e(route('users.show', $auditLog->user->id)); ?>" style="color:#d4af37;font-weight:600;text-decoration:none;font-size:.72rem">
                                <i class="bx bx-link-external" style="font-size:.7rem;vertical-align:middle"></i> <?php echo e($auditLog->user->id); ?>
                ...
                <div class="kv-row">
                    ...
                    <span class="kv-value">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($auditLog->user): ?>
                            <span class="v-badge" style="font-size:.62rem"><?php echo e($auditLog->user->email); ?></span>
                        <?php else: ?>
                            <?php echo e($auditLog->user_email ?? 'System'); ?>
                ...
                <div class="kv-row">
                    ...
                    <span class="kv-value"><?php echo e($auditLog->user?->name ?? 'System'); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="ex-card sec-card" style="margin-bottom:.65rem">
            ...
            <div class="sec-body" style="padding:.55rem .75rem">
                <div class="kv-row">
                    ...
                    <span class="kv-value"><?php echo e($auditLog->model ?? '—'); ?></span>
                </div>
                <div class="kv-row">
                    <span class="kv-label">Model ID</span>
                    <span class="kv-value"><?php echo e($auditLog->model_id ?? '—'); ?></span>
                </div>
                <div class="kv-row">
                    <span class="kv-label">Description</span>
                    <span class="kv-value"><?php echo e($auditLog->description ?? 'No description'); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="ex-card sec-card" style="margin-bottom:.65rem">
            ...
            <div class="sec-body" style="padding:.55rem .75rem">
                <div class="json-block"><?php echo e(json_encode($auditLog->changes, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES)); ?></div>
            </div>
        </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
    ...
    <div>
        ...
        <div class="ex-card sec-card" style="margin-bottom:.65rem">
            ...
            <div class="sec-body" style="padding:.55rem .75rem">
                <div class="kv-row">
                    ...
                    <span class="kv-value"><span class="code-tag"><?php echo e($auditLog->ip_address ?? '—'); ?></span></span>
                </div>
                <div class="kv-row">
                    ...
                    <span class="kv-value" style="font-size:.68rem">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($auditLog->user_agent): ?>
                            <?php echo e(Str::limit($auditLog->user_agent, 50)); ?>
                ...
                <div style="margin-top:.35rem">
                    ...
                    <div class="ua-block"><?php echo e($auditLog->user_agent); ?></div>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </div>
        ...
        <div class="ex-card sec-card">
            ...
            <div class="sec-body" style="padding:.55rem .75rem">
                <a href="<?php echo e(route('admin.audit-logs.index', ['action' => $auditLog->action])); ?>" class="nav-link-btn">
                    <i class="bx bx-filter-alt"></i> All "<?php echo e(ucfirst(str_replace('_', ' ', $auditLog->action))); ?>" logs
                </a>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($auditLog->user): ?>
                <a href="<?php echo e(route('admin.audit-logs.index', ['user_id' => $auditLog->user_id])); ?>" class="nav-link-btn">
                    <i class="bx bx-user"></i> All logs from <?php echo e($auditLog->user->email); ?>
