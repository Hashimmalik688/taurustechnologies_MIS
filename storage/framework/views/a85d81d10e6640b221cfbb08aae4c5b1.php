    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <a href="<?php echo e(route('audit-logs.index', ['action' => $auditLog->action])); ?>" class="btn btn-sm btn-outline-primary w-100 mb-2">
                        <i class="fas fa-filter"></i> Show All "<?php echo e(ucfirst(str_replace('_', ' ', $auditLog->action))); ?>"
                    </a>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($auditLog->user): ?>
                        <a href="<?php echo e(route('audit-logs.index', ['user_id' => $auditLog->user_id])); ?>" class="btn btn-sm btn-outline-primary w-100">
