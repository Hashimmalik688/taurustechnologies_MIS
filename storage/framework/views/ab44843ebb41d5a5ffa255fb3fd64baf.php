...
<div class="container-fluid">
    <div class="row mb-3">
        ...
        <div class="col-md-4 text-end">
            <a href="<?php echo e(route('admin.audit-logs.export')); ?><?php echo e(request()->getQueryString() ? '?' . request()->getQueryString() : ''); ?>" class="btn btn-success">
    ...
    <ul class="nav nav-tabs mb-4">
        <li class="nav-item">
            <a class="nav-link" href="<?php echo e(route('admin.account-switching-log')); ?>">
                <i class="bx bx-transfer me-1"></i> Suspicious Devices
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link active" href="<?php echo e(route('admin.audit-logs.index')); ?>">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('admin.audit-logs.index')); ?>" class="row g-3">
                <div class="col-md-3">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $auditLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(route('admin.audit-logs.show', $log->id)); ?>" class="btn btn-sm btn-info" title="View Details">
