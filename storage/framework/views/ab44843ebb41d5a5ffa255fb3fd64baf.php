...
<div class="tab-row">
    ...
    <a href="<?php echo e(route('admin.audit-logs.index')); ?>" class="tab-pill <?php echo e(!request('action') ? 'active' : ''); ?>">
        <i class="bx bx-list-ul"></i> All Activity Logs
    </a>
    <a href="<?php echo e(route('admin.audit-logs.index', ['action' => 'security_suspect'])); ?>" class="tab-pill <?php echo e(request('action') === 'security_suspect' ? 'active' : ''); ?>" style="<?php echo e(request('action') === 'security_suspect' ? '' : 'border-color:rgba(239,68,68,.3);color:#ef4444'); ?>">
        ...
        ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($secCount > 0): ?>
            <span style="background:#ef4444;color:#fff;border-radius:99px;font-size:.58rem;font-weight:700;padding:1px 5px;line-height:1.4;min-width:16px;text-align:center"><?php echo e($secCount); ?></span>
        ...
        <div class="table-responsive">
            <table class="table ex-tbl mb-0" id="auditLogTable">
                ...
                <tbody>
                    ...
                    <tr <?php echo e($log->action === 'security_suspect' ? 'style=background:rgba(239,68,68,.04);border-left:3px solid rgba(239,68,68,.35)' : ''); ?>>
                        ...
                        <td>
                            <span class="action-pill <?php echo e($log->action === 'security_suspect' ? 'security' : ''); ?>">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($log->action === 'security_suspect'): ?> 🚨 <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php echo e(ucfirst(str_replace('_', ' ', $log->action))); ?>

                            </span>
                        </td>
                        <td>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($log->action === 'security_suspect'): ?>
                                <?php
                                    $triggerLabels = [
                                ...
                                <div style="display:flex;flex-direction:column;gap:2px">
                                    <span style="font-size:.72rem;font-weight:700;color:#ef4444"><?php echo e($icon); ?> <?php echo e($label); ?></span>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pagePath): ?>
                                        <span style="font-size:.62rem;color:var(--bs-surface-400);font-family:monospace"><?php echo e($pagePath); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            <?php elseif($log->model): ?>
                                ...
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php elseif($log->description): ?>
                                <span style="font-size:.7rem;color:var(--bs-surface-500)"><?php echo e($log->description); ?></span>
                            <?php else: ?>
