<?php $__env->startSection('title', 'Retention Dashboard'); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="col-xl-9 col-lg-8">
                ...
                <div class="sec-hdr">
                    ...
                    <div class="team-tabs">
                        <button class="team-tab-btn active" onclick="switchTab('retained')" id="retainedTab">
                            Retained (<span id="retainedCount"><?php echo e($retainedLeads->count()); ?></span>)
                        </button>
                        <button class="team-tab-btn" onclick="switchTab('rewrite')" id="rewriteTab">
                            Rewrites (<span id="rewriteCount"><?php echo e($rewriteLeads->count()); ?></span>)
                        </button>
                    </div>
                </div>
                <div class="scroll-tbl">
                    <table class="ex-tbl">
                        ...
                        <tbody id="salesTableBody">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $retainedLeads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="sales-row" data-type="retained">
                                <td>
                                    <i class="bx bx-user-circle me-1" style="color:var(--bs-gold);opacity:.7"></i>
                                    <?php echo e($lead->cn_name ?? 'N/A'); ?>

                                </td>
                                <td><?php echo e($lead->phone_number ?? 'N/A'); ?></td>
                                <td><?php echo e($lead->carrier_name ?? ($lead->insuranceCarrier->name ?? 'N/A')); ?></td>
                                <td><?php echo e($lead->closer_name ?? 'N/A'); ?></td>
                                <td class="text-center">
                                    <span class="bd-mini bd-green">$<?php echo e(number_format($lead->monthly_premium ?? 0, 2)); ?></span>
                                </td>
                                <td class="text-center">
                                    <span class="status-pill s-retained">Retained</span>
                                </td>
                                <td><?php echo e($lead->retained_at ? $lead->retained_at->format('m/d/Y') : 'N/A'); ?></td>
                            </tr>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $rewriteLeads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="sales-row" data-type="rewrite" style="display:none">
                                ...
                                <td><?php echo e($lead->closer_name ?? 'N/A'); ?></td>
                                <td class="text-center">
                                    <span class="bd-mini bd-warn">$<?php echo e(number_format($lead->monthly_premium ?? 0, 2)); ?></span>
                                </td>
                                <td class="text-center">
                                    <span class="status-pill s-rewrite">Rewrite</span>
                                </td>
                                <td><?php echo e($lead->sale_date ? $lead->sale_date->format('m/d/Y') : ($lead->chargeback_marked_date ? $lead->chargeback_marked_date->format('m/d/Y') : 'N/A')); ?></td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr class="sales-row" data-type="rewrite" style="display:none">
                                <td colspan="7" class="text-center py-3" style="color:var(--bs-surface-400);font-size:.78rem">
            ...
            <div class="ex-card sec-card">
                <div class="sec-body text-center py-3">
                    <a href="<?php echo e(route('retention.index')); ?>" class="btn btn-primary btn-sm">
                ...
                <div class="sec-body">
                    <div class="target-chart-wrap">
                        ...
                        <div class="target-info">
                            Chargebacks: <strong style="color:#c84646"><?php echo e($stats['total_chargebacks'] ?? 0); ?></strong> &nbsp;|&nbsp;
                            Retained: <strong style="color:#1a8754"><?php echo e($stats['total_retained'] ?? 0); ?></strong>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="sec-body">
                    <div class="ret-row" style="margin-bottom:0.4rem">
                        <div class="ret-block r-cb">
                            <div class="r-val"><?php echo e($stats['total_chargebacks'] ?? 0); ?></div>
                            <div class="r-lbl">Chargebacks</div>
                        </div>
                        <div class="ret-block r-ret">
                            <div class="r-val"><?php echo e($stats['retained_today'] ?? 0); ?></div>
                            <div class="r-lbl">Today</div>
                        </div>
                    </div>
                    <div class="ret-row">
                        <div class="ret-block r-pend">
                            <div class="r-val"><?php echo e($stats['yet_to_retain'] ?? 0); ?></div>
                            <div class="r-lbl">Pending</div>
                        </div>
                        <div class="ret-block r-rw">
                            <div class="r-val"><?php echo e($stats['rewrite_count'] ?? 0); ?></div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($stats['rewrite_count'] ?? 0) > 0): ?>
    <div class="ex-card att-alert" style="border-left-color: #7c69ef; background: linear-gradient(135deg, rgba(124,105,239,.06) 0%, rgba(124,105,239,.02) 100%); margin-top: 0.5rem;">
        <div>
            ...
            <span>There are <strong><?php echo e($stats['rewrite_count']); ?></strong> sales that need to be rewritten (30+ days old chargebacks).</span>
        </div>
        <a href="<?php echo e(route('retention.index')); ?>" class="link-btn" style="border-color:#7c69ef;color:#5b49c7">View Rewrites</a>
    </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php $__env->stopSection(); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const retained = <?php echo e($stats['total_retained'] ?? 0); ?>;
    const pending = <?php echo e($stats['yet_to_retain'] ?? 0); ?>;
    const rewrites = <?php echo e($stats['rewrite_count'] ?? 0); ?>;
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taurus-crm/resources/views/retention/dashboard.blade.php ENDPATH**/ ?>