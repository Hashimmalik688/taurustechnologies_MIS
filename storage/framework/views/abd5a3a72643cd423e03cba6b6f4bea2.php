<?php $__env->startSection('title', 'Zoom Webhook Diagnostics'); ?>
    ...
    <div class="row">
        <div class="col-12">
            <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:1.5rem;">
                ...
                <a href="<?php echo e(route('settings.reports.zoom-logs')); ?>" class="btn btn-primary">
            ...
            <div class="diag-grid">
                <div class="stat-box">
                    <div class="stat-value"><?php echo e($stats['crm_events']); ?></div>
                    <div class="stat-label">Events in CRM</div>
                </div>
                <div class="stat-box warning">
                    <div class="stat-value"><?php echo e($stats['estimated_zoom']); ?></div>
                    <div class="stat-label">Estimated Zoom Total</div>
                </div>
                <div class="stat-box success">
                    <div class="stat-value"><?php echo e($stats['coverage_percent']); ?>%</div>
            ...
            <div class="diag-card">
                <h4><i class="bx bx-check-circle" style="color:#10b981"></i> Currently Enabled (<?php echo e(count($current_events)); ?> events)</h4>
                <ul class="event-list">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $current_events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <span><code><?php echo e($event); ?></code></span>
                            <span class="badge badge-success"><?php echo e($count); ?> captured</span>
                        </li>
            ...
            <div class="diag-card">
                ...
                <div style="margin-top:1rem; padding:1rem; background:#fef3c7; border-radius:8px; font-size:.85rem;">
                    <strong>⚠️ Impact:</strong> These 4 events account for ~<?php echo e($stats['estimated_zoom'] - $stats['crm_events']); ?> missing call records (<?php echo e(100 - $stats['coverage_percent']); ?>% gap)
                </div>
            </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taurus-crm/resources/views/admin/reports/zoom-diagnostics.blade.php ENDPATH**/ ?>