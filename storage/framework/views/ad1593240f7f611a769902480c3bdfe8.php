<?php $__env->startSection('title', 'Live Analytics'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="ex-card sec-card" style="margin-bottom:.5rem;">
        <div class="filter-bar">
            <button type="button" class="f-btn <?php echo e($filter === 'today' ? 'active' : ''); ?>" data-filter="today">
                <i class="bx bx-calendar-alt"></i> Today
            </button>
            <button type="button" class="f-btn <?php echo e($filter === 'custom' ? 'active' : ''); ?>" data-filter="custom" id="customRangeBtn">
                <i class="bx bx-calendar-edit"></i> Custom
            </button>
            <input type="text" id="customDateRange" class="f-input <?php echo e($filter !== 'custom' ? 'd-none' : ''); ?>" placeholder="Select date range">
            ...
            <span class="ts-footer" style="margin-left:auto;">
                ...
                <span id="last-updated"><?php echo e(now('America/Los_Angeles')->format('M d, Y h:i A')); ?> PT</span>
            </span>
        </div>
    </div>
    ...
    <div class="team-section">
        ...
        <div class="grid-2">
            ...
            <div class="ex-card sec-card">
                <div class="sec-hdr">
                    ...
                    <span style="font-size:.6rem;color:var(--bs-surface-400);" id="per-verifier-count"><?php echo e($verifierPipeline->count()); ?> active</span>
                </div>
                <div class="scroll-tbl">
                    <table class="ex-tbl">
                        ...
                        <tbody id="per-verifier-tbody">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $verifierPipeline; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><strong><?php echo e($v['name']); ?></strong></td>
                                    <td class="text-center"><span class="v-badge v-blue"><?php echo e($v['total']); ?></span></td>
                                    <td class="text-center"><span class="v-badge v-gray"><?php echo e($v['disposed']); ?></span></td>
                                    <td class="text-center"><span class="v-badge v-warn"><?php echo e($v['pending']); ?></span></td>
                                    <td class="text-center"><span class="v-badge v-green"><?php echo e($v['sales']); ?></span></td>
                                    <td class="text-center"><span class="v-badge v-red"><?php echo e($v['declined']); ?></span></td>
                                </tr>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($verifierPipeline->count() > 0): ?>
                        <tfoot id="per-verifier-tfoot">
                            <tr>
                                <td><strong>Total</strong></td>
                                <td class="text-center"><span class="v-badge v-blue"><?php echo e($verifierPipeline->sum('total')); ?></span></td>
                                <td class="text-center"><span class="v-badge v-gray"><?php echo e($verifierPipeline->sum('disposed')); ?></span></td>
                                <td class="text-center"><span class="v-badge v-warn"><?php echo e($verifierPipeline->sum('pending')); ?></span></td>
                                <td class="text-center"><span class="v-badge v-green"><?php echo e($verifierPipeline->sum('sales')); ?></span></td>
                                <td class="text-center"><span class="v-badge v-red"><?php echo e($verifierPipeline->sum('declined')); ?></span></td>
                            </tr>
                        </tfoot>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </table>
            ...
            <div class="ex-card sec-card">
                <div class="sec-hdr">
                    ...
                    <span style="font-size:.6rem;color:var(--bs-surface-400);" id="per-closer-count"><?php echo e($peregrineCloserBreakdown->count()); ?> active</span>
                </div>
                <div class="scroll-tbl">
                    <table class="ex-tbl">
                        <thead>
                        ...
                        <tbody id="per-closer-tbody">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $peregrineCloserBreakdown; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $closer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><strong><?php echo e($closer['name']); ?></strong></td>
                                    <td class="text-center"><span class="v-badge v-blue"><?php echo e($closer['total_assigned']); ?></span></td>
                                    <td class="text-center"><span class="v-badge v-gray"><?php echo e($closer['disposed']); ?></span></td>
                                    <td class="text-center"><span class="v-badge v-warn"><?php echo e($closer['callbacks']); ?></span></td>
                                    <td class="text-center"><span class="v-badge v-teal"><?php echo e($closer['sent_to_validator']); ?></span></td>
                                    <td class="text-center"><span class="v-badge v-green"><?php echo e($closer['sales']); ?></span></td>
                                    <td class="text-center"><span class="v-badge v-red"><?php echo e($closer['declined']); ?></span></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($peregrineCloserBreakdown->count() > 0): ?>
                        <tfoot id="per-closer-tfoot">
                            <tr>
                                <td><strong>Total</strong></td>
                                <td class="text-center"><span class="v-badge v-blue"><?php echo e($peregrineCloserBreakdown->sum('total_assigned')); ?></span></td>
                                <td class="text-center"><span class="v-badge v-gray"><?php echo e($peregrineCloserBreakdown->sum('disposed')); ?></span></td>
                                <td class="text-center"><span class="v-badge v-warn"><?php echo e($peregrineCloserBreakdown->sum('callbacks')); ?></span></td>
                                <td class="text-center"><span class="v-badge v-teal"><?php echo e($peregrineCloserBreakdown->sum('sent_to_validator')); ?></span></td>
                                <td class="text-center"><span class="v-badge v-green"><?php echo e($peregrineCloserBreakdown->sum('sales')); ?></span></td>
                                <td class="text-center"><span class="v-badge v-red"><?php echo e($peregrineCloserBreakdown->sum('declined')); ?></span></td>
                            </tr>
                        </tfoot>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </table>
        ...
        <div class="ex-card sec-card" style="margin-top:.5rem;">
            <div class="sec-hdr">
                ...
                <span style="font-size:.6rem;color:var(--bs-surface-400);" id="per-submissions-count"><?php echo e($verifierSubmissions->count()); ?> submissions</span>
            </div>
            <div class="scroll-tbl" style="max-height:320px;">
                <table class="ex-tbl">
                    ...
                    <tbody id="per-submissions-tbody">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $verifierSubmissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td style="color:var(--bs-surface-400);font-size:.7rem;"><?php echo e($idx + 1); ?></td>
                                <td style="font-size:.75rem;white-space:nowrap;"><?php echo e($sub['submitted_at']); ?></td>
                                <td><strong><?php echo e($sub['cn_name']); ?></strong></td>
                                <td style="font-size:.75rem;"><?php echo e($sub['phone']); ?></td>
                                <td><?php echo e($sub['verifier']); ?></td>
                                <td><?php echo e($sub['closer']); ?></td>
                                <td class="text-center">
                                    ...
                                    ?>
                                    <span class="v-badge <?php echo e($sc); ?>"><?php echo e($sub['status']); ?></span>
                                </td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        ...
        <div class="grid-2">
            ...
            <div class="ex-card sec-card">
                <div class="sec-hdr">
                    ...
                    <span style="font-size:.6rem;color:var(--bs-surface-400);" id="per-validator-count"><?php echo e($validatorBreakdown->count()); ?> active</span>
                </div>
                <div class="scroll-tbl">
                    <table class="ex-tbl">
                        <thead>
                        ...
                        <tbody id="per-validator-tbody">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $validatorBreakdown; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $validator): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><strong><?php echo e($validator['name']); ?></strong></td>
                                    <td class="text-center"><span class="v-badge v-teal"><?php echo e($validator['total_assigned']); ?></span></td>
                                    <td class="text-center"><span class="v-badge v-warn"><?php echo e($validator['pending']); ?></span></td>
                                    <td class="text-center"><span class="v-badge v-green"><?php echo e($validator['approved']); ?></span></td>
                                    <td class="text-center"><span class="v-badge v-gray"><?php echo e($validator['returned']); ?></span></td>
                                    <td class="text-center"><span class="v-badge v-red"><?php echo e($validator['declined']); ?></span></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($validatorBreakdown->count() > 0): ?>
                        <tfoot id="per-validator-tfoot">
                            <tr>
                                <td><strong>Total</strong></td>
                                <td class="text-center"><span class="v-badge v-teal"><?php echo e($validatorFormMetrics['total_assigned']); ?></span></td>
                                <td class="text-center"><span class="v-badge v-warn"><?php echo e($validatorFormMetrics['pending']); ?></span></td>
                                <td class="text-center"><span class="v-badge v-green"><?php echo e($validatorFormMetrics['approved']); ?></span></td>
                                <td class="text-center"><span class="v-badge v-gray"><?php echo e($validatorFormMetrics['returned']); ?></span></td>
                                <td class="text-center"><span class="v-badge v-red"><?php echo e($validatorFormMetrics['declined']); ?></span></td>
                            </tr>
                        </tfoot>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </table>
            ...
            <div class="ex-card sec-card">
                <div class="sec-hdr">
                    ...
                    <span class="v-badge v-warn" style="font-size:.55rem;"><?php echo e($metrics['sales']['pending_approval'] ?? 0); ?> pending</span>
                </div>
                <div class="scroll-tbl">
                    <table class="ex-tbl">
                        <thead>
                        ...
                        <tbody id="per-manager-tbody">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $peregrineManagerBreakdown; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mgr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><strong><?php echo e($mgr['name']); ?></strong></td>
                                    <td class="text-center"><span class="v-badge v-blue"><?php echo e($mgr['total_reviewed']); ?></span></td>
                                    <td class="text-center"><span class="v-badge v-green"><?php echo e($mgr['approved']); ?></span></td>
                                    <td class="text-center"><span class="v-badge v-red"><?php echo e($mgr['declined']); ?></span></td>
                                    <td class="text-center"><span class="v-badge v-purple"><?php echo e($mgr['underwriting']); ?></span></td>
                                    <td class="text-center"><span class="v-badge v-gray"><?php echo e($mgr['chargeback']); ?></span></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($peregrineManagerBreakdown->count() > 0): ?>
                        <tfoot id="per-manager-tfoot">
                            <tr>
                                <td><strong>Total</strong></td>
                                <td class="text-center"><span class="v-badge v-blue"><?php echo e($peregrineManagerBreakdown->sum('total_reviewed')); ?></span></td>
                                <td class="text-center"><span class="v-badge v-green"><?php echo e($peregrineManagerBreakdown->sum('approved')); ?></span></td>
                                <td class="text-center"><span class="v-badge v-red"><?php echo e($peregrineManagerBreakdown->sum('declined')); ?></span></td>
                                <td class="text-center"><span class="v-badge v-purple"><?php echo e($peregrineManagerBreakdown->sum('underwriting')); ?></span></td>
                                <td class="text-center"><span class="v-badge v-gray"><?php echo e($peregrineManagerBreakdown->sum('chargeback')); ?></span></td>
                            </tr>
                        </tfoot>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </table>
        ...
        <div class="ex-card sec-card">
            <div class="sec-hdr">
                ...
                <span class="v-badge v-warn" style="font-size:.55rem;"><?php echo e($metrics['qa']['pending'] ?? 0); ?> pending</span>
            </div>
            <div class="scroll-tbl">
                <table class="ex-tbl">
                    <thead>
                    ...
                    <tbody id="per-qa-tbody">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $peregrineQABreakdown; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $qa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td><strong><?php echo e($qa['name']); ?></strong></td>
                                <td class="text-center"><span class="v-badge v-warn"><?php echo e($qa['pending']); ?></span></td>
                                <td class="text-center"><span class="v-badge v-green"><?php echo e($qa['good']); ?></span></td>
                                <td class="text-center"><span class="v-badge v-purple"><?php echo e($qa['avg']); ?></span></td>
                                <td class="text-center"><span class="v-badge v-red"><?php echo e($qa['bad']); ?></span></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($peregrineQABreakdown->count() > 0): ?>
                    <tfoot id="per-qa-tfoot">
                        <tr>
                            <td><strong>Total</strong></td>
                            <td class="text-center"><span class="v-badge v-warn"><?php echo e($peregrineQABreakdown->sum('pending')); ?></span></td>
                            <td class="text-center"><span class="v-badge v-green"><?php echo e($peregrineQABreakdown->sum('good')); ?></span></td>
                            <td class="text-center"><span class="v-badge v-purple"><?php echo e($peregrineQABreakdown->sum('avg')); ?></span></td>
                            <td class="text-center"><span class="v-badge v-red"><?php echo e($peregrineQABreakdown->sum('bad')); ?></span></td>
                        </tr>
                    </tfoot>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </table>
    ...
    <div class="team-section">
        ...
        <div class="ex-card sec-card">
            <div class="sec-hdr">
                ...
                <span style="font-size:.6rem;color:var(--bs-surface-400);" id="rav-closer-count"><?php echo e($ravensCloserBreakdown->count()); ?> active</span>
            </div>
            <div class="scroll-tbl">
                <table class="ex-tbl">
                    <thead>
                    ...
                    <tbody id="rav-closer-tbody">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $ravensCloserBreakdown; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $closer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td><strong><?php echo e($closer['name']); ?></strong></td>
                                <td class="text-center"><span class="v-badge v-green"><?php echo e($closer['sales']); ?></span></td>
                                <td class="text-center"><span class="v-badge v-warn"><?php echo e($closer['mgr_pending']); ?></span></td>
                                <td class="text-center"><span class="v-badge v-blue"><?php echo e($closer['mgr_approved']); ?></span></td>
                                <td class="text-center"><span class="v-badge v-red"><?php echo e($closer['mgr_declined']); ?></span></td>
                                <td class="text-center"><span class="v-badge v-purple"><?php echo e($closer['mgr_underwriting']); ?></span></td>
                                <td class="text-center"><span class="v-badge v-gray"><?php echo e($closer['mgr_chargeback']); ?></span></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr><td colspan="7" class="text-center py-3" style="color:var(--bs-surface-400);font-size:.75rem;"><i class="bx bx-info-circle"></i> No closer activity</td></tr>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ravensCloserBreakdown->count() > 0): ?>
                    <tfoot id="rav-closer-tfoot">
                        <tr>
                            <td><strong>Total</strong></td>
                            <td class="text-center"><span class="v-badge v-green"><?php echo e($ravensCloserBreakdown->sum('sales')); ?></span></td>
                            <td class="text-center"><span class="v-badge v-warn"><?php echo e($ravensCloserBreakdown->sum('mgr_pending')); ?></span></td>
                            <td class="text-center"><span class="v-badge v-blue"><?php echo e($ravensCloserBreakdown->sum('mgr_approved')); ?></span></td>
                            <td class="text-center"><span class="v-badge v-red"><?php echo e($ravensCloserBreakdown->sum('mgr_declined')); ?></span></td>
                            <td class="text-center"><span class="v-badge v-purple"><?php echo e($ravensCloserBreakdown->sum('mgr_underwriting')); ?></span></td>
                            <td class="text-center"><span class="v-badge v-gray"><?php echo e($ravensCloserBreakdown->sum('mgr_chargeback')); ?></span></td>
                        </tr>
                    </tfoot>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </table>
                ...
                <div class="scroll-tbl">
                    <table class="ex-tbl">
                        ...
                        <tbody id="rav-qa-tbody">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $ravensQABreakdown; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $qa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><strong><?php echo e($qa['name']); ?></strong></td>
                                    <td class="text-center"><span class="v-badge v-warn"><?php echo e($qa['pending']); ?></span></td>
                                    <td class="text-center"><span class="v-badge v-green"><?php echo e($qa['good']); ?></span></td>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ravensQABreakdown->count() > 0): ?>
                        <tfoot id="rav-qa-tfoot">
                            <tr>
                                <td><strong>Total</strong></td>
                                <td class="text-center"><span class="v-badge v-warn"><?php echo e($ravensQABreakdown->sum('pending')); ?></span></td>
                                <td class="text-center"><span class="v-badge v-green"><?php echo e($ravensQABreakdown->sum('good')); ?></span></td>
                                <td class="text-center"><span class="v-badge v-purple"><?php echo e($ravensQABreakdown->sum('avg')); ?></span></td>
                                <td class="text-center"><span class="v-badge v-red"><?php echo e($ravensQABreakdown->sum('bad')); ?></span></td>
                            </tr>
                        </tfoot>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </table>
                ...
                <div class="scroll-tbl">
                    <table class="ex-tbl">
                        ...
                        <tbody id="rav-manager-tbody">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $ravensManagerBreakdown; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mgr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><strong><?php echo e($mgr['name']); ?></strong></td>
                                    <td class="text-center"><span class="v-badge v-blue"><?php echo e($mgr['total_reviewed']); ?></span></td>
                                    <td class="text-center"><span class="v-badge v-green"><?php echo e($mgr['approved']); ?></span></td>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ravensManagerBreakdown->count() > 0): ?>
                        <tfoot id="rav-manager-tfoot">
                            <tr>
                                <td><strong>Total</strong></td>
                                <td class="text-center"><span class="v-badge v-blue"><?php echo e($ravensManagerBreakdown->sum('total_reviewed')); ?></span></td>
                                <td class="text-center"><span class="v-badge v-green"><?php echo e($ravensManagerBreakdown->sum('approved')); ?></span></td>
                                <td class="text-center"><span class="v-badge v-red"><?php echo e($ravensManagerBreakdown->sum('declined')); ?></span></td>
                                <td class="text-center"><span class="v-badge v-purple"><?php echo e($ravensManagerBreakdown->sum('underwriting')); ?></span></td>
                                <td class="text-center"><span class="v-badge v-gray"><?php echo e($ravensManagerBreakdown->sum('chargeback')); ?></span></td>
                            </tr>
                        </tfoot>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </table>
...
<script>
let currentFilter = '<?php echo e($filter); ?>';
...
<?php if($filter === 'custom' && $startDate && $endDate): ?>
    dateRangePicker.setDate(['<?php echo $startDate; ?>', '<?php echo $endDate; ?>']);
...
function updateFilters() {
    ...
    window.location.href = '<?php echo e(route("analytics.live")); ?>?' + params.toString();
}
...
function fetchLiveData() {
    ...
    fetch('<?php echo e(route("analytics.live.data")); ?>?' + getFilterParams(), {
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taurus-crm/resources/views/analytics/live.blade.php ENDPATH**/ ?>