<?php $__env->startSection('title', 'Live Analytics Dashboard'); ?>
                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="<?php echo e(route('root')); ?>">Dashboard</a></li>
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                            <div class="d-flex flex-wrap gap-2">
                                <button type="button" class="btn btn-outline-primary filter-btn <?php echo e($filter === 'today' ? 'active' : ''); ?>" data-filter="today">
                                    <i class="bx bx-calendar-alt me-1"></i> Today
                                </button>
                                <button type="button" class="btn btn-outline-primary filter-btn <?php echo e($filter === 'custom' ? 'active' : ''); ?>" data-filter="custom" id="customRangeBtn">
                        ...
                        <div class="mt-2">
                            <small class="text-muted">
                                ...
                                Last Updated: <strong id="last-updated"><?php echo e(now('America/Denver')->format('M d, Y h:i:s A')); ?> MT</strong>
                                ...
                                <tfoot class="table-light">
                                    <tr>
                                        ...
                                        <th class="text-center">
                                            <span class="badge bg-info fs-6"><?php echo e($validatorFormMetrics['total_assigned']); ?></span>
                                        </th>
                                        <th class="text-center">
                                            <span class="badge bg-secondary fs-6"><?php echo e($validatorBreakdown->sum('pending') ?? 0); ?></span>
                                        </th>
                                        <th class="text-center">
                                            <span class="badge bg-warning fs-6"><?php echo e($validatorBreakdown->sum('submitted') ?? 0); ?></span>
                                        </th>
                                        <th class="text-center">
                                            <span class="badge bg-success fs-6"><?php echo e($validatorFormMetrics['approved']); ?></span>
                                        </th>
                                        <th class="text-center">
                                            <span class="badge bg-warning fs-6"><?php echo e($validatorFormMetrics['returned']); ?></span>
                                        </th>
                                        <th class="text-center">
                                            <span class="badge bg-danger fs-6"><?php echo e($validatorFormMetrics['declined']); ?></span>
                                        </th>
                                        <th class="text-center">
                                            <span class="badge bg-primary fs-6"><?php echo e($validatorFormMetrics['approved'] + $validatorFormMetrics['returned'] + $validatorFormMetrics['declined']); ?></span>
                                        </th>
                                    </tr>
                                </tfoot>
                            </table>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover table-striped align-middle mb-0">
                                ...
                                <tbody>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($peregrineCloserBreakdown && $peregrineCloserBreakdown->count() > 0): ?>
                                        <?php
                                            $totals = [
                                        ...
                                        ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $peregrineCloserBreakdown; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $closer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><strong><?php echo e($closer['name']); ?></strong></td>
                                                <td class="text-center">
                                                    <span class="badge bg-primary-subtle text-primary fs-6"><?php echo e($closer['total_assigned']); ?></span>
                                                </td>
                                                <td class="text-center">
                                                    <span class="badge bg-warning-subtle text-warning fs-6"><?php echo e($closer['pending']); ?></span>
                                                </td>
                                                <td class="text-center">
                                                    <span class="badge bg-info-subtle text-info fs-6"><?php echo e($closer['closed']); ?></span>
                                                </td>
                                                <td class="text-center">
                                                    <span class="badge bg-success-subtle text-success fs-6"><?php echo e($closer['sales']); ?></span>
                                                </td>
                                                <td class="text-center">
                                                    <span class="badge bg-secondary-subtle text-secondary fs-6"><?php echo e($closer['returned']); ?></span>
                                                </td>
                                                <td class="text-center">
                                                    <span class="badge bg-danger-subtle text-danger fs-6"><?php echo e($closer['declined']); ?></span>
                                                </td>
                                                <td class="text-center">
                                                    <span class="badge bg-dark-subtle text-dark fs-6"><?php echo e($closer['total_processed']); ?></span>
                                                </td>
                                                <td class="text-center">
                                                    <span class="badge bg-<?php echo e($closer['conversion_rate'] >= 50 ? 'success' : ($closer['conversion_rate'] >= 30 ? 'warning' : 'danger')); ?> fs-6">
                                                        <?php echo e($closer['conversion_rate']); ?>%
                                                    </span>
                                                </td>
                                            </tr>
                                        ...
                                        <tr class="table-active fw-bold">
                                            <td>Total</td>
                                            <td class="text-center">
                                                <span class="badge bg-primary fs-6"><?php echo e($totals['total_assigned']); ?></span>
                                            </td>
                                            <td class="text-center">
                                                <span class="badge bg-warning fs-6"><?php echo e($totals['pending']); ?></span>
                                            </td>
                                            <td class="text-center">
                                                <span class="badge bg-info fs-6"><?php echo e($totals['closed']); ?></span>
                                            </td>
                                            <td class="text-center">
                                                <span class="badge bg-success fs-6"><?php echo e($totals['sales']); ?></span>
                                            </td>
                                            <td class="text-center">
                                                <span class="badge bg-secondary fs-6"><?php echo e($totals['returned']); ?></span>
                                            </td>
                                            <td class="text-center">
                                                <span class="badge bg-danger fs-6"><?php echo e($totals['declined']); ?></span>
                                            </td>
                                            <td class="text-center">
                                                <span class="badge bg-dark fs-6"><?php echo e($totals['total_processed']); ?></span>
                                            </td>
                                            <td class="text-center">
                                                <span class="badge bg-<?php echo e($avgConversionRate >= 50 ? 'success' : ($avgConversionRate >= 30 ? 'warning' : 'danger')); ?> fs-6">
                                                    <?php echo e($avgConversionRate); ?>%
                                                </span>
                                            </td>
                                        </tr>
                                    <?php else: ?>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($verifierBreakdown && $verifierBreakdown->count() > 0): ?>
                                        <?php
                                            $totals = [
                                        ...
                                        ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $verifierBreakdown; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $verifier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><strong><?php echo e($verifier['name']); ?></strong></td>
                                                <td class="text-center">
                                                    <span class="badge bg-primary-subtle text-primary fs-6"><?php echo e($verifier['total_submitted']); ?></span>
                                                </td>
                                                <td class="text-center">
                                                    <span class="badge bg-success-subtle text-success fs-6"><?php echo e($verifier['marked_as_sale']); ?></span>
                                                </td>
                                                <td class="text-center">
                                                    <span class="badge bg-warning-subtle text-warning fs-6"><?php echo e($verifier['pending_callbacks']); ?></span>
                                                </td>
                                                <td class="text-center">
                                                    <span class="badge bg-danger-subtle text-danger fs-6"><?php echo e($verifier['declined_calls']); ?></span>
                                                </td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <tr class="table-active fw-bold">
                                            <td>Total</td>
                                            <td class="text-center">
                                                <span class="badge bg-primary fs-6"><?php echo e($totals['total_submitted']); ?></span>
                                            </td>
                                            <td class="text-center">
                                                <span class="badge bg-success fs-6"><?php echo e($totals['marked_as_sale']); ?></span>
                                            </td>
                                            <td class="text-center">
                                                <span class="badge bg-warning fs-6"><?php echo e($totals['pending_callbacks']); ?></span>
                                            </td>
                                            <td class="text-center">
                                                <span class="badge bg-danger fs-6"><?php echo e($totals['declined_calls']); ?></span>
                                            </td>
                                        </tr>
                                    <?php else: ?>
                                        <tr>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($qaBreakdown && $qaBreakdown->count() > 0): ?>
                                        <?php
                                            $totals = [
                                        ...
                                        ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $qaBreakdown; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $qa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><strong><?php echo e($qa['name']); ?></strong></td>
                                                <td class="text-center">
                                                    <span class="badge bg-primary-subtle text-primary fs-6"><?php echo e($qa['total_sales']); ?></span>
                                                </td>
                                                <td class="text-center">
                                                    <span class="badge bg-warning-subtle text-warning fs-6"><?php echo e($qa['pending']); ?></span>
                                                </td>
                                                <td class="text-center">
                                                    <span class="badge bg-success-subtle text-success fs-6"><?php echo e($qa['good']); ?></span>
                                                </td>
                                                <td class="text-center">
                                                    <span class="badge bg-danger-subtle text-danger fs-6"><?php echo e($qa['issues']); ?></span>
                                                </td>
                                                <td class="text-center">
                                                    <span class="badge bg-info-subtle text-info fs-6"><?php echo e($qa['total_reviewed']); ?></span>
                                                </td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <tr class="table-active fw-bold">
                                            <td>Total</td>
                                            <td class="text-center">
                                                <span class="badge bg-primary fs-6"><?php echo e($totals['total_sales']); ?></span>
                                            </td>
                                            <td class="text-center">
                                                <span class="badge bg-warning fs-6"><?php echo e($totals['pending']); ?></span>
                                            </td>
                                            <td class="text-center">
                                                <span class="badge bg-success fs-6"><?php echo e($totals['good']); ?></span>
                                            </td>
                                            <td class="text-center">
                                                <span class="badge bg-danger fs-6"><?php echo e($totals['issues']); ?></span>
                                            </td>
                                            <td class="text-center">
                                                <span class="badge bg-info fs-6"><?php echo e($totals['total_reviewed']); ?></span>
                                            </td>
                                        </tr>
                                    <?php else: ?>
                                        <tr>
...
<script>
    ...
    <?php if($filter === 'custom' && $startDate && $endDate): ?>
        dateRangePicker.setDate(['<?php echo e($startDate); ?>', '<?php echo e($endDate); ?>']);
    ...
    function showDrillDown(type) {
        ...
        fetch('<?php echo e(route('analytics.drill-down')); ?>?' + params.toString())
