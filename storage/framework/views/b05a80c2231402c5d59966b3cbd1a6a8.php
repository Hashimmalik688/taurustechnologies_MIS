<?php $__env->startSection('title', 'Ledger Management'); ?>
...
<div class="container-fluid">
    ...
    <div class="form-page-hdr">
        ...
        <a href="<?php echo e(route('ledger.create')); ?>" class="act-btn a-primary"><i class="bx bx-plus"></i> Add Entry</a>
    </div>
...
$(function(){
    ...
    var table = $('#ledgerTable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "<?php echo e(route('ledger.index')); ?>",
            data: function(d) {
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taurus-crm/resources/views/admin/ledger/index.blade.php ENDPATH**/ ?>