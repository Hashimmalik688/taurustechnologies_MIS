...
<?php $__env->startSection('content'); ?>
 ...
 <div class="u-fs-2 text-surface-500" style="margin-bottom: 0.5rem">
        ...
        <div class="col-md-3 mb-3">
            <div class="card shadow-sm border-0 h-100" style="border-left: 4px solid var(--bs-ui-warning) !important;">
                <div class="card-body text-center">
 <div class="u-fs-2 text-ui-warning" style="margin-bottom: 0.5rem">
                        <i class="bx bx-time-five"></i>
                    </div>
                    <h6 class="text-muted mb-2">Pending</h6>
 <h3 class="fw-bold text-ui-warning" ><?php echo e($qaAnalytics['pending']); ?></h3>
        ...
        <div class="col-md-3 mb-3">
            <div class="card shadow-sm border-0 h-100" style="border-left: 4px solid var(--bs-ui-success) !important;">
                <div class="card-body text-center">
 <div class="u-fs-2 text-ui-success" style="margin-bottom: 0.5rem">
                        <i class="bx bx-check-circle"></i>
                    </div>
                    <h6 class="text-muted mb-2">Good</h6>
 <h3 class="fw-bold text-ui-success" ><?php echo e($qaAnalytics['good']); ?></h3>
        ...
        <div class="col-md-3 mb-3">
            <div class="card shadow-sm border-0 h-100" style="border-left: 4px solid var(--bs-ui-danger) !important;">
                <div class="card-body text-center">
 <div class="u-fs-2 text-ui-danger" style="margin-bottom: 0.5rem">
                        <i class="bx bx-x-circle"></i>
                    </div>
                    <h6 class="text-muted mb-2">Issues</h6>
 <h3 class="fw-bold text-ui-danger" ><?php echo e($qaAnalytics['avg'] + $qaAnalytics['bad']); ?></h3>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-2">
                                <select name="qa_status" class="form-select">
                                    ...
                                    <option value="Pending" <?php echo e(request('qa_status') == Statuses::QA_PENDING ? 'selected' : ''); ?>>⏳ Pending</option>
                                    <option value="Good" <?php echo e(request('qa_status') == Statuses::QA_GOOD ? 'selected' : ''); ?>>✅ Good</option>
                                    <option value="Avg" <?php echo e(request('qa_status') == Statuses::QA_AVG ? 'selected' : ''); ?>>⚠️ Avg</option>
                                    <option value="Bad" <?php echo e(request('qa_status') == Statuses::QA_BAD ? 'selected' : ''); ?>>❌ Bad</option>
                                </select>
                            </div>
                            <div class="col-md-1">
 ...
 <th class="u-min-w-140" >QA Status</th>
 <th class="u-min-w-250" >QA Reason</th>
                                </tr>
                            </thead>
                            <tbody>
