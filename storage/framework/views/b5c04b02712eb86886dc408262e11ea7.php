...
<div class="container-fluid px-3 py-3" style="max-width:1600px">
    ...
    <div class="kpi-row">
        ...
        <div class="kpi-card k-purple">
            <div class="k-val">$<?php echo e(number_format($totalCommission, 2)); ?></div>
            <div class="k-lbl">Total Commission</div>
        </div>
        <div class="kpi-card k-orange">
            <div class="k-val">$<?php echo e(number_format($totalOurShare, 2)); ?></div>
            <div class="k-lbl">Our Share</div>
        </div>
        <div class="kpi-card k-indigo">
            <div class="k-val"><?php echo e($unpostedCount); ?></div>
            <div class="k-lbl">Not in Ledger</div>
        </div>
        <a href="<?php echo e(route('chargebacks.index')); ?>" class="kpi-card k-red" style="text-decoration:none;" title="View all chargebacks">
            <div class="k-val"><?php echo e($chargebackCount); ?></div>
    ...
    <div class="sec-card">
        <div class="sec-hdr">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($unpostedCount > 0): ?>
                <button id="btn-post-all" class="a-btn" style="font-size:.63rem;background:rgba(99,102,241,.15);color:#4338ca;border-color:rgba(99,102,241,.3);">
                    ...
                    <span class="badge rounded-pill" style="background:#4338ca;color:#fff;font-size:.58rem;padding:.15rem .4rem;margin-left:.2rem;"><?php echo e($unpostedCount); ?></span>
                </button>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php endif; ?>
                <a href="<?php echo e(route('admin.accounting.dashboard')); ?>" class="a-btn" style="font-size:.63rem;background:rgba(212,175,55,.1);color:#b89730;border-color:rgba(212,175,55,.25);">
            ...
            <table class="ex-tbl">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $leads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="<?php echo e($lead->status === 'chargeback' ? 'tr-chargeback' : ''); ?>">
                            ...
                            <td><?php echo e($lead->policy_number ?? '—'); ?></td>
                            <td>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->partner): ?>
                                    <span style="font-size:.7rem;font-weight:500;"><?php echo e($lead->partner->name); ?></span>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->partner->code): ?>
                                        <span style="font-size:.6rem;color:var(--bs-surface-400);display:block;"><?php echo e($lead->partner->code); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php else: ?>
                            ...
                            <td>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->calculated_commission > 0): ?>
                                    <span style="color:#722ed1;font-weight:600;">$<?php echo e(number_format($lead->calculated_commission, 2)); ?></span>
                                <?php else: ?>
                                    <span style="color:var(--bs-surface-400);">—</span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </td>
                            <td>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->calculated_our_share > 0): ?>
                                    <?php $sharePct = $lead->partner ? ($lead->partner->our_commission_percentage ?? 15.0) : 15.0; ?>
                                    <span style="color:#c47a05;font-weight:600;">$<?php echo e(number_format($lead->calculated_our_share, 2)); ?></span>
                                    <span style="font-size:.6rem;color:var(--bs-surface-400);display:block;"><?php echo e(rtrim(rtrim(number_format($sharePct, 2), '0'), '.')); ?>%</span>
                                <?php else: ?>
                                    <span style="color:var(--bs-surface-400);">—</span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </td>
                            ...
                            <td>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->ledger_journal_entry_id && $lead->ledgerJournalEntry): ?>
                                    <a href="<?php echo e(route('admin.accounting.journal.show', $lead->ledger_journal_entry_id)); ?>" target="_blank"
                                       class="bd-posted" title="<?php echo e($lead->ledgerJournalEntry->entry_number); ?>">
                                        <i class="bx bx-check-circle"></i> <?php echo e($lead->ledgerJournalEntry->entry_number); ?>

                                    </a>
                                <?php else: ?>
                                    <?php if(auth()->check() && auth()->user()->canViewModule('accounting')): ?>
                                    <button class="a-btn btn-post-ledger" data-id="<?php echo e($lead->id); ?>" data-name="<?php echo e($lead->cn_name); ?>">
                                ...
                                <div class="d-flex gap-1 flex-wrap">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->status === 'chargeback'): ?>
                                        ...
                                        <?php else: ?>
                                            ...
                                            <button class="a-btn btn-chargeback-paid" data-id="<?php echo e($lead->id); ?>" data-name="<?php echo e($lead->cn_name); ?>" style="font-size:.63rem;background:rgba(5,150,105,.12);color:#059669;border-color:rgba(5,150,105,.3);">
                                                <i class="bx bx-dollar"></i> Mark Paid
                                            </button>
                                            <?php endif; ?>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php else: ?>
                                        <button class="a-btn btn-chargeback" data-id="<?php echo e($lead->id); ?>" data-name="<?php echo e($lead->cn_name); ?>" style="font-size:.63rem;background:rgba(220,53,69,.12);color:#dc3545;border-color:rgba(220,53,69,.3);">
                                            <i class="bx bx-error"></i> Chargeback
                                        </button>
                                        <button class="a-btn btn-send-back" data-id="<?php echo e($lead->id); ?>" data-name="<?php echo e($lead->cn_name); ?>" style="font-size:.63rem;background:rgba(100,116,139,.1);color:#64748b;border-color:rgba(100,116,139,.25);">
