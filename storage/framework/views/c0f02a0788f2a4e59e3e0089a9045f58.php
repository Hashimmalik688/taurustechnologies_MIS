                        ...
                        <div class="tab-pane active" id="yet-to-retain" role="tabpanel">
                            <div class="table-wrapper">
                                <table class="table table-striped table-bordered table-hover table-sm align-middle">
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $yet_to_retain_leads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <?php
                            ...
                            <?php if($yet_to_retain_leads->hasPages()): ?>
                                <div class="d-flex justify-content-center mt-4">
                                    <?php echo e($yet_to_retain_leads->appends(['search' => $search, 'month' => $month, 'year' => $year])->links()); ?>
                        ...
                        <div class="tab-pane" id="retained" role="tabpanel">
                            <div class="table-wrapper">
                                <table class="table table-striped table-bordered table-hover table-sm align-middle">
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $retained_leads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                <td><strong><?php echo e($lead->id); ?></strong></td>
                                                <td><?php echo e($lead->sale_date ? $lead->sale_date->format('M d, Y') : 'N/A'); ?></td>
                                                <td>
                            ...
                            <?php if($retained_leads->hasPages()): ?>
                                <div class="d-flex justify-content-center mt-4">
                        ...
                        <div class="tab-pane" id="rewrite" role="tabpanel">
                            <div class="table-wrapper">
                                <table class="table table-striped table-bordered table-hover table-sm align-middle">
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $rewrite_leads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                <td><strong><?php echo e($lead->id); ?></strong></td>
                                                <td><?php echo e($lead->sale_date ? $lead->sale_date->format('M d, Y') : 'N/A'); ?></td>
                                                <td><?php echo e($lead->chargeback_marked_date ? $lead->chargeback_marked_date->format('M d, Y') : 'N/A'); ?></td>
                                                <td>
                                                    <?php if($lead->chargeback_marked_date && $lead->sale_date): ?>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\code\taurus-crm-master\resources\views/admin/retention/index.blade.php ENDPATH**/ ?>