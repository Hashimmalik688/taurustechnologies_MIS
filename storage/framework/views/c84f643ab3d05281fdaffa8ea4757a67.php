...
<div class="row g-3 mb-3">
    <div class="col-md-2">
        ...
        <input type="text" class="form-control" name="height" value="<?php echo e(old('height', $lead->height ?? '')); ?>" placeholder="5'10&quot;">
    </div>
    <div class="col-md-2">
        <label for="weight" class="form-label">Weight (lbs)</label>
        <input type="text" class="form-control" name="weight" value="<?php echo e(old('weight', $lead->weight ?? '')); ?>" placeholder="180">
    </div>
    <div class="col-md-1">
