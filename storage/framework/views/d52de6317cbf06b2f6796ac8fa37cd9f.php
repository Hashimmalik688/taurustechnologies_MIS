...
<?php $__env->startSection('content'); ?>
    ...
    <div class="sl-topbar">
        ...
        <div class="sl-topbar-right">
            ...
            <form method="GET" action="<?php echo e(route('chargebacks.index')); ?>" id="policySearchForm" class="sl-search-wrap" style="margin-right:.25rem;">
                ...
                <input type="text" name="policy_search" id="cbPolicySearch"
                    ...
                    value="<?php echo e($policySearch ?? ''); ?>"
                    style="width:160px;border-color:<?php echo e(($policySearch ?? '') ? '#d4af37' : ''); ?>">
            </form>
            <div class="sl-search-wrap">
                <i class="bx bx-search sl-search-icon"></i>
                <input type="text" id="cbSearch" class="sl-search-input" placeholder="Search name, phone, carrier, closer..." value="<?php echo e($search); ?>">
            </div>
        </div>
    </div>
    ...
    <!-- Chargebacks Card -->
    <div class="sl-card">
        <form method="GET" action="<?php echo e(route('chargebacks.index')); ?>" id="cbFilterForm" class="sl-filter-pills">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->hasAny(['search', 'month', 'year', 'date_from', 'date_to', 'policy_search'])): ?>
                <a href="<?php echo e(route('chargebacks.index')); ?>" class="sl-pill-clear" title="Clear filters"><i class="bx bx-x"></i> Clear</a>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($policySearch ?? null): ?>
                <span style="font-size:.68rem;font-weight:600;color:#d4af37;background:rgba(212,175,55,.1);border:1px solid rgba(212,175,55,.25);padding:.25rem .6rem;border-radius:22px;">
                    <i class="bx bx-file-find"></i> Policy: <?php echo e($policySearch); ?>

                </span>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <span class="sl-result-count"><?php echo e($chargebacks->total()); ?> chargebacks</span>
        </form>
        ...
        <div class="sl-tbl-wrap">
            <table class="sl-tbl">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $chargebacks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr style="background:rgba(220,53,69,.03);">
                            <td><?php echo e($lead->sale_date ? $lead->sale_date->format('M d, Y') : 'N/A'); ?></td>
                            <td>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->policy_number): ?>
                                    <span style="font-size:.72rem;font-weight:600;color:#334155;"><?php echo e($lead->policy_number); ?></span>
                                <?php else: ?>
                            ...
                            <td>
                                ...
                                <br><small class="text-muted"><?php echo e($lead->phone_number ?? ''); ?></small>
                            </td>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($chargebacks->count() > 0): ?>
                    <tfoot>
                        <tr>
        ...
        <div class="mt-3">
            <?php echo e($chargebacks->appends(['search' => $search, 'policy_search' => $policySearch ?? '', 'month' => $month, 'year' => $year, 'date_from' => $date_from ?? '', 'date_to' => $date_to ?? ''])->links()); ?>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taurus-crm/resources/views/admin/chargebacks/index.blade.php ENDPATH**/ ?>