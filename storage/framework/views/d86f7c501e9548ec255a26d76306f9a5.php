...
<!-- Tab Pills -->
<div class="tab-row">
    <a href="<?php echo e(route('admin.account-switching-log')); ?>" class="tab-pill active">
        <i class="bx bx-shield-x"></i> Suspicious Devices
    </a>
    <a href="<?php echo e(route('admin.audit-logs.index')); ?>" class="tab-pill">
...
<div class="ex-card sec-card">
    <div class="sec-hdr">
        ...
        <span class="badge-count"><?php echo e(count($logs)); ?></span>
    </div>
                    ...
                    <tr>
                        <td>
                            <div style="display:flex;align-items:center;gap:.35rem">
                                ...
                                <span style="font-size:.72rem;font-weight:600"><?php echo e($log->device_name ?: 'Unknown Device'); ?></span>
                            </div>
                        </td>
                        <td><span class="fp-code"><?php echo e($log->device_fingerprint); ?></span></td>
                        <td>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($log->user): ?>
                            <span class="v-badge" style="font-size:.65rem"><?php echo e($log->user->name); ?></span>
                            <?php else: ?>
                            <span style="font-size:.7rem;color:var(--bs-surface-400)">Unknown</span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </td>
                        <td style="font-size:.7rem"><?php echo e($log->user ? $log->user->email : $log->user_email); ?></td>
                        <td><span class="s-pill" style="font-size:.62rem"><?php echo e($log->ip_address); ?></span></td>
                        <td style="font-size:.68rem;color:var(--bs-surface-500)">
                            ...
                            <?php echo e($log->created_at->format('Y-m-d h:i A')); ?>
