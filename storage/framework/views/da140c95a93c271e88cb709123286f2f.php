<?php $__env->startSection('title', 'Opening Balance'); ?>
        ...
        <div>
            <div class="txn-card">
                ...
                <div class="txn-card-body">
                    <form method="POST" action="<?php echo e(route('admin.accounting.opening-balance.store')); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="bal-type-group">
                                <div class="bal-type-option">
                                    <input type="radio" name="normal_balance" id="balDebit" value="debit"
                                           <?php echo e(old('normal_balance', 'debit') === 'debit' ? 'checked' : ''); ?>>
                                    <label for="balDebit">
                                ...
                                <div class="bal-type-option">
                                    <input type="radio" name="normal_balance" id="balCredit" value="credit"
                                           <?php echo e(old('normal_balance') === 'credit' ? 'checked' : ''); ?>>
                                    <label for="balCredit">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['normal_balance'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" rows="2" class="form-control"
                                      placeholder="e.g. Opening balance as at 01 Jan 2026"><?php echo e(old('description')); ?></textarea>
                        </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taurus-crm/resources/views/admin/accounting/quick/opening-balance.blade.php ENDPATH**/ ?>