<?php $__env->startSection('title', 'QA Manual Score'); ?>
...
<div class="qm-wrap">
    ...
    <div class="qm-header">
        ...
        <div style="display:flex;gap:.5rem;align-items:center;">
            <a href="<?php echo e(route('qa.upload')); ?>" class="qm-btn qm-btn-ghost">
            ...
            <div class="qm-controls">
                <div class="qm-field">
                    ...
                    <select id="agentSelect">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $agents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="qm-field">
                    ...
                    <input type="date" id="callDate" value="<?php echo e(date('Y-m-d')); ?>">
                </div>
                <div class="qm-field">
                    <label>&nbsp;</label>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taurus-crm/resources/views/qa/manual.blade.php ENDPATH**/ ?>