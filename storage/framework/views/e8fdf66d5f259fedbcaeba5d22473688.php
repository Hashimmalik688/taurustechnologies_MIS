<?php $__env->startSection('title', 'Employee Salary Settings'); ?>
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <div class="card border-light">
                                    <div class="card-body">
                                        <form method="GET" action="<?php echo e(route('salary.employees')); ?>" class="row g-3">
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select name="salary_range" class="form-select">
                                                    ...
                                                    <option value="0-25000"
                                                        <?php echo e(request('salary_range') == '0-25000' ? 'selected' : ''); ?>>Rs0 -
                                                        Rs25,000</option>
                                                    <option value="25000-50000"
                                                        <?php echo e(request('salary_range') == '25000-50000' ? 'selected' : ''); ?>>
                                                        Rs25,000 - Rs50,000</option>
                                                    <option value="50000-100000"
                                                        <?php echo e(request('salary_range') == '50000-100000' ? 'selected' : ''); ?>>
                                                        Rs50,000 - Rs100,000</option>
                                                    <option value="100000+"
                                                        <?php echo e(request('salary_range') == '100000+' ? 'selected' : ''); ?>>
                                                        Rs100,000+</option>
                                                </select>
                                            </div>
                                            <div class="col-md-3">
                                                ...
                                                <select name="target_range" class="form-select">
                                                    ...
                                                    <option value="0-10"
                                                        <?php echo e(request('target_range') == '0-10' ? 'selected' : ''); ?>>0 - 10
                                                        sales</option>
                                                    <option value="10-20"
                                                        <?php echo e(request('target_range') == '10-20' ? 'selected' : ''); ?>>10 - 20
                                                        sales</option>
                                                    <option value="20-50"
                                                        <?php echo e(request('target_range') == '20-50' ? 'selected' : ''); ?>>20 - 50
                                                        sales</option>
                                                    <option value="50+"
                                                        <?php echo e(request('target_range') == '50+' ? 'selected' : ''); ?>>50+ sales
                                                    </option>
                                                </select>
                                            </div>
                                            <div class="col-md-2">
                                                ...
                                                <div class="d-flex gap-2">
                                                    ...
                                                    <a href="<?php echo e(route('salary.employees')); ?>"
                        ...
                        <div class="row mb-4">
                            <div class="col-md-3">
                                <div class="card text-center border-primary">
                                    <div class="card-body">
                                        <h5 class="card-title text-primary"><?php echo e($employees->total()); ?></h5>
                                ...
                                <div class="card text-center border-success">
                                    <div class="card-body">
                                        <h5 class="card-title text-success">
                                            Rs<?php echo e(number_format($employees->sum('basic_salary'), 0)); ?>
                                ...
                                <div class="card text-center border-info">
                                    <div class="card-body">
                                        <h5 class="card-title text-info">
                                            <?php echo e($employees->avg('target_sales') ? number_format($employees->avg('target_sales'), 1) : '0'); ?>
                                ...
                                <div class="card text-center border-warning">
                                    <div class="card-body">
                                        <h5 class="card-title text-warning">
                                            Rs<?php echo e(number_format($employees->avg('bonus_per_extra_sale'), 0)); ?>
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr class="employee-row" data-employee-id="<?php echo e($employee->id); ?>">
                                            <td>
                                                    ...
                                                    <div>
                                                        ...
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($employee->roles->isNotEmpty()): ?>
                                                            ...
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $employee->roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <small class="badge bg-primary me-1"><?php echo e($role->name); ?></small>
                                                        ...
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($employee->department): ?>
                                                            <br><small
                                                                class="badge bg-light text-dark"><?php echo e($employee->department); ?></small>
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <span class="fw-bold text-primary fs-6">
                                                    Rs<?php echo e(number_format($employee->basic_salary, 0)); ?>
                                            ...
                                            <td>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($employee->is_sales_employee): ?>
                                                    <span class="badge bg-info fs-6">
                                                        <?php echo e($employee->target_sales ?? 20); ?> sales
                                                    </span>
                                                <?php else: ?>
                                            ...
                                            <td>
                                                ...
                                                <?php else: ?>
                                                    <span class="text-muted">N/A</span>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </td>?? 20 }}, <?php echo e($employee->bonus_per_extra_sale ?? 0); ?>, <?php echo e($employee->punctuality_bonus ?? 0); ?>, <?php echo e($employee->is_sales_employee ? 'true' : 'false'
                                            <td>
                                                <span class="fw-bold text-warning">
                                                    Rs{{ number_format($employee->punctuality_bonus ?? 0, 0)); ?>

                                                </span>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($employee->punctuality_bonus > 0): ?>
                                                    <br><small class="text-muted">If qualified</small>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </td>
                                            <td>
                                                <small class="text-muted">
                                                    <?php echo e($employee->updated_at->format('M d, Y')); ?>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <butt9n class="btn btn-sm btn-outline-primary"
                                                        onclick="editEmployee(<?php echo e($employee->id); ?>, '<?php echo e($employee->name); ?>', <?php echo e($employee->basic_salary); ?>, <?php echo e($employee->target_sales); ?>, <?php echo e($employee->bonus_per_extra_sale); ?>)">
                                                        <i class="fas fa-edit"></i>
                                                    </button>
                                                    <?php endif; ?>
                                                    <button class="btn btn-sm btn-outline-info"
                                                        onclick="viewSalaryHistory(<?php echo e($employee->id); ?>)">
                                                        <i class="fas fa-history"></i>
                                                    </button>
                                                    <button class="btn btn-sm btn-outline-success"
                                                        onclick="quickCalculate(<?php echo e($employee->id); ?>)">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taurus-crm/resources/views/admin/salary/employees.blade.php ENDPATH**/ ?>