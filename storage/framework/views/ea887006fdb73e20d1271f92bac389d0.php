...
<body>
    ...
    <!-- Employee Login Button -->
    <a href="<?php echo e(route('login')); ?>" class="employee-login-btn">
...
unset($__errorArgs, $__bag); ?>" 
                               name="email" value="<?php echo e(old('email')); ?>" required autofocus placeholder="partner@example.com">
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?>" 
            ...
            <div class="footer-text">
                <p>&copy; <?php echo e(date('Y')); ?> Taurus CRM. All rights reserved.</p>
            </div>
        </div>
    </div>
