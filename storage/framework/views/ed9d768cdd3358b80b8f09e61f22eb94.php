        ...
        <div class="col-12">
            <form method="GET" action="<?php echo e(route('petty-cash.index')); ?>" class="d-flex gap-2 flex-wrap align-items-end">
                ...
                <div>
                    ...
                    <input type="date" name="from_date" class="form-control form-control-sm" value="<?php echo e($fromDate); ?>" style="min-width: 140px;">
                </div>

                <!-- Date To Filter -->
                <div>
                    <label class="form-label small mb-2">To Date</label>
                    <input type="date" name="to_date" class="form-control form-control-sm" value="<?php echo e($toDate); ?>" style="min-width: 140px;">
                </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h4 class="mb-0" style="color: <?php echo e($currentBalance >= 0 ? '#28a745' : '#dc3545'); ?>">
                                <?php echo e(number_format($currentBalance, 2)); ?>

                            </h4>
                        </div>
                        <div style="font-size: 2rem; color: <?php echo e($currentBalance >= 0 ? '#28a745' : '#dc3545'); ?>;">
