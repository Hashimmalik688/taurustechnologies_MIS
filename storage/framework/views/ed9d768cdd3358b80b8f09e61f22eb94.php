<?php $__env->startSection('title', 'Petty Cash Ledger'); ?>
...
<div class="container-fluid">
    ...
    <div class="alert alert-success alert-dismissible fade show" role="alert" style="font-size:.78rem;border-radius:12px">
        <i class="bx bx-check-circle me-1"></i> <?php echo e($message); ?>
    ...
    <div class="alert alert-danger alert-dismissible fade show" role="alert" style="font-size:.78rem;border-radius:12px">
        <i class="bx bx-x-circle me-1"></i> <?php echo e($message); ?>
    ...
    <div class="form-page-hdr">
        ...
        <div class="d-flex gap-2">
            <a href="<?php echo e(route('petty-cash.print', request()->query())); ?>" target="_blank" class="act-btn a-info"><i class="bx bx-printer"></i> Print</a>
            <a href="<?php echo e(route('petty-cash.export', request()->query())); ?>" class="act-btn a-info"><i class="bx bx-download"></i> Export</a>
    ...
    <div class="pipe-filter-bar mb-2">
        <form method="GET" action="<?php echo e(route('petty-cash.index')); ?>" class="d-flex flex-wrap align-items-end gap-2 w-100">
            <div style="min-width:140px">
                <label class="crm-label">Category</label>
                <select name="head" class="crm-input crm-select">
                    <option value="">All Categories</option>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $heads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $head): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($head); ?>" <?php echo e($selectedHead === $head ? 'selected' : ''); ?>><?php echo e($head); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </select>
            </div>
            <div style="min-width:130px">
                <label class="crm-label">From Date</label>
                <input type="text" name="from_date" id="pcFromDate" class="crm-input crm-date" placeholder="Select" value="<?php echo e($fromDate); ?>" autocomplete="off">
            </div>
            <div style="min-width:130px">
                <label class="crm-label">To Date</label>
                <input type="text" name="to_date" id="pcToDate" class="crm-input crm-date" placeholder="Select" value="<?php echo e($toDate); ?>" autocomplete="off">
            </div>
            <button type="submit" class="pipe-pill" style="margin-top:auto"><i class="bx bx-filter-alt"></i> Filter</button>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedHead || $fromDate || $toDate): ?>
            <a href="<?php echo e(route('petty-cash.index')); ?>" class="pipe-pill" style="margin-top:auto;background:rgba(239,68,68,.08);color:#ef4444;border-color:rgba(239,68,68,.15)"><i class="bx bx-x"></i> Clear</a>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </form>
    </div>
    ...
    <div class="info-pill mb-2">
        ...
        <strong><?php echo e($selectedHead); ?></strong> &mdash;
        All time: <strong style="color:#ef4444"><?php echo e(number_format($categoryTotal, 2)); ?></strong> |
        ...
        <?php else: ?>
            This month:
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <strong style="color:#ef4444"><?php echo e(number_format($categoryMonthTotal, 2)); ?></strong>
    </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($fromDate && $toDate && !$selectedHead): ?>
    <div class="info-pill mb-2">
        <i class="bx bx-calendar-event"></i>
        Viewing from <strong><?php echo e(date('M d, Y', strtotime($fromDate))); ?></strong> to <strong><?php echo e(date('M d, Y', strtotime($toDate))); ?></strong>
    </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="kpi-row" style="grid-template-columns:repeat(auto-fill,minmax(170px,1fr))">
        <div class="kpi-card k-green">
            ...
            <div class="kpi-val"><?php echo e(number_format($totalDebit, 2)); ?></div>
        </div>
        <div class="kpi-card k-red">
            <div class="kpi-lbl">Total Credits (Out)</div>
            <div class="kpi-val"><?php echo e(number_format($totalCredit, 2)); ?></div>
        </div>
        <div class="kpi-card k-gold">
            <div class="kpi-lbl">Running Balance</div>
            <div class="kpi-val"><?php echo e(number_format($currentBalance, 2)); ?></div>
        </div>
        <div class="kpi-card k-blue">
            <div class="kpi-lbl">Total Entries</div>
            <div class="kpi-val"><?php echo e($entries->count()); ?></div>
        </div>
    </div>
            ...
            <div class="table-responsive">
                <table class="ex-tbl w-100">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-center"><span class="v-badge"><?php echo e($serialNumberMap[$entry->id]); ?></span></td>
                            <td style="font-size:.7rem;color:var(--bs-surface-500)"><?php echo e($entry->date->format('M d, Y')); ?></td>
                            <td><strong style="font-size:.75rem"><?php echo e($entry->description); ?></strong></td>
                            <td><span class="v-badge"><?php echo e($entry->head); ?></span></td>
                            <td class="text-end">
                                ...
                                <span style="color:#10b981;font-weight:700;font-size:.75rem"><?php echo e(number_format($entry->debit, 2)); ?></span>
                                <?php else: ?>
                            ...
                            <td class="text-end">
                                ...
                                <span style="color:#ef4444;font-weight:700;font-size:.75rem"><?php echo e(number_format($entry->credit, 2)); ?></span>
                                <?php else: ?>
                                <span style="opacity:.3;font-size:.72rem">—</span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </td>
                            <td class="text-end"><strong style="color:#d4af37;font-size:.75rem"><?php echo e(number_format($balanceMap[$entry->id] ?? 0, 2)); ?></strong></td>
                            <td class="text-center">
                                <?php if(auth()->check() && auth()->user()->canEditModule('petty-cash')): ?>
                                <button class="act-btn a-warn" style="padding:.15rem .4rem;font-size:.65rem" onclick="editEntry(<?php echo e($entry->id); ?>)" title="Edit"><i class="bx bx-pencil"></i></button>
                                <?php endif; ?>
                                <?php if(auth()->check() && auth()->user()->canDeleteInModule('petty-cash')): ?>
                                <button class="act-btn a-danger" style="padding:.15rem .4rem;font-size:.65rem" onclick="deleteEntry(<?php echo e($entry->id); ?>)" title="Delete"><i class="bx bx-trash"></i></button>
                                <?php endif; ?>
                            </td>
                        </tr>
        ...
        <div class="sec-body p-0">
            <div class="table-responsive">
                <table class="ex-tbl w-100">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $heads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $headItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
                        ...
                        ?>
                        <tr>
                            <td><span class="v-badge"><?php echo e($headItem); ?></span></td>
                            <td class="text-end"><span style="color:#ef4444;font-weight:700;font-size:.75rem"><?php echo e(number_format($categorySpent, 2)); ?></span></td>
                            <td class="text-end"><span style="color:#f59e0b;font-weight:700;font-size:.75rem"><?php echo e(number_format($thisMonthSpent, 2)); ?></span></td>
                            <td class="text-center"><a href="<?php echo e(route('petty-cash.index', ['head' => $headItem])); ?>" class="act-btn a-info" style="padding:.15rem .45rem;font-size:.62rem"><i class="bx bx-search"></i></a></td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<div class="modal fade" id="addEntryModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="entryForm" method="POST" action="<?php echo e(route('petty-cash.store')); ?>">
                <?php echo csrf_field(); ?>
...
document.getElementById('addEntryModal').addEventListener('hidden.bs.modal', function() {
    ...
    document.getElementById('entryForm').action = "<?php echo e(route('petty-cash.store')); ?>";
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taurus-crm/resources/views/admin/finance/petty-cash.blade.php ENDPATH**/ ?>