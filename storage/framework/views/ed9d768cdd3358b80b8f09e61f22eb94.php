...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <form method="GET" action="<?php echo e(route('petty-cash.index')); ?>" class="d-flex gap-2 flex-wrap align-items-end">
                <!-- Category Filter -->
                <div>
 ...
 <select name="head" class="form-select form-select-sm u-min-w-150" >
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $heads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $head): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($head); ?>" <?php echo e($selectedHead === $head ? 'selected' : ''); ?>>
                                <?php echo e($head); ?>
 ...
 <input type="date" name="from_date" class="form-control form-control-sm u-min-w-140" value="<?php echo e($fromDate); ?>" >
                </div>

                <!-- Date To Filter -->
                <div>
                    <label class="form-label small mb-2">To Date</label>
 <input type="date" name="to_date" class="form-control form-control-sm u-min-w-140" value="<?php echo e($toDate); ?>" >
                </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedHead || $fromDate || $toDate): ?>
                    <a href="<?php echo e(route('petty-cash.index')); ?>" class="btn btn-sm btn-outline-secondary">
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="alert alert-info alert-dismissible fade show" role="alert">
                    ...
                    <strong><?php echo e($selectedHead); ?></strong> | 
                    Total spent all time: <strong class="text-danger"><?php echo e(number_format($categoryTotal, 2)); ?></strong> | 
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($fromDate && $toDate): ?>
                        Date range (<?php echo e(date('M d, Y', strtotime($fromDate))); ?> - <?php echo e(date('M d, Y', strtotime($toDate))); ?>):
                    <?php else: ?>
                        This month:
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <strong class="text-danger"><?php echo e(number_format($categoryMonthTotal, 2)); ?></strong>
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="alert alert-warning alert-dismissible fade show" role="alert">
                    ...
                    Viewing entries from <strong><?php echo e(date('M d, Y', strtotime($fromDate))); ?></strong> to <strong><?php echo e(date('M d, Y', strtotime($toDate))); ?></strong>
                    <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h4 class="mb-0 text-success"><?php echo e(number_format($totalDebit, 2)); ?></h4>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h4 class="mb-0 text-danger"><?php echo e(number_format($totalCredit, 2)); ?></h4>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h4 class="mb-0" style="color: <?php echo e($currentBalance >= 0 ? 'var(--bs-status-present)' : 'var(--bs-status-absent)'); ?>">
                                <?php echo e(number_format($currentBalance, 2)); ?>

                            </h4>
                        </div>
 <div class="u-fs-2" style="color: <?php echo e($currentBalance >= 0 ? 'var(--bs-status-present)' : 'var(--bs-status-absent)'); ?>">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            ...
                            <h4 class="mb-0 text-info"><?php echo e($entries->count()); ?></h4>
                        </div>
 <div class="text-info u-fs-2" >
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-light border-bottom d-flex justify-content-between align-items-center">
            ...
            <div>
                <a href="<?php echo e(route('petty-cash.print', request()->query())); ?>" target="_blank" class="btn btn-sm btn-outline-secondary">
                    <i class="bx bx-printer me-1"></i>
                    Print
                </a>
                <a href="<?php echo e(route('petty-cash.export', request()->query())); ?>" class="btn btn-sm btn-outline-secondary">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $entries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="text-center">
                                    <span class="badge bg-secondary"><?php echo e($serialNumberMap[$entry->id]); ?></span>
                                </td>
                                <td>
                                    <small class="text-muted"><?php echo e($entry->date->format('M d, Y')); ?></small>
                                </td>
                                <td>
                                    <strong><?php echo e($entry->description); ?></strong>
                                </td>
                                <td>
                                    <span class="badge bg-light text-dark"><?php echo e($entry->head); ?></span>
                                </td>
                                <td class="text-end">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($entry->debit > 0): ?>
                                        <span class="text-success fw-bold"><?php echo e(number_format($entry->debit, 2)); ?></span>
                                    <?php else: ?>
                                ...
                                <td class="text-end">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($entry->credit > 0): ?>
                                        <span class="text-danger fw-bold"><?php echo e(number_format($entry->credit, 2)); ?></span>
                                    <?php else: ?>
                                        <span class="text-muted">-</span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </td>
                                <td class="text-end">
                                    <strong class="text-primary"><?php echo e(number_format($balanceMap[$entry->id] ?? 0, 2)); ?></strong>
                                </td>
                                <td class="text-center">
                                    <?php if(auth()->check() && auth()->user()->canEditModule('petty-cash')): ?>
                                    <button class="btn btn-sm btn-light" 
                                            onclick="editEntry(<?php echo e($entry->id); ?>)"
                                    ...
                                    <button class="btn btn-sm btn-light" 
                                            onclick="deleteEntry(<?php echo e($entry->id); ?>)"
                                            data-bs-toggle="tooltip" 
                                            title="Delete">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-sm table-hover mb-0">
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $heads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $head): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php
                                ...
                                <tr>
                                    <td>
                                        <span class="badge bg-light text-dark"><?php echo e($head); ?></span>
                                    </td>
                                    <td class="text-end text-danger fw-bold"><?php echo e(number_format($categorySpent, 2)); ?></td>
                                    <td class="text-end text-warning fw-bold"><?php echo e(number_format($thisMonthSpent, 2)); ?></td>
                                    <td class="text-center">
                                        <a href="<?php echo e(route('petty-cash.index', ['head' => $head])); ?>" class="btn btn-xs btn-outline-primary">
