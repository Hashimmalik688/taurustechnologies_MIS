<?php $__env->startSection('title', 'Record a Sale'); ?>
        ...
        <div>
            <div class="txn-card">
                ...
                <div class="txn-card-body">
                    <form method="POST" action="<?php echo e(route('admin.accounting.record-sale.store')); ?>" id="saleForm">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                       value="<?php echo e(old('gross_amount')); ?>" placeholder="Full policy / sale value">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taurus-crm/resources/views/admin/accounting/quick/sale.blade.php ENDPATH**/ ?>