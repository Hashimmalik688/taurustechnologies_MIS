<?php $__env->startSection('title', 'Calculate Salaries'); ?>
...
<?php $__env->startSection('content'); ?>
 ...
 <i class="bx bx-calculator me-2 text-gold" ></i>
                            Calculate Monthly Salaries
                        </h4>
                        <p class="text-muted mb-0">Process salary calculations for <?php echo e(\Carbon\Carbon::create()->month($currentMonth)->format('F')); ?> <?php echo e($currentYear); ?></p>
                    </div>
                    <a href="<?php echo e(route('salary.records')); ?>" class="btn btn-outline-dark">
        ...
        <form action="<?php echo e(route('salary.calculate')); ?>" method="POST" id="salaryCalculationForm">
            <?php echo csrf_field(); ?>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    <div class="card salary-card gold-border">
                        <div class="card-body">
 <h6 class="card-title mb-3 text-print-body u-fw-600" >
 <i class="bx bx-calendar me-2 text-gold" ></i>
                                Calculation Period
                            </h6>
                            <div class="row g-2">
                                <div class="col-7">
                                    ...
                                    <select name="month" id="month" class="form-select form-select-sm" required>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = 1; $i <= 12; $i++): ?>
                                            <option value="<?php echo e($i); ?>" <?php echo e($i == $currentMonth ? 'selected' : ''); ?>>
                                ...
                                <div class="col-5">
                                    ...
                                    <select name="year" id="year" class="form-select form-select-sm" required>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($i = date('Y'); $i >= date('Y') - 2; $i--): ?>
                                            <option value="<?php echo e($i); ?>" <?php echo e($i == $currentYear ? 'selected' : ''); ?>>
                                                <?php echo e($i); ?>
 ...
 <h5 class="mb-0 text-print-body u-fw-700" ><?php echo e($employees->count()); ?></h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
 ...
 <h5 class="mb-0 text-success u-fw-700" ><?php echo e($existingRecords->count()); ?></h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
 ...
 <h6 class="mb-0 text-gold u-fw-700" >Rs<?php echo e(number_format($employees->sum('basic_salary'), 0)); ?></h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
 ...
 <h5 class="mb-0 text-primary u-fw-700" id="selectedCount">0</h5>
                                </div>
                            </div>
                        </div>
                    </div>
 ...
 <th class="u-min-w-200" >Employee</th>
                                    <th>Basic</th>
                                    <th>Target</th>
                                    <th>Actual</th>
                                    <th>Extra</th>
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    ...
                                    ?>
                                    <tr class="employee-row <?php echo e($existingRecord ? 'table-light' : ''); ?>">
                                        <td>
                                            <input type="checkbox" name="user_ids[]" value="<?php echo e($employee->id); ?>"
                                                class="form-check-input employee-checkbox"
                                                <?php echo e($existingRecord ? 'checked' : ''); ?>

                                                <?php echo e(!$employee->basic_salary || $employee->basic_salary <= 0 ? 'disabled' : ''); ?>>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-xs me-2">
 <span class="avatar-title rounded-circle text-print-body u-fw-600 bg-gold">
                                                        <?php echo e(substr($employee->name, 0, 1)); ?>

                                                    </span>
                                                </div>
                                                <div>
 <div class="u-fw-600 text-print-body u-fs-0875"><?php echo e($employee->name); ?></div>
                                                    <small class="text-muted"><?php echo e($employee->email); ?></small>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($employee->roles->isNotEmpty()): ?>
                                                        <div class="mt-1">
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $employee->roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <span class="badge bg-secondary" style="font-size: 0.65rem;"><?php echo e($role->name); ?></span>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                        </div>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$employee->basic_salary || $employee->basic_salary <= 0): ?>
                                                        <div class="mt-1">
                                        ...
                                        <td>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($employee->basic_salary && $employee->basic_salary > 0): ?>
 <span class="u-fw-600 text-print-body" >
                                                    Rs<?php echo e(number_format($employee->basic_salary ?? 0, 0)); ?>
                                        ...
                                        <td>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($employee->is_sales_employee): ?>
                                                <span class="badge bg-primary"><?php echo e($employee->target_sales ?? 0); ?></span>
                                            <?php else: ?>
                                        ...
                                        <td>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($employee->is_sales_employee): ?>
                                                <span class="badge <?php echo e($actualSales >= ($employee->target_sales ?? 0) ? 'bg-success' : 'bg-warning'); ?>">
                                                    <?php echo e($actualSales); ?>
                                        ...
                                        <td>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($employee->is_sales_employee && $extraSales > 0): ?>
                                                <span class="badge bg-success">+<?php echo e($extraSales); ?></span>
                                            <?php else: ?>
                                        ...
                                        <td>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($employee->is_sales_employee): ?>
 <span class="text-ui-success-dark u-fw-600" >
                                                    Rs<?php echo e(number_format($employee->bonus_per_extra_sale ?? 0, 0)); ?>
                                        ...
                                        <td>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($totalBonus > 0): ?>
 <span class="text-ui-success-dark u-fw-600" >
                                                    Rs<?php echo e(number_format($totalBonus, 0)); ?>
                                        ...
                                        <td>
 <span class="u-fw-700 text-print-body u-fs-095" >
                                                Rs<?php echo e(number_format($grossSalary, 0)); ?>

                                            </span>
                                        </td>
                                        <td>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($existingRecord): ?>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($existingRecord->status == 'paid'): ?>
                                                    <span class="badge bg-success">Paid</span>
                                                <?php elseif($existingRecord->status == 'approved'): ?>
                                                    <span class="badge bg-info">Approved</span>
                                                <?php elseif($existingRecord->status == 'calculated'): ?>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-sm btn-outline-primary" 
                                                onclick="openSalarySettings(<?php echo e($employee->id); ?>, '<?php echo e(addslashes($employee->name)); ?>', <?php echo e($employee->basic_salary ?? 0); ?>, <?php echo e($employee->target_sales ?? 20); ?>, <?php echo e($employee->bonus_per_extra_sale ?? 0); ?>, <?php echo e($employee->punctuality_bonus ?? 0); ?>, <?php echo e($employee->fine_per_absence ?? 0); ?>, <?php echo e($employee->fine_per_late ?? 0); ?>, '<?php echo e($employee->salary_start_date ?? ''); ?>', '<?php echo e($employee->salary_end_date ?? ''); ?>', <?php echo e($employee->payday_date ?? 5); ?>, <?php echo e($employee->is_sales_employee ? 'true' : 'false'); ?>)"
 ...
 <h5 class="modal-title text-gold" >
                    ...
                    <form id="salarySettingsForm" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mb-3">
                                <div class="col-12">
 <h6 class="border-bottom pb-2 mb-3 text-print-body" >💰 Base Salary</h6>
                                </div>
                                <div class="col-md-12">
                            ...
                            <div id="settings_sales_section">
                                <div class="row mb-3">
                                    <div class="col-12">
 <h6 class="border-bottom pb-2 mb-3 text-print-body" >📊 Sales & Bonus</h6>
                                    </div>
                                    <div class="col-md-6">
                            ...
                            <div class="row mb-3">
                                <div class="col-12">
 <h6 class="border-bottom pb-2 mb-3 text-print-body" >⏰ Punctuality & Fines (Dock)</h6>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row mb-3">
                                <div class="col-12">
 <h6 class="border-bottom pb-2 mb-3 text-print-body" >📅 Salary Period</h6>
                                </div>
                                <div class="col-md-4">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/taurus-crm/resources/views/admin/salary/index.blade.php ENDPATH**/ ?>