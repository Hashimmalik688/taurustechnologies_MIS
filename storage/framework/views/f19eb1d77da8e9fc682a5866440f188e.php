                        ...
                        <div class="col-md-3">
                            <div class="card stat-card">
                                <div class="card-body p-3 text-center">
                                    ...
                                    <h5 class="mb-0" style="color: #1a1a1a; font-weight: 700;"><?php echo e($employees->count()); ?></h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card stat-card">
                                <div class="card-body p-3 text-center">
                                    ...
                                    <h5 class="mb-0 text-success" style="font-weight: 700;"><?php echo e($existingRecords->count()); ?></h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card stat-card">
                                <div class="card-body p-3 text-center">
                                    ...
                                    <h6 class="mb-0" style="color: #d4af37; font-weight: 700;">Rs<?php echo e(number_format($employees->sum('basic_salary'), 0)); ?></h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                                    ...
                                    <tr class="employee-row <?php echo e($existingRecord ? 'table-light' : ''); ?>">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <div style="font-weight: 600; color: #1a1a1a; font-size: 0.875rem;"><?php echo e($employee->name); ?></div>
