<?php $__env->startSection('title'); ?>
    <?php echo e($project->name); ?> - Dashboard
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="project-header">
        <div class="row align-items-center position-relative">
            <div class="col-md-8">
                <h2 class="mb-2"><i class="fas fa-project-diagram me-3"></i><?php echo e($project->name); ?></h2>
                <p class="mb-3 opacity-90"><?php echo e($project->description); ?></p>
                <div class="d-flex gap-4 flex-wrap">
                    <span><i class="fas fa-user-tie me-2"></i><?php echo e($project->client_name); ?></span>
                    <span><i class="fas fa-globe me-2"></i><?php echo e($project->region); ?></span>
                    <span><i class="far fa-calendar-alt me-2"></i><?php echo e($project->deadline->format('M d, Y')); ?></span>
                </div>
            </div>
    ...
    <div class="row mb-4">
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="stat-card">
                ...
                <div class="stat-trend">
                    <small class="text-muted-dark"><?php echo e($project->completed_tasks); ?>/<?php echo e($project->total_tasks); ?> tasks completed</small>
                </div>
                ...
                <div class="stat-trend">
                    <small class="text-muted-dark">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->days_remaining > 0): ?>
                            <?php echo e($project->days_remaining); ?> days remaining
                        <?php else: ?>
                            <?php echo e(abs($project->days_remaining)); ?> days overdue
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </small>
                </div>
            </div>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="stat-card">
                ...
                <div class="stat-value"><?php echo e(number_format($project->project_velocity, 2)); ?></div>
                <div class="stat-trend">
                    <small class="text-muted-dark">tasks per day</small>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->estimated_completion_date): ?>
                        <br><small class="text-info"><i class="fas fa-calendar-check me-1"></i><?php echo e($project->estimated_completion_date->format('M d')); ?></small>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 mb-3">
            <div class="stat-card">
                ...
                <div class="stat-value"><?php echo e($project->scope_creep_count); ?></div>
                <div class="stat-trend">
                    <small class="text-muted-dark">revision tasks</small>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->total_tasks > 0): ?>
                        <br><small class="text-warning"><?php echo e(number_format(($project->revision_tasks / $project->total_tasks) * 100, 1)); ?>% of total</small>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="glass-card p-4">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $project->tasks->sortBy('order'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="task-card task-priority-<?php echo e($task->priority); ?>">
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                <div class="flex-grow-1">
                                    <h6 class="mb-1 text-white">
                                        <?php echo e($task->name); ?>

                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($task->task_type === 'revision'): ?>
                                            <span class="badge bg-warning ms-2">Revision</span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </h6>
                                    <small class="text-muted-dark">
                                        <i class="far fa-calendar me-1"></i><?php echo e($task->start_date->format('M d')); ?> - <?php echo e($task->end_date->format('M d')); ?>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($task->assignedUser): ?>
                                            <i class="fas fa-user ms-3 me-1"></i><?php echo e($task->assignedUser->name); ?>
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <div>
                                        <div class="progress-modern" style="width: 100px;">
                                            <div class="progress-bar-modern" style="width: <?php echo e($task->progress); ?>%"></div>
                                        </div>
                                        <small class="text-muted-dark"><?php echo e($task->progress); ?>%</small>
                                    </div>
                                    <span class="badge bg-<?php echo e($task->status === 'completed' ? 'success' : ($task->status === 'in-progress' ? 'primary' : 'secondary')); ?>">
                ...
                <div class="glass-card p-4">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $project->milestones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $milestone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="d-flex justify-content-between align-items-start mb-3 pb-3" style="border-bottom: 1px solid rgba(255,255,255,0.05);">
                            <div>
                                <h6 class="mb-1 text-white"><?php echo e($milestone->name); ?></h6>
                                <small class="text-muted-dark"><i class="far fa-calendar me-1"></i><?php echo e($milestone->due_date->format('M d, Y')); ?></small>
                            </div>
                            <span class="milestone-badge bg-<?php echo e($milestone->status === 'completed' ? 'success' : ($milestone->status === 'missed' ? 'danger' : 'warning')); ?>">
    ...
    <div id="tab-resources" class="tab-content-panel">
        <div class="glass-card p-4">
            ...
            <div class="row">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $teamMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="resource-item">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div>
                                    <h6 class="mb-0 text-white"><?php echo e($member->name); ?></h6>
                                    <small class="text-muted-dark"><?php echo e($memberTasks->count()); ?> tasks assigned</small>
                                </div>
                                <div class="text-end">
                                    <span class="badge bg-<?php echo e($workloadClass === 'high' ? 'danger' : ($workloadClass === 'medium' ? 'warning' : 'success')); ?>">
                                        <?php echo e(number_format($workloadPercentage, 0)); ?>% Load
                                    </span>
                                </div>
                            </div>
                            <div class="workload-bar mb-2">
                                <div class="workload-fill workload-<?php echo e($workloadClass); ?>" style="width: <?php echo e($workloadPercentage); ?>%"></div>
                            </div>
                            <div class="d-flex justify-content-between">
                                <small class="text-muted-dark"><i class="far fa-clock me-1"></i><?php echo e($totalHours); ?>h total</small>
                                <small class="text-success"><i class="fas fa-check me-1"></i><?php echo e($completedHours); ?>h completed</small>
                            </div>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        ...
        <div class="row">
                    ...
                    <div class="row text-center mb-4">
                        <div class="col-md-4 mb-3">
                            <div class="p-3" style="border-right: 1px solid rgba(255,255,255,0.1);">
                                ...
                                <h3 class="text-white mb-0"><?php echo e($project->currency); ?> <?php echo e(number_format($project->contract_value, 2)); ?></h3>
                            </div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <div class="p-3" style="border-right: 1px solid rgba(255,255,255,0.1);">
                                <small class="text-muted-dark d-block mb-2">External Costs</small>
                                <h3 class="text-danger mb-2"><?php echo e($project->currency); ?> <?php echo e(number_format($project->external_costs, 2)); ?></h3>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="p-3">
                                ...
                                <h3 class="text-success mb-2"><?php echo e($project->currency); ?> <?php echo e(number_format($project->gross_profit, 2)); ?></h3>
                                <span class="badge bg-success"><?php echo e(number_format($project->margin_percentage, 1)); ?>% Margin</span>
                            </div>
                        </div>
                    </div>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->externalCosts->count() > 0): ?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-dark">
                                ...
                                <tbody>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $project->externalCosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cost): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><span class="badge bg-secondary"><?php echo e(ucfirst($cost->cost_type)); ?></span></td>
                                            <td class="text-white"><?php echo e($cost->name); ?></td>
                                            <td><?php echo e($cost->vendor_name ?? 'N/A'); ?></td>
                                            <td class="text-end text-danger fw-bold"><?php echo e($cost->currency); ?> <?php echo e(number_format($cost->amount, 2)); ?></td>
                                        </tr>
            ...
            <div class="col-lg-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->region === 'US'): ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currencyRisk): ?>
                        <div class="currency-risk-card">
                            <h6 class="mb-3"><i class="fas fa-exclamation-triangle me-2"></i>Currency Risk Alert</h6>
                            <div class="d-flex justify-content-between mb-2">
                                <span>Current Rate:</span>
                                <strong><?php echo e($currencyRisk['current_rate']); ?> PKR/USD</strong>
                            </div>
                            <div class="d-flex justify-content-between mb-2">
                                <span>Last Week:</span>
                                <span><?php echo e($currencyRisk['last_week_rate']); ?> PKR/USD</span>
                            </div>
                            <div class="d-flex justify-content-between">
                                <span>Change:</span>
                                <span class="<?php echo e($currencyRisk['change_percentage'] < 0 ? 'text-success' : 'text-warning'); ?>">
                                    <i class="fas fa-<?php echo e($currencyRisk['change_percentage'] < 0 ? 'arrow-down' : 'arrow-up'); ?> me-1"></i>
                                    <?php echo e(abs($currencyRisk['change_percentage'])); ?>%
                                </span>
                            </div>
                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div id="tab-risks" class="tab-content-panel">
        <div class="glass-card p-4">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->region === 'US' && $currencyRisk && abs($currencyRisk['change_percentage']) > 2): ?>
                <div class="risk-item risk-high">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <div>
                            <h6 class="text-white mb-1">Currency Exchange Rate Volatility</h6>
                            <p class="text-muted-dark mb-2 small">USD/PKR rate changed <?php echo e($currencyRisk['change_percentage']); ?>% this week.</p>
                            <span class="risk-badge high">High</span>
                            <span class="badge bg-secondary ms-2">Financial</span>
                        </div>
                        <span class="text-muted-dark small">Impact: <?php echo e(abs($currencyRisk['change_percentage']) > 5 ? 'High' : 'Medium'); ?></span>
                    </div>
                    <div class="mt-3">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->scope_creep_count > 5): ?>
                <div class="risk-item risk-high">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <div>
                            <h6 class="text-white mb-1">Scope Creep Detected</h6>
                            <p class="text-muted-dark mb-2 small"><?php echo e($project->scope_creep_count); ?> revision tasks added, <?php echo e(number_format(($project->revision_tasks / $project->total_tasks) * 100, 1)); ?>% of total work.</p>
                            <span class="risk-badge high">High</span>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->health_score === 'red' || $project->days_remaining < 0): ?>
                <div class="risk-item risk-critical">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <div>
                            <h6 class="text-white mb-1">Project Behind Schedule</h6>
                            <p class="text-muted-dark mb-2 small">Project is <?php echo e(abs($project->days_remaining)); ?> days overdue with <?php echo e(number_format(100 - $project->progress_percentage, 1)); ?>% work remaining.</p>
                            <span class="risk-badge critical">Critical</span>
                            <span class="badge bg-secondary ms-2">Schedule</span>
                        </div>
    ...
    <div id="tab-activity" class="tab-content-panel">
        <div class="glass-card p-4">
            ...
            <div class="activity-timeline">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $project->tasks->sortByDesc('updated_at')->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="activity-item">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                ...
                                <p class="text-white mb-1"><?php echo e($task->name); ?></p>
                                <small class="text-muted-dark">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($task->assignedUser): ?>
                                        by <?php echo e($task->assignedUser->name); ?>

                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </small>
                            </div>
                            <small class="text-muted-dark"><?php echo e($task->updated_at->diffForHumans()); ?></small>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $project->milestones->sortByDesc('updated_at')->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $milestone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="activity-item">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                <h6 class="text-white mb-1">
                                    <i class="fas fa-flag text-warning me-2"></i>Milestone <?php echo e(ucfirst($milestone->status)); ?>

                                </h6>
                                <p class="text-white mb-1"><?php echo e($milestone->name); ?></p>
                                <small class="text-muted-dark">Due: <?php echo e($milestone->due_date->format('M d, Y')); ?></small>
                            </div>
                            <small class="text-muted-dark"><?php echo e($milestone->updated_at->diffForHumans()); ?></small>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->tasks->count() === 0 && $project->milestones->count() === 0): ?>
                    <div class="text-center py-5">
                        <i class="fas fa-inbox text-muted-dark" style="font-size: 3rem;"></i>
    ...
    <div class="modal fade" id="addCostModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('epms.costs.store', $project)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="mb-3">
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        const milestones = <?php echo json_encode($ganttMilestones, 15, 512) ?>;
        ...
        function updateTaskDates(taskId, start, end) {
            fetch(`<?php echo e(route('epms.show', $project)); ?>/tasks/${taskId}/dates`, {
                method: 'POST',
                headers: {
        ...
        function updateTaskProgress(taskId, progress) {
            fetch(`<?php echo e(route('epms.show', $project)); ?>/tasks/${taskId}/status`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
