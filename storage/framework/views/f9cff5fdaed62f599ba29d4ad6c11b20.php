...
<?php $__env->startSection('css'); ?>
    ...
    <style>
        ...
        .p1-vm-btn{background:none;color:#6c757d;border:1.5px solid #dee2e6;border-radius:14px;padding:.55rem 1.5rem;font-size:.82rem;font-weight:600;cursor:pointer;transition:all .25s;display:inline-flex;align-items:center;gap:.4rem;margin-top:.6rem}
        .p1-vm-btn:hover{background:#f8f9fa;border-color:#adb5bd;color:#495057}
        ...
        .mf-vm{background:#f8f9fa;color:#6c757d;border:1.5px solid #dee2e6;box-shadow:none}
        .mf-vm:hover{background:#e9ecef;color:#495057;box-shadow:none}
        ...
        /* Dark mode tweaks */
        :is([data-theme="emerald-glass"],[data-theme="midnight-black"],[data-theme="ocean-blue"],[data-theme="royal-purple"],[data-theme="rose-gold"],[data-theme="copper-steel"]) .sl-card{background:var(--bs-card-bg);border-color:var(--bs-border-color)}
        :is([data-theme="emerald-glass"],[data-theme="midnight-black"],[data-theme="ocean-blue"],[data-theme="royal-purple"],[data-theme="rose-gold"],[data-theme="copper-steel"]) .sl-legend{background:var(--bs-tertiary-bg)}
        :is([data-theme="emerald-glass"],[data-theme="midnight-black"],[data-theme="ocean-blue"],[data-theme="royal-purple"],[data-theme="rose-gold"],[data-theme="copper-steel"]) .sl-table thead th{background:var(--bs-tertiary-bg)}
        :is([data-theme="emerald-glass"],[data-theme="midnight-black"],[data-theme="ocean-blue"],[data-theme="royal-purple"],[data-theme="rose-gold"],[data-theme="copper-steel"]) .sl-search input{background:var(--bs-input-bg);color:var(--bs-body-color);border-color:var(--bs-border-color)}
        :is([data-theme="emerald-glass"],[data-theme="midnight-black"],[data-theme="ocean-blue"],[data-theme="royal-purple"],[data-theme="rose-gold"],[data-theme="copper-steel"]) .sl-modal .modal-content{background:var(--bs-card-bg)}
    </style>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="sl-topbar">
        <div>
            <h1><i class="bx bx-phone-call me-2" style="color:#d4af37"></i>Ravens Calling System
                <span class="sl-subtitle"><?php echo e($leads->total()); ?> lead<?php echo e($leads->total() !== 1 ? 's' : ''); ?></span>
            </h1>
        </div>
        <div class="sl-actions">
            <form action="<?php echo e(route('ravens.calling')); ?>" method="GET" class="sl-search">
                <input type="text" name="search" placeholder="Search name or phone…" value="<?php echo e(request('search')); ?>">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request('search')): ?>
                    <a href="<?php echo e(route('ravens.calling')); ?>" class="sl-btn sl-btn-outline" title="Clear"><i class="bx bx-x"></i></a>
            ...
            <button type="button" class="sl-btn sl-btn-outline" onclick="openMyCallsToday()" title="View your call log for today">
                <i class="bx bx-history me-1"></i>My Calls
                <span id="myCallsBadge" class="badge bg-primary ms-1" style="font-size:.65rem;display:none">0</span>
            </button>
        </div>
    </div>
    ...
    <div class="sl-card">
        ...
        <div class="sl-card-body" style="padding:.5rem .75rem">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $leads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="lead-row" data-lead-id="<?php echo e($lead->id); ?>" data-phone="<?php echo e($lead->phone_number); ?>" data-secondary-phone="<?php echo e($lead->secondary_phone_number ?? ''); ?>">
                                ...
                                <td>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($lead->sale_at && $lead->closer_name): ?>
                                        <span class="badge bg-success ms-1" style="border-radius:8px;font-size:.68rem">Sale by <?php echo e($lead->closer_name); ?> · <?php echo e($lead->sale_at->format('M d, Y')); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <td>
                                    ...
                                    ?>
                                    <input type="text" class="callback-note-input" data-lead-id="<?php echo e($lead->id); ?>"
                                        value="<?php echo e($noteValue); ?>" placeholder="e.g., callback 2pm"
                                ...
                                <td class="text-center">
                                    <div class="dial-badges" id="dial-badges-<?php echo e($lead->id); ?>"></div>
                                </td>
                                <td class="text-center">
                                    <button class="dial-btn" onclick="makeCall('<?php echo e($lead->id); ?>', '<?php echo e($lead->phone_number); ?>', this)">
            ...
            <div class="sl-pagination">
                <span class="sl-result-count">Showing <?php echo e($leads->firstItem()); ?>–<?php echo e($leads->lastItem()); ?> of <?php echo e($leads->total()); ?></span>
    ...
    <!-- MY CALLS TODAY MODAL -->
    <div class="modal fade" id="myCallsTodayModal" tabindex="-1" data-bs-backdrop="true">
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content" style="border-radius:18px;overflow:hidden">
                <div class="modal-header" style="background:linear-gradient(135deg,#4e73df,#375bd2);padding:.85rem 1.25rem">
                    <h5 class="modal-title text-white" style="font-size:.95rem;font-weight:700">
                        <i class="bx bx-history me-2"></i>My Calls Today
                        <span id="myCallsModalCount" class="badge bg-white text-primary ms-2" style="font-size:.7rem">0</span>
                    </h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body p-0" style="max-height:420px;overflow-y:auto">
                    <div id="myCallsLoading" class="text-center py-4 text-muted" style="font-size:.85rem">
                        <i class="bx bx-loader-alt bx-spin d-block mb-2" style="font-size:1.5rem"></i>Loading…
                    </div>
                    <div id="myCallsEmpty" class="text-center py-4 text-muted" style="font-size:.85rem;display:none">
                        <i class="bx bx-phone-off d-block mb-2" style="font-size:1.8rem"></i>No calls yet today
                    </div>
                    <table class="table table-sm mb-0" id="myCallsTable" style="display:none;font-size:.8rem">
...
<script>
    ...
    /**
     * Apply lock states sourced from the latest dial-status poll.
     * Disables Call buttons and highlights rows for leads currently being called.
     */
    function applyLockStates(locks, currentUserId) {
        // Reset previous lock UI
        document.querySelectorAll('.dial-btn').forEach(btn => {
            btn.classList.remove('locked');
            btn.disabled = false;
            btn.title = '';
        });
        document.querySelectorAll('.lead-row').forEach(row => row.classList.remove('in-call'));
        document.querySelectorAll('.live-badge').forEach(el => el.remove());

        if (!locks) return;

        for (const [leadId, lock] of Object.entries(locks)) {
            const row = document.querySelector(`.lead-row[data-lead-id="${leadId}"]`);
            if (!row) continue;

            row.classList.add('in-call');

            const btn = row.querySelector('.dial-btn');
            if (btn && !lock.is_mine) {
                btn.classList.add('locked');
                btn.disabled = true;
                btn.title = lock.user_name + ' is currently calling this lead';
            }

            const badgeContainer = document.getElementById('dial-badges-' + leadId);
            if (badgeContainer) {
                const liveBadge = document.createElement('span');
                liveBadge.className = 'live-badge' + (lock.is_mine ? ' mine' : '');
                liveBadge.innerHTML = '⬤ ' + (lock.is_mine ? 'You (live)' : lock.user_name);
                liveBadge.title = (lock.is_mine ? 'You are' : lock.user_name + ' is') + ' currently calling · ' + lock.since;
                badgeContainer.prepend(liveBadge);
            }
        }
    }

    /**
     * Release this user's call-lock on a lead (fire-and-forget).
     */
    function releaseLock(leadId) {
        if (!leadId) return;
        fetch('/ravens/leads/release-lock', {
            method: 'POST',
            headers: {
            ...
            if (window.activeLocks) delete window.activeLocks[String(leadId)];
            loadDialStatus();
        }).catch(e => console.warn('releaseLock failed silently:', e));
    }
    ...
    // ── Smart Embed cross-tab call status listener ────────────────────────────
    // The /zoom/phone tab receives zp-call-* events from the Smart Embed iframe
    // and writes them to localStorage('zpw_call_status').  This listener picks
    // them up on the calling page and drives form open / close instantly.
    window.addEventListener('storage', function(zpEvt) {
        if (zpEvt.key !== 'zpw_call_status' || !zpEvt.newValue) return;
        try {
            const s = JSON.parse(zpEvt.newValue);
            if (!s || (Date.now() - s.ts) > 30000) return; // ignore stale (>30s)
            const ac = window.currentCallInfo;
            console.log('📡 Smart Embed status →', s.status, s.result || '', JSON.stringify({direction:s.direction, caller:s.caller, callerNumber:s.callerNumber, callee:s.callee}));

            // Extract caller phone from all possible fields — caller may be an object {phoneNumber,...} or a string
            const extractCallerNum = (src) => {
                if (!src) return null;
                const raw = (typeof src === 'object') ? (src.phoneNumber || src.number || '') : String(src);
                const digits = raw.replace(/[^\d+]/g, '');
                return digits || null;
            };
            const resolvedCallerNum = s.callerNumber || extractCallerNum(s.caller) || null;
            console.log('🔍 resolvedCallerNum:', resolvedCallerNum, '| currentCallInfo:', window.currentCallInfo ? window.currentCallInfo.leadName : 'null');

            if (s.status === 'ringing') {
                toastr.clear();
                if (ac) {
                    // Outbound — we already have the lead
                    toastr.info('📞 Ringing ' + ac.leadName + '…', 'Calling', {
                        timeOut: 0, extendedTimeOut: 0, closeButton: true
                    });
                } else {
    ...
    // startRealCallDetection kept as stub — Smart Embed events now handle the flow
    window.startRealCallDetection = function(leadId, phoneNumber, leadName) {
        window.currentCallInfo = { leadId, phoneNumber, leadName };
    }

    // Agent clicked "Left Voicemail" in Dispose dropdown — close form and record outcome
    window.markVoicemailAndClose = function() {
        const ac = window.currentCallInfo;
        if (ac && ac.leadId) {
            fetch('/ravens/leads/record-dial', {
                method: 'POST',
                ...
                body: JSON.stringify({ lead_id: ac.leadId, outcome: 'voicemail' })
            }).catch(() => {});
        }
        toastr.clear();
        toastr.info('📬 Marked as voicemail', 'Voicemail');
        closeRavensForm();
        window.currentCallInfo = null;
    };

    // Inbound ringing — find matching lead and store in currentCallInfo so connected event opens the form
    window.handleInboundRinging = function(callerNumber) {
        const digits = String(callerNumber).replace(/\D/g, '').slice(-10);
        toastr.info('📲 Incoming call from ' + callerNumber + '…', 'Incoming Call', {
            timeOut: 0, extendedTimeOut: 0, closeButton: true
        });
        ...
        .then(function(lead) {
            if (!lead || !lead.id) {
                // No match — keep generic toast, form will not auto-open
                toastr.clear();
                toastr.info('📲 Incoming call from ' + callerNumber + ' (no matching lead)', 'Incoming Call', {
                    timeOut: 0, extendedTimeOut: 0, closeButton: true
                });
                return;
            }
            // Store lead so connected event can open the form immediately
            window.currentCallInfo = { leadId: lead.id, phoneNumber: lead.phone_number, leadName: lead.cn_name };
            toastr.clear();
            toastr.info('📲 Incoming from ' + lead.cn_name, 'Incoming Call', {
                timeOut: 0, extendedTimeOut: 0, closeButton: true
            });
        })
        .catch(function() { /* keep existing toast */ });
    };
...
` +
    ...
    function closeCallModal() {
        ...
        // Release call lock so other closers can pick up this lead
        const activeLeadId = window.currentLeadData?.id || window.currentCallInfo?.leadId;
        if (activeLeadId) {
            releaseLock(activeLeadId);
        }
    ...
    /**
     * Open the "My Calls Today" modal and populate it with today's dial log.
     */
    function openMyCallsToday() {
        const modal = new bootstrap.Modal(document.getElementById('myCallsTodayModal'));
        modal.show();

        const loading = document.getElementById('myCallsLoading');
        const empty   = document.getElementById('myCallsEmpty');
        const table   = document.getElementById('myCallsTable');
        const tbody   = document.getElementById('myCallsBody');
        const count   = document.getElementById('myCallsModalCount');
        ...
        fetch('/ravens/leads/my-calls-today', {
            headers: {
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                'Accept': 'application/json'
            }
        ...
        .then(data => {
            ...
            const outcomeColors = {
                dialed: 'secondary', connected: 'success', no_answer: 'warning',
                callback: 'info', not_interested: 'danger'
            };
            data.dials.forEach(d => {
                const tr = document.createElement('tr');
                const color = outcomeColors[d.outcome] || 'secondary';
                tr.innerHTML = `
                    <td class="ps-3 fw-semibold">${d.name || '—'}</td>
                    <td style="font-variant-numeric:tabular-nums">${d.phone || '—'}</td>
                    <td><span class="badge bg-${color}" style="border-radius:8px;font-size:.68rem">${(d.outcome || 'dialed').replace('_',' ')}</span></td>
                    <td class="text-muted">${d.time}</td>
                `;
            ...
            // Update topbar badge
            const badge = document.getElementById('myCallsBadge');
        ...
        .catch(err => {
            loading.style.display = 'none';
            empty.style.display = '';
            console.error('myCallsToday fetch error:', err);
        });
    }

    // Keep "My Calls" badge updated on each dial-status poll
    (function patchDialStatusForBadge() {
        const orig = loadDialStatus;
        // Badge is refreshed via openMyCallsToday() when opened;
        // update it passively by counting local dial records
    })();
